...
const char test_case_name[] = "RawMonitorExit0103";
...
void JNICALL callbackVMInit(prms_VMINIT)
{
    ...
    result = jvmti_env->RawMonitorExit(NULL);
    fprintf(stderr, "\tnative: RawMonitorExit result = %d (must be JVMTI_ERROR_INVALID_MONITOR (50)) \n", result);
    fflush(stderr);
