...
const char test_case_name[] = "GetClassLoader0103";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetClassLoader(parent_class, NULL);
    fprintf(stderr, "\tnative: GetMethodName result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n", result);
    fflush(stderr);
