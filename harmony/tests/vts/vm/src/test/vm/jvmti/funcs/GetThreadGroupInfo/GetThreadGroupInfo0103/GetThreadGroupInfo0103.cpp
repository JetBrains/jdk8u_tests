...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    fprintf(stderr, "\n-------------------------------------------------\n");
    fprintf(stderr, "\ntest GetThreadGroupInfo0103 is started\n{\n");
    fflush(stderr);
...
void JNICALL callbackThreadStart(prms_THRD_START)
{
    ...
    result = jvmti_env->GetThreadGroupInfo(tinfo.thread_group, NULL);
    fprintf(stderr, "\tnative: GetThreadGroupInfo result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n",
            result);
...
void JNICALL callbackVMDeath(prms_VMDEATH)
{
    ...
    fprintf(stderr, "\n\tTest of function GetThreadGroupInfo0103          : ");
    ...
    fprintf(stderr, "\n} /* test GetThreadGroupInfo0103 is finished */ \n");
    fflush(stderr);
}
