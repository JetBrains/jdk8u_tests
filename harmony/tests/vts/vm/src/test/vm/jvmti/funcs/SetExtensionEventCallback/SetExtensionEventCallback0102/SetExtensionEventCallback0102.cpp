...
const char test_case_name[] = "SetExtensionEventCallback0102";
...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    result = jvmti->SetExtensionEventCallback(666, cb_ptr);
    fprintf(stderr, "\tnative: SetExtensionEventCallback result = %d (must be JVMTI_ERROR_ILLEGAL_ARGUMENT (103)) \n", result);
    fprintf(stderr, "\tnative: ext_events[0].extension_event_index is 666\n");
