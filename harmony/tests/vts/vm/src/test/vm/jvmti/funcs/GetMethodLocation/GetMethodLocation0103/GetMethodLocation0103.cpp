...
const char test_case_name[] = "GetMethodLocation0103";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetMethodLocation((jmethodID)jvmti_env, &start, &finis);
    fprintf(stderr, "\tnative: GetMethodLocation result = %d (must be JVMTI_ERROR_INVALID_METHODID (23)) \n", result);
