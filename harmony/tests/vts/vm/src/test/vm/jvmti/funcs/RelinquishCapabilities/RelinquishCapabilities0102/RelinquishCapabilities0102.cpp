...
const char test_case_name[] = "RelinquishCapabilities0102";
...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    result = jvmti->RelinquishCapabilities(NULL);
    fprintf(stderr, "\tnative: RelinquishCapabilities result = %d (must be JVMTI_ERROR_NULL_POINTER(100)) \n", result);
    fflush(stderr);
