...
const char test_case_name[] = "SetBreakpoint0104";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    jvmtiError result = jvmti_env->SetBreakpoint(NULL, loc);
    fprintf(stderr, "\tnative: SetBreakpoint result = %d (must be JVMTI_ERROR_INVALID_METHODID (23)) \n", result);
