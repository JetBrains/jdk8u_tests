...
const char test_case_name[] = "GetLocalVariableTable0107";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetLocalVariableTable(method, &count, NULL);
    fprintf(stderr, "\tnative: GetLocalVariableTable result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n", result);
