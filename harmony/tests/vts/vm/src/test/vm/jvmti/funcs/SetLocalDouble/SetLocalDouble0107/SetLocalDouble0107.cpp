...
const char test_case_name[] = "SetLocalDouble0107";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->SetLocalDouble(create_not_alive_thread(jni_env,
                jvmti_env), depth, slot, value_1);
    fprintf(stderr, "\tnative: SetLocalDouble result = %d (must be JVMTI_ERROR_THREAD_NOT_ALIVE (15)) \n", result);
