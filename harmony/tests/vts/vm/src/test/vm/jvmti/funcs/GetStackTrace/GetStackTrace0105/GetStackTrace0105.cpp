...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    fprintf(stderr, "\n-------------------------------------------------\n");
    fprintf(stderr, "\ntest GetStackTrace0105 is started\n{\n");
    fflush(stderr);
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetStackTrace(thread, 0, -1, frames, &count);
...
void JNICALL callbackVMDeath(prms_VMDEATH)
{
    ...
    fprintf(stderr, "\nTest of function GetStackTrace0105               : ");
    ...
    fprintf(stderr, "\n} /* test GetStackTrace0105 is finished */ \n");
    fflush(stderr);
}
