...
const char test_case_name[] = "GetJNIFunctionTable0102";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetJNIFunctionTable(NULL);
    fprintf(stderr, "\tnative: GetJNIFunctionTable result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n", result);
