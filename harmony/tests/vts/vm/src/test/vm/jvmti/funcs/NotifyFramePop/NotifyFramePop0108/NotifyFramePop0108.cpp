...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    fprintf(stderr, "\n-------------------------------------------------\n");
    fprintf(stderr, "\ntest NotifyFramePop0108 is started\n{\n");
    fflush(stderr);
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->NotifyFramePop(thread, 1000);
    fprintf(stderr, "\tnative: NotifyFramePop result = %d (must be JVMTI_ERROR_NO_MORE_FRAMES (31)) \n", result);
...
void JNICALL callbackVMDeath(prms_VMDEATH)
{
    ...
    fprintf(stderr, "\n\tTest of function NotifyFramePop0108              : ");
    ...
    fprintf(stderr, "\n} /* test NotifyFramePop0108 is finished */ \n");
    fflush(stderr);
}
