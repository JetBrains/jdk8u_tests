...
const char test_case_name[] = "GetLoadedClasses0103";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetLoadedClasses(&classes_count, NULL);
    fprintf(stderr, "\tnative: GetLoadedClasses result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n", result);
