...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    fprintf(stderr, "\n-------------------------------------------------\n");
    fprintf(stderr, "\ntest GetThreadGroupChildren0103 is started\n{\n");
    fflush(stderr);
...
void JNICALL callbackThreadStart(prms_THRD_START)
{
    ...
    result = jvmti_env->GetThreadGroupChildren( tinfo.thread_group,
            NULL, &thread_ptr, &group_counter, &group_ptr);
...
void JNICALL callbackVMDeath(prms_VMDEATH)
{
    ...
    fprintf(stderr, "\nTest of function GetThreadGroupChildren0103      : ");
    ...
    fprintf(stderr, "\n} /* test GetThreadGroupChildren0103 is finished */ \n");
    fflush(stderr);
}
