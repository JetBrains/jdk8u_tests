...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    fprintf(stderr, "\tnative: GetTag result = %d (must be JVMTI_ERROR_MUST_POSSESS_CAPABILITY) \n", result);
