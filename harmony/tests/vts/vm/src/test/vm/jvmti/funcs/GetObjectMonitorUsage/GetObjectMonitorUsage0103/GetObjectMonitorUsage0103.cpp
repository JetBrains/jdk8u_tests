...
const char test_case_name[] = "GetObjectMonitorUsage0103";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetObjectMonitorUsage(NULL, &info);
    fprintf(stderr, "\tnative: GetObjectMonitorUsage result = %d (must be JVMTI_ERROR_INVALID_OBJECT (20)) \n", result);
