...
const char test_case_name[] = "GetClassMethods0104";
...
void JNICALL callbackClassPrepare(prms_CLS_PRPR)
{
    ...
    if (strcmp(signature, "Lorg/apache/harmony/vts/test/vm/jvmti/GetClassMethods0104;")) return;
    ...
    result = jvmti_env->GetClassMethods(klass, NULL, &mids);
