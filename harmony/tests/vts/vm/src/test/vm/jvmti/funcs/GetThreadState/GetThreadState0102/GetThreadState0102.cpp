...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    fprintf(stderr, "\n-------------------------------------------------\n");
    fprintf(stderr, "\ntest GetThreadState0102 is started\n{\n");
    fflush(stderr);
...
void JNICALL callbackThreadStart(prms_THRD_START)
{
    ...
    result = jvmti_env->GetThreadState(thread, NULL);
    fprintf(stderr, "\n\tnative: GetThreadState with NULL-thread_state \n");
    fprintf(stderr, "\tnative: GetThreadState result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n", result);
    fflush(stderr);
...
void JNICALL callbackVMDeath(prms_VMDEATH)
{
    ...
    fprintf(stderr, "\n\tTest of function GetThreadState0102              : ");
    ...
    fprintf(stderr, "\n} /* test GetThreadState0102 is finished */ \n\n");
    fflush(stderr);
}
