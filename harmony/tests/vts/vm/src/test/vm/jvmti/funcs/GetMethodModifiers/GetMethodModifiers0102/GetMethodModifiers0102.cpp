...
const char test_case_name[] = "GetMethodModifiers0102";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetMethodModifiers((jmethodID)jvmti_env, &modifiers);
    fprintf(stderr, "\tnative: GetMethodModifiers result = %d (must be JVMTI_ERROR_INVALID_METHODID (23)) \n", result);
    fflush(stderr);
