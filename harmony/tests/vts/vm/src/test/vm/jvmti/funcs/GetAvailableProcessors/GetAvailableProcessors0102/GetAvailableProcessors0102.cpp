...
const char test_case_name[] = "GetAvailableProcessors0102";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetAvailableProcessors(NULL);
    fprintf(stderr, "\tnative: GetAvailableProcessors result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n", result);
