...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    fprintf(stderr, "\n-------------------------------------------------\n");
    fprintf(stderr, "\ntest GetTopThreadGroups0103 is started\n{\n");
    fflush(stderr);
...
void JNICALL callbackThreadStart(prms_THRD_START)
{
    ...
    result = jvmti_env->GetTopThreadGroups(&group_counter, NULL);
...
void JNICALL callbackVMDeath(prms_VMDEATH)
{
    ...
    fprintf(stderr, "\n\tTest of function GetTopThreadGroups0103          : ");
    ...
    fprintf(stderr, "\n} /* test GetTopThreadGroups0103 is finished */ \n");
    fflush(stderr);
}
