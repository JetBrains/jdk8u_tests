...
const char test_case_name[] = "GetMethodDeclaringClass0102";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetMethodDeclaringClass((jmethodID)jvmti_env, &decl_class);
    fprintf(stderr, "\tnative: GetMethodDeclaringClass result = %d (must be JVMTI_ERROR_INVALID_METHODID (23)) \n", result);
    fflush(stderr);
