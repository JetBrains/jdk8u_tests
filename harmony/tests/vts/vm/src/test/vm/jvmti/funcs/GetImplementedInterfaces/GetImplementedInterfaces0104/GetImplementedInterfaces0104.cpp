...
const char test_case_name[] = "GetImplementedInterfaces0104";
...
void JNICALL callbackClassPrepare(prms_CLS_PRPR) {
    ...
    if (strcmp(signature, "Lorg/apache/harmony/vts/test/vm/jvmti/TestThread_C_09_04;")) return;
    ...
    result = jvmti_env->GetImplementedInterfaces(klass, NULL, &ints);
