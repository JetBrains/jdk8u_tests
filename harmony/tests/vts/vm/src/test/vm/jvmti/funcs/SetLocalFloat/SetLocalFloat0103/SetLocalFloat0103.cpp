...
const char test_case_name[] = "SetLocalFloat0103";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    fprintf(stderr, "\tnative: SetLocalFloat result = %d (must be JVMTI_ERROR_INVALID_SLOT (35)) \n", result);
    if (result != JVMTI_ERROR_INVALID_SLOT) return;
    test = true;
}
