 ...
 *
 */ 
public class GetBytecodes0105 {

    static public void main(String args[]) {

        CustomClassLoader_GetBytecodes0105 ccl = new CustomClassLoader_GetBytecodes0105();
...
class CustomClassLoader_GetBytecodes0105 extends ClassLoader {
    int fake = 0;
}
