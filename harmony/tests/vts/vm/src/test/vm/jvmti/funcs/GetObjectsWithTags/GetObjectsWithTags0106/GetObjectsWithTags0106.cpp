...
/**
 * test of function GetObjectsWithTag0106
 */
...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    fprintf(stderr, "\n-------------------------------------------------\n");
    fprintf(stderr, "\ntest GetObjectsWithTag0106 is started\n{\n");
    fflush(stderr);
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetObjectsWithTags(tag_count, tags, NULL,
...
void JNICALL callbackVMDeath(prms_VMDEATH)
{
    ...
    fprintf(stderr, "\n\tTest of function GetObjectsWithTags0106               : ");
    ...
    fprintf(stderr, "\n} /* test GetObjectsWithTags0106 is finished */ \n");
    fflush(stderr);
}
