...
const char test_case_name[] = "GetClassFields0104";
...
void JNICALL callbackClassPrepare(prms_CLS_PRPR)
{
    ...
    if (strcmp(signature, "Lorg/apache/harmony/vts/test/vm/jvmti/GetClassFields0104;")) return;
    ...
    result = jvmti_env->GetClassFields(klass, NULL, &fids);
