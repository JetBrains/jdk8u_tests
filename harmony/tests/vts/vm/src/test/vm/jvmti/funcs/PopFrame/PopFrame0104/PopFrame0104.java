    ...
    static public void main(String args[]) {
        new Thread("agent") {
            ...
            public void sub_special() {
                if (PopFrame0104.stop) return;
                System.err.print("\tjava: method (sub_special) is paused...\n");
                while (PopFrame0104.pause1) {
                    PopFrame0104.pause2 = false;
                    long x = 1;
        ...
        new Thread("control") {
            ...
            public void special_method() {
                ...
                PopFrame0104.pause1 = false;
                PopFrame0104.stop = true;
