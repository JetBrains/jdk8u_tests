...
const char test_case_name[] = "GetObjectHashCode0103";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetObjectHashCode((jobject)thread, NULL);
    fprintf(stderr, "\tnative: GetObjectHashCode result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n", result);
    fflush(stderr);
