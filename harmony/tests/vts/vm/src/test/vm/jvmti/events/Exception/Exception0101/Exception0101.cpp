...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    fprintf(stderr, "\tnative: Exception (prms) catch_method   is %p\n", catch_method);
    fprintf(stderr, "\tnative: Exception (prms) catch_location is %lld\n", catch_location);
    fflush(stderr);
...
void JNICALL callbackVMDeath(prms_VMDEATH)
{
    ...
    fprintf(stderr, "\n} /* test Exception0101 is finished */ \n");
    fflush(stderr);
}
