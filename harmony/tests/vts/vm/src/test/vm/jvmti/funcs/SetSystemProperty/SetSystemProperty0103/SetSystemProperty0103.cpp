...
const char test_case_name[] = "SetSystemProperty0103";
...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    result = jvmti->SetSystemProperty(NULL, "bla-bla-bla_0");
    fprintf(stderr, "\tnative: SetSystemProperty 1 result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n", result);
