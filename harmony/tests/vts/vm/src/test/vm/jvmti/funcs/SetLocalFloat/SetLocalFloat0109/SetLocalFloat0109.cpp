...
const char test_case_name[] = "SetLocalFloat0109";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->SetLocalFloat(NULL, depth, slot, value_1);
    fprintf(stderr, "\tnative: SetLocalFloat result = %d (must be JVMTI_ERROR_NO_MORE_FRAMES (31)) \n", result);
    if (result != JVMTI_ERROR_NO_MORE_FRAMES) return;
    test = true;
}
