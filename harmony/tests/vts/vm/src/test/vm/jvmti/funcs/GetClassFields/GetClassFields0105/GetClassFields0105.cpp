...
const char test_case_name[] = "GetClassFields0105";
...
void JNICALL callbackClassPrepare(prms_CLS_PRPR)
{
    ...
    if (strcmp(signature, "Lorg/apache/harmony/vts/test/vm/jvmti/GetClassFields0105;")) return;
    ...
    result = jvmti_env->GetClassFields(klass, &fld_num, NULL);
    fprintf(stderr, "\tnative: GetClassFields result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n", result);
    fflush(stderr);
