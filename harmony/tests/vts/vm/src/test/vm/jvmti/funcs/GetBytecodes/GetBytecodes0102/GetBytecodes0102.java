 ...
 *
 */ 
public class GetBytecodes0102 {

    static public void main(String args[]) {

        CustomClassLoader_GetBytecodes0102 ccl = new CustomClassLoader_GetBytecodes0102();
...
class CustomClassLoader_GetBytecodes0102 extends ClassLoader {
    int fake = 0;
}
