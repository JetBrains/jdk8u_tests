...
const char test_case_name[] = "GetFieldName0104";
...
void JNICALL callbackClassPrepare(prms_CLS_PRPR)
{
    ...
    if (strcmp(signature, "Lorg/apache/harmony/vts/test/vm/jvmti/GetFieldName0104;")) return;
    ...
    result = jvmti_env->GetFieldName((jclass)thread, fids[0], &name,
            &signature, &generic);
