...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    fprintf(stderr, "\n-------------------------------------------------\n");
    fprintf(stderr, "\ntest IterateInstances0104 is started\n{\n");
    fflush(stderr);
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    jvmtiHeapObjectFilter object_filter = (jvmtiHeapObjectFilter)100;
    ...
    fprintf(stderr, "\tnative: IterateOverInstancesOfClass result = %d (must be JVMTI_ERROR_ILLEGAL_ARGUMENT (103)) \n",
            result);
...
void JNICALL callbackVMDeath(prms_VMDEATH)
{
    ...
    fprintf(stderr, "\n\tTest of function IterateOverInstancesOfClass0104  : ");
    ...
    fprintf(stderr, "\n} /* test IterateInstances0104 is finished */ \n");
    fflush(stderr);
}
