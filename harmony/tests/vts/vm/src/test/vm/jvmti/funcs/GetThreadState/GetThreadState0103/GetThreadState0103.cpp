...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    fprintf(stderr, "\n-------------------------------------------------\n");
    fprintf(stderr, "\ntest GetThreadState0103 is started\n{\n");
    fflush(stderr);
...
void JNICALL callbackThreadStart(prms_THRD_START)
{
    ...
    result = jvmti_env->GetThreadState(thread_x, &thread_state);
    fprintf(stderr, "\n\tnative: GetThreadState with NON-thread \n");
    fprintf(stderr, "\tnative: GetThreadState result = %d (JVMTI_ERROR_INVALID_THREAD (10)) \n", result);
    fflush(stderr);
...
void JNICALL callbackVMDeath(prms_VMDEATH)
{
    ...
    fprintf(stderr, "\n\tTest of function GetThreadState0103              : ");
    ...
    fprintf(stderr, "\n} /* test GetThreadState0103 is finished */ \n\n");
    fflush(stderr);
}
