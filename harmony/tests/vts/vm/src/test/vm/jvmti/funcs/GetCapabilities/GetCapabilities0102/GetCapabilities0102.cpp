...
const char test_case_name[] = "GetCapabilities0102";
...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    result = jvmti->GetCapabilities(NULL);
    fprintf(stderr, "\tnative: GetCapabilities result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n", result);
    fflush(stderr);
