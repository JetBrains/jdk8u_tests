...
const char test_case_name[] = "GetMaxLocals0104";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetMaxLocals(method, NULL);

    fprintf(stderr, "\tnative: GetMaxLocals result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n", result);
