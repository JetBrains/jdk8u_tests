...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    jvmtiEvent events[] = { JVMTI_EVENT_MONITOR_CONTENDED_ENTERED,
        JVMTI_EVENT_VM_DEATH };

    AGENT_FOR_EVENTS_TESTS_PART_II;

    fprintf(stderr, "\n-------------------------------------------------\n");
    fprintf(stderr, "\ntest MonitorContendedEntered0101 is started\n{\n");
    fflush(stderr);
...
void JNICALL callbackMonitorContendedEntered(prms_MON_ENTERED)
{
    ...
    if (strncmp(tinfo.name, "MonitorContendedEntered0101.Main", 32)==0){
    	/* count only events generated by our main thread and ignore everything else */
    	 counter++;
   	}
...
void JNICALL callbackVMDeath(prms_VMDEATH)
{
    ...
    fprintf(stderr, "\n\tTest of event MonitorContendedEntered0101        : ");
    ...
    fprintf(stderr, "\n} /* test MonitorContendedEntered0101 is finished */ \n");
    fflush(stderr);
}
