...
/**
 * test of function GetSourceDebugExtension
 */
...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    fprintf(stderr, "\n-------------------------------------------------\n");
    fprintf(stderr, "\ntest GetSourceDebugExtension0101 is started\n{\n");
    fflush(stderr);
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    jvmtiError result;
    jclass clazz;
    char* source_debug_extension = NULL;
    ...
    result = jvmti_env->GetSourceDebugExtension( clazz,
            &source_debug_extension);

    fprintf(stderr, "\tnative: GetSourceDebugExtension result = %d (must be zero) \n",
            result);
    fprintf(stderr, "\tnative: clazz is %p \n", clazz);
    fprintf(stderr, "\tnative: source_debug_extension is %s \n", source_debug_extension);
    fflush(stderr);
...
void JNICALL callbackVMDeath(prms_VMDEATH)
{
    ...
    fprintf(stderr, "\n\tTest of function GetSourceDebugExtension0101     : ");
    ...
    fprintf(stderr, "\n} /* test GetSourceDebugExtension0101 is finished */ \n");
    fflush(stderr);
}
