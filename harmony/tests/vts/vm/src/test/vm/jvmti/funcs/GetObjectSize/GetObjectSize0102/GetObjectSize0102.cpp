...
const char test_case_name[] = "GetObjectSize0102";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetObjectSize(NULL, &obj_size);

    fprintf(stderr, "\tnative: GetObjectSize #1 result = %d (must be JVMTI_ERROR_INVALID_OBJECT (20)) \n", result);
    fprintf(stderr, "\tnative: fobject1 is NULL \n");
    fprintf(stderr, "\tnative: fc1_size is %lld \n", (long long)obj_size);
