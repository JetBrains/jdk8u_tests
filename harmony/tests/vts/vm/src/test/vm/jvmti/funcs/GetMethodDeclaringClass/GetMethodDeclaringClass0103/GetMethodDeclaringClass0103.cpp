...
const char test_case_name[] = "GetMethodDeclaringClass0103";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetMethodDeclaringClass( method, NULL);
    fprintf(stderr, "\tnative: GetMethodDeclaringClass result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n", result);
