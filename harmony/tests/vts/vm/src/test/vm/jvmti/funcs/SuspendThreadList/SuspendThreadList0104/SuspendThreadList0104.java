 ...
 *
 */ 
public final class SuspendThreadList0104 {

    static boolean kill = false;
    
    public static void main(String args[]) {

        TestThread_T_04_04 thread_1 = new TestThread_T_04_04(1);
        TestThread_T_04_04 thread_2 = new TestThread_T_04_04(2);
        TestThread_T_04_04 thread_3 = new TestThread_T_04_04(3);
         ...
         */
        while (TestThread_T_04_04.counter < 3) {
            try {
                Thread.sleep(100);
        ...
        new Thread ("agent") {
            public void run() {
                ...
                SuspendThreadList0104.kill = true;
...
class TestThread_T_04_04 extends Thread {
    static int counter = 0;
    private boolean stop = false;
    private int number;
    
    TestThread_T_04_04(int number) {
    ...
    public void run() {
        ...
        synchronized(TestThread_T_04_04.class) {
            counter++;
        }
