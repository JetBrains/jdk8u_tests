...
const char test_case_name[] = "GetLineNumberTable0104";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetLineNumberTable((jmethodID)jvmti_env, &count, &table);
    fprintf(stderr, "\tnative: GetLineNumberTable result = %d (must be JVMTI_ERROR_INVALID_METHODID (23)) \n", result);
