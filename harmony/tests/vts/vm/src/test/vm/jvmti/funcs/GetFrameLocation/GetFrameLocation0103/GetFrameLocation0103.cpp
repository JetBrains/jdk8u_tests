...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    fprintf(stderr, "\n-------------------------------------------------\n");
    fprintf(stderr, "\ntest GetFrameLocation0103 is started\n{\n");
    fflush(stderr);
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetFrameLocation(thread_1, depth, &mID, &loc);
    fprintf(stderr, "\tnative: GetFrameLocation result = %d (must be JVMTI_ERROR_THREAD_NOT_ALIVE (15)) \n", result);
...
void JNICALL callbackVMDeath(prms_VMDEATH)
{
    ...
    fprintf(stderr, "\n\tTest of function GetFrameLocation0103            : ");
    ...
    fprintf(stderr, "\n} /* test GetFrameLocation0103 is finished */ \n");
    fflush(stderr);
}
