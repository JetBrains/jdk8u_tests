 ...
 */
void GetThreadLocalStorage0104()
{
...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    fprintf(stderr, "\n-------------------------------------------------\n");
    fprintf(stderr, "\ntest GetThreadLocalStorage0104 is started\n{\n");
    fflush(stderr);
...
void JNICALL callbackThreadStart(prms_THRD_START)
{
    ...
    fprintf(stderr, "\tnative: GetThreadLocalStorage with NULL data pointer\n");
    result = jvmti_env->GetThreadLocalStorage(thread, NULL);
    fprintf(stderr, "\tnative: GetThreadLocalStorage result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n", result);
...
void JNICALL callbackVMDeath(prms_VMDEATH)
{
    ...
    fprintf(stderr, "\n\tTest of function GetThreadLocalStorage0104            : ");
    ...
    fprintf(stderr, "\n} /* test GetThreadLocalStorage0104 is finished */ \n");
    fflush(stderr);
}
