...
const char test_case_name[] = "GetThreadCPUTime0103";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetThreadCpuTime((jthread)jvmti_env, &nanos);
    fprintf(stderr, "\tnative: GetThreadCpuTime result = %d (must be JVMTI_ERROR_INVALID_THREAD (10)) \n", result);
