...
const char test_case_name[] = "GetSystemProperty0104";
...
void JNICALL callbackVMInit(prms_VMINIT)
{
    ...
    result = jvmti_env->GetSystemProperty("java.bla_bla_bla.property", NULL);
    util = true;
    fprintf(stderr, "\tnative: GetSystemProperty result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n", result);
