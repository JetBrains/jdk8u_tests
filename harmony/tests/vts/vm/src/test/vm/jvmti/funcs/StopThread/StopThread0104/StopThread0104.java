...
public class StopThread0104 {
    ...
    static public void special_method() {        
        TestThread_T_07_0104 thread = new TestThread_T_07_0104("SuperPuperTest");
    ...
    public static void killThread(TestThread_T_07_0104 thread) {
        thread.stop = true;
        try {
            thread.join();
        } catch (Throwable tex) {
...
class TestThread_T_07_0104 extends Thread {
    boolean stop = false;
    
    TestThread_T_07_0104(String name) {
        super(name);
    }    
