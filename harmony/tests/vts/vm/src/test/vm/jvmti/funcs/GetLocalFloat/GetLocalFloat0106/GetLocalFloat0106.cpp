...
const char test_case_name[] = "GetLocalFloat0106";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetLocalFloat((jthread)jvmti_env, depth, slot, &value);

    fprintf(stderr, "\tnative: GetLocalFloat result = %d (must be JVMTI_ERROR_INVALID_THREAD (10)) \n", result);
