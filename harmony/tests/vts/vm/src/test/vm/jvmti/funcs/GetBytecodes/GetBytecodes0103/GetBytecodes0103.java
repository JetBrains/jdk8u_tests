 ...
 *
 */ 
public class GetBytecodes0103 {

    static public void main(String args[]) {

        CustomClassLoader_GetBytecodes0103 ccl = new CustomClassLoader_GetBytecodes0103();
...
class CustomClassLoader_GetBytecodes0103 extends ClassLoader {
    int fake = 0;
}
