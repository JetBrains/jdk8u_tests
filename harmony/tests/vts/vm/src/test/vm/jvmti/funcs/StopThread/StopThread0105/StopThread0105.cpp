...
const char test_case_name[] = "StopThread0105";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    if (!stored_exception)
    {
        stored_exception = (jobject)jvmti_env;
...
void JNICALL callbackThreadStart(prms_THRD_START)
{
    ...
    fprintf(stderr, "\tnative: StopThread result = %d (must be JVMTI_ERROR_INVALID_OBJECT (20)) \n", result);
