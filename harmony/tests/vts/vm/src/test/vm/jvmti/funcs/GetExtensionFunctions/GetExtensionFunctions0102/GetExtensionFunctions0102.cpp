...
const char test_case_name[] = "GetExtensionFunctions0102";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetExtensionFunctions(NULL, &ext_funcs);
    fprintf(stderr, "\tnative: GetExtensionFunctions result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n", result);
