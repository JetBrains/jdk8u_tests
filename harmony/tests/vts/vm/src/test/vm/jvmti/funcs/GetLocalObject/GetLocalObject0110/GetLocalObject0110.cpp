...
const char test_case_name[] = "GetLocalObject0110";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetLocalObject(NULL, depth, slot, NULL);

    fprintf(stderr, "\tnative: GetLocalObject result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n", result);
