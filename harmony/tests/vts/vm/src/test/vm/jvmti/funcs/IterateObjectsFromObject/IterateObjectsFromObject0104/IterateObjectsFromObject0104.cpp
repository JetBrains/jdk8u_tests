...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    fprintf(stderr, "\n-------------------------------------------------\n");
    fprintf(stderr, "\ntest IterateObjectsFromObject0104 is started\n{\n");
    fflush(stderr);
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->IterateOverObjectsReachableFromObject(object, NULL, user_data);

    fprintf(stderr, "\tnative: IterateOverObjectsReachableFromObject result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n",
            result);
...
void JNICALL callbackVMDeath(prms_VMDEATH)
{
    ...
    fprintf(stderr, "\n\tTest of function IterateOverObjectsReachableFromObject0104  : ");
    ...
    fprintf(stderr, "\n} /* test IterateObjectsFromObject0104 is finished */ \n");
    fflush(stderr);
}
