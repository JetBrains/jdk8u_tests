...
const char test_case_name[] = "GetClassModifiers0103";
...
void JNICALL callbackClassLoad(prms_CLS_LD)
{
    ...
    if (strcmp(signature, "Lorg/apache/harmony/vts/test/vm/jvmti/GetClassModifiers0103;")) return;
    ...
    result = jvmti_env->GetClassModifiers(klass, NULL);
    fprintf(stderr, "\tnative: GetClassModifiers result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n", result);
    fflush(stderr);
