...
const char test_case_name[] = "IsMethodNative0102";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->IsMethodNative((jmethodID)(((int)exception) + 7), &native);
    fprintf(stderr, "\tnative: IsMethodNative result = %d (must be JVMTI_ERROR_INVALID_METHODID (23)) \n", result);
    fflush(stderr);
