 ...
 *
 */ 
public final class SuspendThreadList0102 {

    static boolean kill = false;
    
    public static void main(String args[]) {

        TestThread_T_04_02 thread_1 = new TestThread_T_04_02(1);
        TestThread_T_04_02 thread_2 = new TestThread_T_04_02(2);
        TestThread_T_04_02 thread_3 = new TestThread_T_04_02(3);
         ...
         */
        while (TestThread_T_04_02.counter < 3) {
            try {
                Thread.sleep(100);
        ...
        new Thread ("agent") {
            public void run() {
                ...
                SuspendThreadList0102.kill = true;
...
class TestThread_T_04_02 extends Thread {
    static int counter = 0;
    private boolean stop = false;
    private int number;
    
    TestThread_T_04_02(int number) {
    ...
    public void run() {
        ...
        synchronized(TestThread_T_04_02.class) {
            counter++;
        }
