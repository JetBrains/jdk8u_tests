...
const char test_case_name[] = "GetLocalFloat0110";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetLocalFloat(NULL, depth, slot, NULL);

    fprintf(stderr, "\tnative: GetLocalFloat result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n", result);
