...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    fprintf(stderr, "\n-------------------------------------------------\n");
    fprintf(stderr, "\ntest GetFrameLocation0106 is started\n{\n");
    fflush(stderr);
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetFrameLocation(NULL, depth, NULL, &loc);
    fprintf(stderr, "\tnative: GetFrameLocation result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n", result);
...
void JNICALL callbackVMDeath(prms_VMDEATH)
{
    ...
    fprintf(stderr, "\n\tTest of function GetFrameLocation0106            : ");
    ...
    fprintf(stderr, "\n} /* test GetFrameLocation0106 is finished */ \n");
    fflush(stderr);
}
