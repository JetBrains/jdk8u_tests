...
const char test_case_name[] = "SetEventNotificationMode0104";
...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    jvmtiError result = jvmti->SetEventNotificationMode(JVMTI_ENABLE, JVMTI_EVENT_VM_DEATH, (jthread)jvmti);
    fprintf(stderr, "\tnative: SetEventNotificationMode result = %d (must be JVMTI_ERROR_ILLEGAL_ARGUMENT (103)) \n", result);
