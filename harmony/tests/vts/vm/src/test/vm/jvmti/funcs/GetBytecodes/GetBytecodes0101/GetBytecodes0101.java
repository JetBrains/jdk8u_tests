 ...
 *
 */ 
public class GetBytecodes0101 {

    static public void main(String args[]) {

        CustomClassLoader_GetBytecodes0101 ccl = new CustomClassLoader_GetBytecodes0101();
...
class CustomClassLoader_GetBytecodes0101 extends ClassLoader {
    int fake = 0;
}
