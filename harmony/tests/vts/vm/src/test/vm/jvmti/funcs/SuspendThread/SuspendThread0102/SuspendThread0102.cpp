...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    fprintf(stderr, "\n-------------------------------------------------\n");
    fprintf(stderr, "\ntest SuspendThread0102 is started\n{\n");
    fflush(stderr);
...
void JNICALL callbackThreadStart(prms_THRD_START)
{
    ...
    fprintf(stderr, "\tnative: SuspendThread result = %d (must be JVMTI_ERROR_MUST_POSSESS_CAPABILITY (99)) \n",
            result);
...
void JNICALL callbackVMDeath(prms_VMDEATH)
{
    ...
    fprintf(stderr, "\n\tTest of function SuspendThread0102               : ");
    ...
    fprintf(stderr, "\n} /* test SuspendThread0102 is finished */ \n");
    fflush(stderr);
}
