...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    fprintf(stderr, "\n-------------------------------------------------\n");
    fprintf(stderr, "\ntest SuspendThreadList0105 is started\n{\n");
    fflush(stderr);
...
void JNICALL callbackThreadStart(prms_THRD_START)
{
    ...
    jthread threads[3] = {thread, thread, thread};
    ...
    result = jvmti_env->SuspendThreadList(3, threads, NULL);
...
void JNICALL callbackVMDeath(prms_VMDEATH)
{
    ...
    fprintf(stderr, "\n\tTest of function SuspendThreadList0105           : ");
    fflush(stderr);
    ...
    fprintf(stderr, "\n} /* test SuspendThreadList0105 is finished */ \n");
    fflush(stderr);
}
