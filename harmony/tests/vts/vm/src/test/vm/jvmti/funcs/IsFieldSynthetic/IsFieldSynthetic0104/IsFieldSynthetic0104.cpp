...
const char test_case_name[] = "IsFieldSynthetic0104";
...
void JNICALL callbackClassPrepare(prms_CLS_PRPR)
{
    ...
    if (strcmp(signature, "Lorg/apache/harmony/vts/test/vm/jvmti/IsFieldSynthetic0104;"))
        return;
    ...
    fprintf(stderr, "\tnative: IsFieldSynthetic result = %d (must be JVMTI_ERROR_INVALID_FIELDID (25)) \n", result);
    fflush(stderr);
