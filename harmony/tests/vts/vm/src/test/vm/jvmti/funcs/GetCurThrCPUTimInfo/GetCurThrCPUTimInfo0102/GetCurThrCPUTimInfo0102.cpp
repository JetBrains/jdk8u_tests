...
const char test_case_name[] = "GetCurrentThreadCPUTimerInfo0102";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    fprintf(stderr, "\tnative: GetCurrentThreadCpuTimerInfo result = %d (must be JVMTI_ERROR_MUST_POSSESS_CAPABILITY (99)) \n", result);
