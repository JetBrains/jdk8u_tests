...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    fprintf(stderr, "\n-------------------------------------------------\n");
    fprintf(stderr, "\ntest NotifyFramePop0105 is started\n{\n");
    fflush(stderr);
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->NotifyFramePop(thread_x, 1);
    fprintf(stderr, "\tnative: NotifyFramePop result = %d (must be JVMTI_ERROR_INVALID_THREAD (10)) \n", result);
...
void JNICALL callbackVMDeath(prms_VMDEATH)
{
    ...
    fprintf(stderr, "\n\tTest of function NotifyFramePop0105              : ");
    ...
    fprintf(stderr, "\n} /* test NotifyFramePop0105 is finished */ \n");
    fflush(stderr);
}
