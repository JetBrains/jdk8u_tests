...
const char test_case_name[] = "IsMethodObsolete0104";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->IsMethodObsolete(method, NULL);

    fprintf(stderr, "\tnative: IsMethodObsolete result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n", result);
    fflush(stderr);
