...
const char test_case_name[] = "SetLocalDouble0106";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->SetLocalDouble((jthread)jvmti_env, depth, slot, value_1);
    fprintf(stderr, "\tnative: SetLocalDouble result = %d (must be JVMTI_ERROR_INVALID_THREAD (10)) \n", result);
