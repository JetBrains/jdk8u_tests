...
const char test_case_name[] = "GetJLocationFormat0102";
...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    result = jvmti->GetJLocationFormat(NULL);
    fprintf(stderr, "\tnative: GetJLocationFormat result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n", result);
    fflush(stderr);
