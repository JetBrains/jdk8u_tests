...
const char test_case_name[] = "IsMethodSynthetic0103";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->IsMethodSynthetic((jmethodID)((int)exception + 7), &synthetic);

    fprintf(stderr, "\tnative: IsMethodSynthetic result = %d (must be JVMTI_ERROR_INVALID_METHODID (23)) \n", result);
    fflush(stderr);
