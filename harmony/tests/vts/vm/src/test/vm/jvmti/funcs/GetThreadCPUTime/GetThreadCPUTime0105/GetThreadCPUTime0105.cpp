...
const char test_case_name[] = "GetThreadCPUTime0105";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetThreadCpuTime(thread, NULL);
    fprintf(stderr, "\tnative: GetThreadCpuTime result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n", result);
