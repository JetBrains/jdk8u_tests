...
const char test_case_name[] = "SetEventNotificationMode0107";
...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    fprintf(stderr, "\tnative: SetEventNotificationMode result = %d (must be JVMTI_ERROR_NONE (0)) \n", results[3]);
    ...
    jvmtiError result = jvmti->SetEventNotificationMode(JVMTI_ENABLE, (jvmtiEvent)80, NULL);
    fprintf(stderr, "\tnative: SetEventNotificationMode result = %d (must be JVMTI_ERROR_INVALID_EVENT_TYPE (102)) \n", result);
