...
const char test_case_name[] = "SetLocalObject0106";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->SetLocalObject((jthread)jvmti_env, depth, slot, value_1);
    fprintf(stderr, "\tnative: SetLocalObject result = %d (must be JVMTI_ERROR_INVALID_THREAD (10)) \n", result);
