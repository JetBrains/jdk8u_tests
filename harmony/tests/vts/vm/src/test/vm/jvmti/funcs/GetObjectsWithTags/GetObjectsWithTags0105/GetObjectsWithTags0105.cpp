...
/**
 * test of function GetObjectsWithTag0105
 */
...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    fprintf(stderr, "\n-------------------------------------------------\n");
    fprintf(stderr, "\ntest GetObjectsWithTag0105 is started\n{\n");
    fflush(stderr);
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetObjectsWithTags(tag_count, NULL, &count,
            &object_result, &tag_result);

    fprintf(stderr, "\tnative: GetObjectsWithTags result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n", result);
    fflush(stderr);
...
void JNICALL callbackVMDeath(prms_VMDEATH)
{
    ...
    fprintf(stderr, "\n\tTest of function GetObjectsWithTags0105               : ");
    ...
    fprintf(stderr, "\n} /* test GetObjectsWithTags0105 is finished */ \n");
    fflush(stderr);
}
