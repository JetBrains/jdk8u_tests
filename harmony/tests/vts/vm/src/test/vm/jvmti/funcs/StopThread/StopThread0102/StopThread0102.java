...
public class StopThread0102 {
    ...
    static public void special_method() {        
        TestThread_T_07_0102 thread = new TestThread_T_07_0102("SuperPuperTest");
    ...
    public static void killThread(TestThread_T_07_0102 thread) {
        thread.stop = true;
        try {
            thread.join();
        } catch (Throwable tex) {
...
class TestThread_T_07_0102 extends Thread {
    boolean stop = false;
    
    TestThread_T_07_0102(String name) {
        super(name);
    }    
