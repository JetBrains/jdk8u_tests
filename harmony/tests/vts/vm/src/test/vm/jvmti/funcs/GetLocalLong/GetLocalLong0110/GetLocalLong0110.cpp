...
const char test_case_name[] = "GetLocalLong0110";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetLocalLong(NULL, depth, slot, NULL);

    fprintf(stderr, "\tnative: GetLocalLong result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n", result);
