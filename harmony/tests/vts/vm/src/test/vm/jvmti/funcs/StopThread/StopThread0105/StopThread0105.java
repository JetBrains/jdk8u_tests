...
public class StopThread0105 {
    ...
    static public void special_method() {        
        TestThread_T_07_0105 thread = new TestThread_T_07_0105("SuperPuperTest");
    ...
    public static void killThread(TestThread_T_07_0105 thread) {
        thread.stop = true;
        try {
            thread.join();
        } catch (Throwable tex) {
...
class TestThread_T_07_0105 extends Thread {
    boolean stop = false;
    
    TestThread_T_07_0105(String name) {
        super(name);
    }    
