...
const char test_case_name[] = "GetLocalInt0110";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetLocalInt(NULL, depth, slot, NULL);

    fprintf(stderr, "\tnative: GetLocalInt result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n", result);
