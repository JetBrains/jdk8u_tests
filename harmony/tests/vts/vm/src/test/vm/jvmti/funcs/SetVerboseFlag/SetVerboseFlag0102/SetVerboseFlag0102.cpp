...
const char test_case_name[] = "SetVerboseFlag0102";
...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    result = jvmti->SetVerboseFlag((jvmtiVerboseFlag)100, true);
    fprintf(stderr, "\tnative: SetVerboseFlag result = %d (must be JVMTI_ERROR_ILLEGAL_ARGUMENT (103)) \n", result);
    fflush(stderr);
