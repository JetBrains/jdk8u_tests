...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    fprintf(stderr, "\n-------------------------------------------------\n");
    fprintf(stderr, "\ntest RunAgentThread0104 is started\n{\n");
    fflush(stderr);
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->RunAgentThread(thread_1, NULL, NULL, JVMTI_THREAD_MAX_PRIORITY);

    fprintf(stderr, "\tnative: RunAgentThread result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n", result);
...
void JNICALL callbackVMDeath(prms_VMDEATH)
{
    ...
    fprintf(stderr, "\n\tTest of function RunAgentThread0104              : ");
    ...
    fprintf(stderr, "\n} /* test RunAgentThread0104 is finished */ \n");
    fflush(stderr);
}
