...
const char test_case_name[] = "GetImplementedInterfaces0105";
...
void JNICALL callbackClassPrepare(prms_CLS_PRPR)
{
    ...
    if (strcmp(signature, "Lorg/apache/harmony/vts/test/vm/jvmti/TestThread_C_09_05;")) return;
    ...
    result = jvmti_env->GetImplementedInterfaces(klass, &int_num, NULL);
    fprintf(stderr, "\tnative: GetImplementedInterfaces result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n", result);
    fflush(stderr);
