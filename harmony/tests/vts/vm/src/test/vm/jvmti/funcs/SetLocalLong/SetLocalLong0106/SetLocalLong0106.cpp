...
const char test_case_name[] = "SetLocalLong0106";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->SetLocalLong((jthread)jvmti_env, depth, slot, value_1);
    fprintf(stderr, "\tnative: SetLocalLong result = %d (must be JVMTI_ERROR_INVALID_THREAD (10)) \n", result);
