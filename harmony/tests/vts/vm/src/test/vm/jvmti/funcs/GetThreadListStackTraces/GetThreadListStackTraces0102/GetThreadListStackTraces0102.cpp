...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    fprintf(stderr, "\n-------------------------------------------------\n");
    fprintf(stderr, "\ntest GetThreadListStackTraces0102 is started\n{\n");
    fflush(stderr);
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetThreadListStackTraces(-1, threads, fc, &sinfo);
...
void JNICALL callbackVMDeath(prms_VMDEATH)
{
    ...
    fprintf(stderr, "\n\tTest of function GetThreadListStackTraces0102    : ");
    ...
    fprintf(stderr, "\n} /* test GetThreadListStackTraces0102 is finished */ \n");
    fflush(stderr);
}
