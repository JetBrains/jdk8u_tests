...
const char test_case_name[] = "GetLocalLong0106";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetLocalLong((jthread)jvmti_env, depth, slot, &value);

    fprintf(stderr, "\tnative: GetLocalLong result = %d (must be JVMTI_ERROR_INVALID_THREAD (10)) \n", result);
