...
const char test_case_name[] = "GetFieldModifiers0104";
...
void JNICALL callbackClassPrepare(prms_CLS_PRPR)
{
    ...
    if (strcmp(signature, "Lorg/apache/harmony/vts/test/vm/jvmti/GetFieldModifiers0104;")) return;
    ...
    result = jvmti_env->GetFieldModifiers(klass, my_fid, NULL);
    fprintf(stderr, "\tnative: GetFieldModifiers result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n", result);
