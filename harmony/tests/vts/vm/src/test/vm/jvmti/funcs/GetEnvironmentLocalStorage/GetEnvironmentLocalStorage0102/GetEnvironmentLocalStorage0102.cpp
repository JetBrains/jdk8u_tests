...
const char test_case_name[] = "GetEnvironmentLocalStorage0102";
...
void JNICALL callbackVMInit(prms_VMINIT)
{
    ...
    void* LS_data;
    util = true;
    jvmtiError result = jvmti_env->GetEnvironmentLocalStorage(NULL);
    fprintf(stderr, "\tnative: GetEnvironmentLocalStorage result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n", result);
    fflush(stderr);
