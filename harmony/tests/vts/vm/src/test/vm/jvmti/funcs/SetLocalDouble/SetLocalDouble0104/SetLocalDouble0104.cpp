...
const char test_case_name[] = "SetLocalFloat0104";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    fprintf(stderr, "\tnative: SetLocalFloat result = %d (must be JVMTI_ERROR_TYPE_MISMATCH (34)) \n", result);
    if (result != JVMTI_ERROR_TYPE_MISMATCH) return;
    test = true;
}
