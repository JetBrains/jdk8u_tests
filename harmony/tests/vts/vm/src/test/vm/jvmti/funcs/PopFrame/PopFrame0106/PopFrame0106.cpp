...
const char test_case_name[] = "PopFrame0106";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->PopFrame((jthread)jvmti_env);
    fprintf(stderr, "\tnative: PopFrame result = %d (must be JVMTI_ERROR_INVALID_THREAD (10)) \n", result);
