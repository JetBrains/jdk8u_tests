...
const char test_case_name[] = "GetBytecodes0105";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetBytecodes(method, NULL, &bytecodes);
    fprintf(stderr, "\tnative: GetBytecodes result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n", result);
    fflush(stderr);
