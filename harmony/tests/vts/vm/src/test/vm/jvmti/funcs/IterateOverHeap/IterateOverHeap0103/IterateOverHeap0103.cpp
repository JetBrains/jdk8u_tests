...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    fprintf(stderr, "\n-------------------------------------------------\n");
    fprintf(stderr, "\ntest IterateOverHeap0103 is started\n{\n");
    fflush(stderr);
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    fprintf(stderr, "\tnative: IterateOverHeap result = %d (must be JVMTI_ERROR_ILLEGAL_ARGUMENT (103)) \n",
            result);
...
void JNICALL callbackVMDeath(prms_VMDEATH)
{
    ...
    fprintf(stderr, "\n\tTest of function IterateOverHeap0103  : ");
    ...
    fprintf(stderr, "\n} /* test IterateOverHeap0103 is finished */ \n");
    fflush(stderr);
}
