...
const char test_case_name[] = "GetLocalInt0106";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetLocalInt((jthread)jvmti_env, depth, slot, &value);

    fprintf(stderr, "\tnative: GetLocalInt result = %d (must be JVMTI_ERROR_INVALID_THREAD (10)) \n", result);
