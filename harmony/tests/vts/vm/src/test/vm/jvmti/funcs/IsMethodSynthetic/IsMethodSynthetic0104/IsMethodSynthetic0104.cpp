...
const char test_case_name[] = "IsMethodSynthetic0104";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->IsMethodSynthetic(method, NULL);

    fprintf(stderr, "\tnative: IsMethodSynthetic result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n", result);
    fflush(stderr);
