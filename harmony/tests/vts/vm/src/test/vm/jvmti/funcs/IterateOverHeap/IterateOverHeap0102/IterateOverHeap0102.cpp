...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    fprintf(stderr, "\n-------------------------------------------------\n");
    fprintf(stderr, "\ntest IterateOverHeap0102 is started\n{\n");
    fflush(stderr);
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    { /* block for turning off can_tag_objects capability */
        ...
        fprintf(stderr, "\tnative: RelinquishCapabilities result = %d (must be JVMTI_ERROR_MUST_POSSESS_CAPABILITY (99)) \n", result);
    }
...
void JNICALL callbackVMDeath(prms_VMDEATH)
{
    ...
    fprintf(stderr, "\n\tTest of function IterateOverHeap0102  : ");
    ...
    fprintf(stderr, "\n} /* test IterateOverHeap0102 is finished */ \n");
    fflush(stderr);
}
