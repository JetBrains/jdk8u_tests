...
const char test_case_name[] = "SetEventNotificationMode0102";
...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    jvmtiError result = jvmti->SetEventNotificationMode(JVMTI_ENABLE, JVMTI_EVENT_EXCEPTION, (jthread)jvmti);
    fprintf(stderr, "\tnative: SetEventNotificationMode result = %d (must be JVMTI_ERROR_INVALID_THREAD (10)) \n", result);
