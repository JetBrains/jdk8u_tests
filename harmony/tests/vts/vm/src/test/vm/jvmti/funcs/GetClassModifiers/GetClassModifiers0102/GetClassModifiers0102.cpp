...
const char test_case_name[] = "GetClassModifiers0102";
...
void JNICALL callbackClassLoad(prms_CLS_LD)
{
    ...
    if (strcmp(signature, "Lorg/apache/harmony/vts/test/vm/jvmti/GetClassModifiers0102;")) return;
    ...
    result = jvmti_env->GetClassModifiers((jclass)thread, &mods);
    fprintf(stderr, "\tnative: GetClassModifiers result = %d (must be JVMTI_ERROR_INVALID_CLASS (21)) \n", result);
    fflush(stderr);
