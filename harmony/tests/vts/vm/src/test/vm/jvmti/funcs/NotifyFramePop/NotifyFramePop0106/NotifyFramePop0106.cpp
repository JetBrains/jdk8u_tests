...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    fprintf(stderr, "\n-------------------------------------------------\n");
    fprintf(stderr, "\ntest NotifyFramePop0106 is started\n{\n");
    fflush(stderr);
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    fprintf(stderr, "\tnative: NotifyFramePop result = %d (must be JVMTI_ERROR_THREAD_NOT_ALIVE (15)) \n", result);
...
void JNICALL callbackVMDeath(prms_VMDEATH)
{
    ...
    fprintf(stderr, "\n\tTest of function NotifyFramePop0106              : ");
    ...
    fprintf(stderr, "\n} /* test NotifyFramePop0106 is finished */ \n");
    fflush(stderr);
}
