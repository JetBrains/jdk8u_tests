...
const char test_case_name[] = "GetBytecodes0103";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetBytecodes((jmethodID)jvmti_env, &count, &bytecodes);
    fprintf(stderr, "\tnative: GetBytecodes result = %d (must be JVMTI_ERROR_INVALID_METHODID (23)) \n", result);
    fflush(stderr);
