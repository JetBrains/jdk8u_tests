...
const char test_case_name[] = "IsMethodObsolete0103";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->IsMethodObsolete((jmethodID)((int)exception + 7), &obsolete);
    fprintf(stderr, "\tnative: IsMethodObsolete result = %d (must be JVMTI_ERROR_INVALID_METHODID (23)) \n", result);
    fflush(stderr);
