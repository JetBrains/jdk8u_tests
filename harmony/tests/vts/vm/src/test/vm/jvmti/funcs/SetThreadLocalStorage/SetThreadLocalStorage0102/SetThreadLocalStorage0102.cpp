...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    fprintf(stderr, "\n-------------------------------------------------\n");
    fprintf(stderr, "\ntest SetThreadLocalStorage0102 is started\n{\n");
    fflush(stderr);
...
void JNICALL callbackThreadStart(prms_THRD_START)
{
    ...
    util = true;
    fprintf(stderr, "\tnative: SetThreadLocalStorage with INVALID Thread \n");
    result = jvmti_env->SetThreadLocalStorage(thread_x, (void*)data);
    fprintf(stderr, "\tnative: SetThreadLocalStorage result = %d (must be JVMTI_ERROR_INVALID_THREAD (10)) \n",
            result);
...
void JNICALL callbackVMDeath(prms_VMDEATH)
{
    ...
    fprintf(stderr, "\n\tTest of function SetThreadLocalStorage0102       : ");
    ...
    fprintf(stderr, "\n} /* test SetThreadLocalStorage0102 is finished */ \n");
    fflush(stderr);
}
