...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->SetTag(NULL, tag_s);
    fprintf(stderr, "\tnative: SetTag result = %d (must be JVMTI_ERROR_INVALID_OBJECT (20)) \n", result);
