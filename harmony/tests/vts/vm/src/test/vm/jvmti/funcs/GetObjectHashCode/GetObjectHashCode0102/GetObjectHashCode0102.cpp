...
const char test_case_name[] = "GetObjectHashCode0102";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetObjectHashCode(NULL, &hash_code );
    fprintf(stderr, "\tnative: GetObjectHashCode result = %d (must be JVMTI_ERROR_INVALID_OBJECT (20)) \n", result);
    fflush(stderr);
