...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    fprintf(stderr, "\n-------------------------------------------------\n");
    fprintf(stderr, "\ntest GetFrameCount0104 is started\n{\n");
    fflush(stderr);
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetFrameCount(NULL, NULL);
    fprintf(stderr, "\tnative: GetFrameCount result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n", result);
...
void JNICALL callbackVMDeath(prms_VMDEATH)
{
    ...
    fprintf(stderr, "\n\tTest of function GetFrameCount0104               : ");
    ...
    fprintf(stderr, "\n} /* test GetFrameCount0104 is finished */ \n");
    fflush(stderr);
}
