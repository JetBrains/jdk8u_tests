...
/**
 * test of function GetObjectsWithTag0102
 */
...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    fprintf(stderr, "\n-------------------------------------------------\n");
    fprintf(stderr, "\ntest GetObjectsWithTag0102 is started\n{\n");
    fflush(stderr);
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    fprintf(stderr, "\tnative: GetObjectsWithTags result = %d (must be JVMTI_ERROR_MUST_POSSESS_CAPABILITY (99)) \n", result);
...
void JNICALL callbackVMDeath(prms_VMDEATH)
{
    ...
    fprintf(stderr, "\n\tTest of function GetObjectsWithTags0102               : ");
    ...
    fprintf(stderr, "\n} /* test GetObjectsWithTags0102 is finished */ \n");
    fflush(stderr);
}
