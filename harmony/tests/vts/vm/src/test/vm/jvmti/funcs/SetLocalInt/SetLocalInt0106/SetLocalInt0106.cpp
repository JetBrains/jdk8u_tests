...
const char test_case_name[] = "SetLocalInt0106";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->SetLocalInt((jthread)jvmti_env, depth, slot, value_1);
    fprintf(stderr, "\tnative: SetLocalInt result = %d (must be JVMTI_ERROR_INVALID_THREAD (10)) \n", result);
