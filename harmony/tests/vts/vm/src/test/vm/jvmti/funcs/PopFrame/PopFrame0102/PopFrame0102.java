    ...
    static public void main(String args[]) {
        new Thread("agent") {
            ...
            public void sub_special() {
                if (PopFrame0102.stop) return;
                System.err.print("\tjava: method (sub_special) is paused...\n");
                while (PopFrame0102.pause1) {
                    PopFrame0102.pause2 = false;
                    long x = 1;
        ...
        new Thread("control") {
            ...
            public void special_method() {
                ...
                PopFrame0102.pause1 = false;
                PopFrame0102.stop = true;
