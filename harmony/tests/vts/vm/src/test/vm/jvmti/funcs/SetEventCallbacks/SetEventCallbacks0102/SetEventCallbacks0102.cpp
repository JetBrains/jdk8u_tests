...
const char test_case_name[] = "SetEventCallbacks0102";
...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    /* set event callbacks for check */
    jvmtiError result = jvmti->SetEventCallbacks( &cb, -100);
    fprintf(stderr, "\tnative: SetEventCallbacks result = %d (must be JVMTI_ERROR_ILLEGAL_ARGUMENT (103)) \n", result);
