...
const char test_case_name[] = "GetExtensionFunctions0101";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetExtensionFunctions(&counter, &ext_funcs);
    fprintf(stderr, "\tnative: GetExtensionFunctions result = %d (must be zero) \n", result);
    fprintf(stderr, "\tnative: counter is %d \n", counter);
    fprintf(stderr, "\tnative: ext_funcs ptr is %p \n", ext_funcs);
