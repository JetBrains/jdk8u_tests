...
const char test_case_name[] = "GetExtensionEvents0103";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetExtensionEvents(&counter, NULL);
    fprintf(stderr, "\tnative: GetExtensionEvents result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n", result);
    fflush(stderr);
