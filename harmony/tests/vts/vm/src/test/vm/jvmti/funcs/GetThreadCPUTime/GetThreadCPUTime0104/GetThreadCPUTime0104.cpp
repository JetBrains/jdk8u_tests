...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetThreadCpuTime(create_not_alive_thread(jni_env, jvmti_env), &nanos);
    fprintf(stderr, "\tnative: GetThreadCpuTime result = %d (must be JVMTI_ERROR_THREAD_NOT_ALIVE (15)) \n", result);
