...
const char test_case_name[] = "GetCurrentThreadCPUTimerInfo0103";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetCurrentThreadCpuTimerInfo(NULL);
    fprintf(stderr, "\tnative: GetCurrentThreadCpuTimerInfo result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n", result);
