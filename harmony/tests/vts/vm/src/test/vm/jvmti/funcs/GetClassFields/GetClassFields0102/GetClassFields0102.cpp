...
const char test_case_name[] = "GetClassFields0102";
...
void JNICALL callbackClassLoad(prms_CLS_LD)
{
    ...
    if (strcmp(signature, "Lorg/apache/harmony/vts/test/vm/jvmti/GetClassFields0102;")) return;
    ...
    fprintf(stderr, "\tnative: GetClassFields result = %d (must be JVMTI_ERROR_CLASS_NOT_PREPARED (22)) \n", result);
    fflush(stderr);
