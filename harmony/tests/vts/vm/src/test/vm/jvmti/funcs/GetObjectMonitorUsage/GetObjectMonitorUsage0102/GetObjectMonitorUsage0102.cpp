...
const char test_case_name[] = "GetObjectMonitorUsage0102";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    CAPABILITY_TURN_OFF_VOID(can_get_monitor_info);

    result = jvmti_env->GetObjectMonitorUsage(value, &info);
    fprintf(stderr, "\tnative: GetObjectMonitorUsage result = %d (must be JVMTI_ERROR_MUST_POSSESS_CAPABILITY (99)) \n", result);
