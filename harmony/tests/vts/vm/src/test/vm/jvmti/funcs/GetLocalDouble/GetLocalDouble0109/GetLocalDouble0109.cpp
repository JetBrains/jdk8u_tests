...
const char test_case_name[] = "GetLocalDouble0109";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetLocalDouble(NULL, depth, slot, &value);

    fprintf(stderr, "\tnative: GetLocalDouble result = %d (must be JVMTI_ERROR_NO_MORE_FRAMES (31)) \n", result);
