...
public class StopThread0103 {
    ...
    static public void special_method() {        
        TestThread_T_07_0103 thread = new TestThread_T_07_0103("SuperPuperTest");
    ...
    public static void killThread(TestThread_T_07_0103 thread) {
        thread.stop = true;
        try {
            thread.join();
        } catch (Throwable tex) {
...
class TestThread_T_07_0103 extends Thread {
    boolean stop = false;
    
    TestThread_T_07_0103(String name) {
        super(name);
    }    
