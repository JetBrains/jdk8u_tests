...
const char test_case_name[] = "GetLocalVariableTable0102";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetLocalVariableTable(method, &count, &table);
    fprintf(stderr, "\tnative: GetLocalVariableTable result = %d (must be JVMTI_ERROR_MUST_POSSESS_CAPABILITY (99)) \n", result);
    fflush(stderr);
