...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    fprintf(stderr, "\n-------------------------------------------------\n");
    fprintf(stderr, "\ntest GetStackTrace0107 is started\n{\n");
    fflush(stderr);
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetStackTrace(thread, 0, 1, frames, NULL);
...
void JNICALL callbackVMDeath(prms_VMDEATH)
{
    ...
    fprintf(stderr, "\nTest of function GetStackTrace0107               : ");
    ...
    fprintf(stderr, "\n} /* test GetStackTrace0107 is finished */ \n");
    fflush(stderr);
}
