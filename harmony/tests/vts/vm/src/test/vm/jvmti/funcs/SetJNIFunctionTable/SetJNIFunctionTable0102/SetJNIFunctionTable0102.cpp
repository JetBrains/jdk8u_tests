...
const char test_case_name[] = "SetJNIFunctionTable0102";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->SetJNIFunctionTable(function_table);

    fprintf(stderr, "\tnative: SetJNIFunctionTable result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n", result);
