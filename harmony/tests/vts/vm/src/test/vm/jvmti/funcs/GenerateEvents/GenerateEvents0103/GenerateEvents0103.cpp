...
const char test_case_name[] = "GenerateEvents0103";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GenerateEvents(JVMTI_EVENT_EXCEPTION);
    fprintf(stderr, "\tnative: GenerateEvents result = %d (must be JVMTI_ERROR_ILLEGAL_ARGUMENT (103)) \n", result);
