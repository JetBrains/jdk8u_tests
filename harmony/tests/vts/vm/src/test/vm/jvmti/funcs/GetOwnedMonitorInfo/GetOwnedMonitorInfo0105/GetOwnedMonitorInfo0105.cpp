...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    fprintf(stderr, "\n-------------------------------------------------\n");
    fprintf(stderr, "\ntest GetOwnedMonitorInfo0105 is started\n{\n");
    fflush(stderr);
...
void JNICALL callbackThreadStart(prms_THRD_START)
{
    ...
    fprintf(stderr, "\tnative: GetOwnedMonitorInfo owned_monitor_count = NULL \n");

    result = jvmti_env->GetOwnedMonitorInfo(thread, NULL, &owned_monitors);
...
void JNICALL callbackVMDeath(prms_VMDEATH)
{
    ...
    fprintf(stderr, "\n\tTest of function GetOwnedMonitorInfo0105         : ");
    ...
    fprintf(stderr, "\n} /* test GetOwnedMonitorInfo0105 is finished */ \n");
    fflush(stderr);
}
