...
const char test_case_name[] = "SetLocalFloat0108";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    jint depth = -1; /* I need current function only */
    jint varnum;
    jint slot = 0;
    jfloat value_1 = 55.5;
    jvmtiError result;
    ...
    fprintf(stderr, "\tnative: SetLocalFloat result = %d (must be JVMTI_ERROR_ILLEGAL_ARGUMENT (103)) \n", result);
