...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    fprintf(stderr, "\n-------------------------------------------------\n");
    fprintf(stderr, "\ntest GetAllThreads0102 is started\n{\n");
    fflush(stderr);
...
void JNICALL callbackThreadStart(prms_THRD_START)
{
    ...
    fprintf(stderr, "\n\tnative: GetAllThreads with NULL thread counter\n");
    result = jvmti_env->GetAllThreads(NULL, &threads);
...
void JNICALL callbackVMDeath(prms_VMDEATH)
{
    ...
    fprintf(stderr, "\n\tTest of function GetAllThreads0102               : ");
    ...
    fprintf(stderr, "\n} /* test GetAllThreads0102 is finished */ \n");
    fflush(stderr);
}
