...
const char test_case_name[] = "GetLocalObject0106";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetLocalObject((jthread)jvmti_env, depth, slot, &value);

    fprintf(stderr, "\tnative: GetLocalObject result = %d (must be JVMTI_ERROR_INVALID_THREAD (10)) \n", result);
