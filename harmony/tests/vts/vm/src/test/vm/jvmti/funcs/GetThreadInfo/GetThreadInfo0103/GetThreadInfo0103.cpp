...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    fprintf(stderr, "\n-------------------------------------------------\n");
    fprintf(stderr, "\ntest GetThreadInfo0103 is started\n{\n");
    fflush(stderr);
...
void JNICALL callbackThreadStart(prms_THRD_START)
{
    ...
    fprintf(stderr, "\tnative: GetThreadInfo INFO = NULL \n");
    result = jvmti_env->GetThreadInfo(thread, NULL);
    fprintf(stderr, "\tnative: GetThreadInfo result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n", result);
...
void JNICALL callbackVMDeath(prms_VMDEATH)
{
    ...
    fprintf(stderr, "\n\tTest of function GetThreadInfo0103               : ");
    ...
    fprintf(stderr, "\n} /* test GetThreadInfo0103 is finished */ \n");
    fflush(stderr);
}
