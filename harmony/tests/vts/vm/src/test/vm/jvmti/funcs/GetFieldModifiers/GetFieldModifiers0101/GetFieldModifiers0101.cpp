...
const char test_case_name[] = "GetFieldModifiers0101";
...
void JNICALL callbackClassPrepare(prms_CLS_PRPR)
{
    ...
    if (strcmp(signature, "Lorg/apache/harmony/vts/test/vm/jvmti/GetFieldModifiers0101;")) return;
    ...
    fprintf(stderr, "\tnative: GetFieldModifiers result = %d (must be zero) \n", result);
    fprintf(stderr, "\tnative: klass ptr is %p \n", klass);
