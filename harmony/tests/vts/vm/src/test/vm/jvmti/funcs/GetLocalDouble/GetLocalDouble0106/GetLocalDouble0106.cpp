...
const char test_case_name[] = "GetLocalDouble0106";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetLocalDouble((jthread)jvmti_env, depth, slot, &value);

    fprintf(stderr, "\tnative: GetLocalDouble result = %d (must be JVMTI_ERROR_INVALID_THREAD (10)) \n", result);
