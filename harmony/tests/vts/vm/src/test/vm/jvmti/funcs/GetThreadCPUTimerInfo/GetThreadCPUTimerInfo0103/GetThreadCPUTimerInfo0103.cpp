...
const char test_case_name[] = "GetThreadCPUTimerInfo0101";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetThreadCpuTimerInfo(NULL);
    fprintf(stderr, "\tnative: GetThreadCpuTimerInfo result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n", result);
