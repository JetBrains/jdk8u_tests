...
const char test_case_name[] = "GetLocalDouble0108";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    jint depth = -100; /* I need current function only */
    jint varnum;
    jint slot = 0;
    jdouble value;
    jvmtiError result;
    ...
    fprintf(stderr, "\tnative: GetLocalDouble result = %d (must be JVMTI_ERROR_ILLEGAL_ARGUMENT (103)) \n", result);
