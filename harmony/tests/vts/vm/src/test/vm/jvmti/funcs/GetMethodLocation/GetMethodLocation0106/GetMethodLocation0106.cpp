...
const char test_case_name[] = "GetMethodLocation0106";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetMethodLocation(method, &start, NULL);
    fprintf(stderr, "\tnative: GetMethodLocation result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n", result);
