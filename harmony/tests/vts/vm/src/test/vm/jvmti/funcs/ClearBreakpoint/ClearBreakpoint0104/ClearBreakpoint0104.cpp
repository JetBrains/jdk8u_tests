...
const char test_case_name[] = "ClearBreakpoint0101";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->ClearBreakpoint(NULL, loc);
    fprintf(stderr, "\tnative: ClearBreakpoint result = %d (must be JVMTI_ERROR_INVALID_METHODID (23)) \n", result);
