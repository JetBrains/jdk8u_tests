...
const char test_case_name[] = "SetLocalFloat0106";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->SetLocalFloat((jthread)jvmti_env, depth, slot, value_1);
    fprintf(stderr, "\tnative: SetLocalFloat result = %d (must be JVMTI_ERROR_INVALID_THREAD (10)) \n", result);
