...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    fprintf(stderr, "\n-------------------------------------------------\n");
    fprintf(stderr, "\ntest GetOwnedMonitorInfo0102 is started\n{\n");
    fflush(stderr);

    CAPABILITY_TURN_OFF(can_get_owned_monitor_info);
...
void JNICALL callbackThreadStart(prms_THRD_START)
{
    ...
    fprintf(stderr, "\tnative: GetOwnedMonitorInfo w/o capability \n");
    result = jvmti_env->GetOwnedMonitorInfo(thread, &owned_monitor_count, &owned_monitors);
    fprintf(stderr, "\tnative: GetOwnedMonitorInfo result = %d (must be JVMTI_ERROR_MUST_POSSESS_CAPABILITY (99)) \n", result);
...
void JNICALL callbackVMDeath(prms_VMDEATH)
{
    ...
    fprintf(stderr, "\n\tTest of function GetOwnedMonitorInfo0102         : ");
    ...
    fprintf(stderr, "\n} /* test GetOwnedMonitorInfo0102 is finished */ \n");
    fflush(stderr);
}
