...
const char test_case_name[] = "GetArgumentsSize0102";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetArgumentsSize((jmethodID)jvmti_env, &size);
    fprintf(stderr, "\tnative: GetArgumentsSize result = %d (must be JVMTI_ERROR_INVALID_METHODID (23)) \n", result);
