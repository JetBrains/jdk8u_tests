...
const char test_case_name[] = "GetLocalDouble0107";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetLocalDouble(create_not_alive_thread(jni_env,
                jvmti_env), depth, slot, &value);

    fprintf(stderr, "\tnative: GetLocalDouble result = %d (must be JVMTI_ERROR_THREAD_NOT_ALIVE (15)) \n", result);
