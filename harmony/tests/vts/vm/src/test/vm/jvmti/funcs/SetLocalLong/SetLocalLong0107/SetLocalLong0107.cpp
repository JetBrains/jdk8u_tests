...
const char test_case_name[] = "SetLocalLong0107";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetLocalLong(create_not_alive_thread(jni_env,
                jvmti_env), depth, slot, &value_1);

    fprintf(stderr, "\tnative: SetLocalLong result = %d (must be JVMTI_ERROR_THREAD_NOT_ALIVE) \n", result);
