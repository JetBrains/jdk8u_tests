...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    fprintf(stderr, "\n-------------------------------------------------\n");
    fprintf(stderr, "\ntest GetThreadGroupChildren0105 is started\n{\n");
    fflush(stderr);
...
void JNICALL callbackThreadStart(prms_THRD_START)
{
    ...
    result = jvmti_env->GetThreadGroupChildren( tinfo.thread_group,
            &thread_counter, &thread_ptr, NULL, &group_ptr);
...
void JNICALL callbackVMDeath(prms_VMDEATH)
{
    ...
    fprintf(stderr, "\nTest of function GetThreadGroupChildren0105      : ");
    ...
    fprintf(stderr, "\n} /* test GetThreadGroupChildren0105 is finished */ \n");
    fflush(stderr);
}
