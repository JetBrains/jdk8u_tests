...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    fprintf(stderr, "\n-------------------------------------------------\n");
    fprintf(stderr, "\ntest GetThreadListStackTraces0105 is started\n{\n");
    fflush(stderr);
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetThreadListStackTraces(tc, threads, fc, NULL);
    fprintf(stderr, "\tnative: GetThreadListStackTraces result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n",
            result);
...
void JNICALL callbackVMDeath(prms_VMDEATH)
{
    ...
    fprintf(stderr, "\n\tTest of function GetThreadListStackTraces0105    : ");
    ...
    fprintf(stderr, "\n} /* test GetThreadListStackTraces0105 is finished */ \n");
    fflush(stderr);
}
