...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    fprintf(stderr, "\n-------------------------------------------------\n");
    fprintf(stderr, "\ntest GetFrameLocation0105 is started\n{\n");
    fflush(stderr);
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    char* signature;
    char* generic;
    jint depth = 10000; /* I need current function only */
    jvmtiPhase phase;
    jvmtiError result;
    jmethodID mid;
    jlocation loc;
    ...
    fprintf(stderr, "\tnative: GetFrameLocation result = %d (must be JVMTI_ERROR_NO_MORE_FRAMES (31)) \n", result);

    if (result == JVMTI_ERROR_NO_MORE_FRAMES) test = true;
}
...
void JNICALL callbackVMDeath(prms_VMDEATH)
{
    ...
    fprintf(stderr, "\n\tTest of function GetFrameLocation0105            : ");
    ...
    fprintf(stderr, "\n} /* test GetFrameLocation0105 is finished */ \n");
    fflush(stderr);
}
