...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    fprintf(stderr, "\n-------------------------------------------------\n");
    fprintf(stderr, "\ntest GetThreadInfo0102 is started\n{\n");
    fflush(stderr);
...
void JNICALL callbackThreadStart(prms_THRD_START)
{
    ...
    jvmtiError result;
    jthread thread_x = (jthread)(((char *)*((void **)thread)) + 3);
    ...
    fprintf(stderr, "\tnative: GetThreadInfo INVALID thread \n");
    result = jvmti_env->GetThreadInfo(thread_x, &tinfo);
    fprintf(stderr, "\tnative: GetThreadInfo result = %d (must be JVMTI_ERROR_INVALID_THREAD (10)) \n", result);
...
void JNICALL callbackVMDeath(prms_VMDEATH)
{
    ...
    fprintf(stderr, "\n\tTest of function GetThreadInfo0102               : ");
    ...
    fprintf(stderr, "\n} /* test GetThreadInfo0102 is finished */ \n");
    fflush(stderr);
}
