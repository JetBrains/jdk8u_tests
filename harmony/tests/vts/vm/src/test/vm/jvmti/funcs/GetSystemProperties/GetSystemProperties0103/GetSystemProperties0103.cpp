...
const char test_case_name[] = "GetSystemProperties0103";
...
void JNICALL callbackVMInit(prms_VMINIT)
{
    ...
    result = jvmti_env->GetSystemProperties(&count,  NULL);
    fprintf(stderr, "\tnative: GetSystemProperties result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n", result);
