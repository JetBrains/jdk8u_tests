...
const char test_case_name[] = "GetImplementedInterfaces0103";
...
void JNICALL callbackClassPrepare(prms_CLS_PRPR) {
    ...
    if (strcmp(signature, "Lorg/apache/harmony/vts/test/vm/jvmti/TestThread_C_09_03;")) return;
    ...
    result = jvmti_env->GetImplementedInterfaces((jclass)thread, &int_num, &ints);
    fprintf(stderr, "\tnative: GetImplementedInterfaces result = %d (must be JVMTI_ERROR_INVALID_CLASS (21)) \n", result);
    fflush(stderr);
