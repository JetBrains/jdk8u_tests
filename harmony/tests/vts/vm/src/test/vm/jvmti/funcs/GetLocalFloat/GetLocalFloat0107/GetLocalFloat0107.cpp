...
const char test_case_name[] = "GetLocalFloat0107";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetLocalFloat(create_not_alive_thread(jni_env,
                jvmti_env), depth, slot, &value);

    fprintf(stderr, "\tnative: GetLocalFloat result = %d (must be JVMTI_ERROR_THREAD_NOT_ALIVE (15)) \n", result);
