...
const char test_case_name[] = "GetCurrentThreadCPUTime0103";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetCurrentThreadCpuTime(NULL);
    fprintf(stderr, "\tnative: GetCurrentThreadCpuTime result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n", result);
