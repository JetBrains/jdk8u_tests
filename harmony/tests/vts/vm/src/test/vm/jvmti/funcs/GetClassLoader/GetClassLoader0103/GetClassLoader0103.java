 ...
 *
 */ 
public class GetClassLoader0103 {

    static public void main(String args[]) {

        CustomClassLoader_GetClassLoader0103 ccl = new CustomClassLoader_GetClassLoader0103();
...
class CustomClassLoader_GetClassLoader0103 extends ClassLoader {
    int fake = 0;
}
