...
const char test_case_name[] = "GetArgumentsSize0104";
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetArgumentsSize(method, NULL);
    fprintf(stderr, "\tnative: GetArgumentsSize result = %d (must be JVMTI_ERROR_NULL_POINTER (100)) \n", result);
