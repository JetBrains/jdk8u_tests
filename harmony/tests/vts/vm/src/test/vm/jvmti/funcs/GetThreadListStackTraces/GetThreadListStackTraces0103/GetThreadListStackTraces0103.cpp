...
JNIEXPORT jint JNICALL Agent_OnLoad(prms_AGENT_ONLOAD)
{
    ...
    fprintf(stderr, "\n-------------------------------------------------\n");
    fprintf(stderr, "\ntest GetThreadListStackTraces0103 is started\n{\n");
    fflush(stderr);
...
void JNICALL callbackException(prms_EXCPT)
{
    ...
    result = jvmti_env->GetThreadListStackTraces(tc, NULL, fc, &sinfo);
...
void JNICALL callbackVMDeath(prms_VMDEATH)
{
    ...
    fprintf(stderr, "\n\tTest of function GetThreadListStackTraces0103    : ");
    ...
    fprintf(stderr, "\n} /* test GetThreadListStackTraces0103 is finished */ \n");
    fflush(stderr);
}
