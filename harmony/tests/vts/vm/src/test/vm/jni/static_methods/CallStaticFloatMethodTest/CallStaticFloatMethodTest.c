...
/*
 * Method: org.apache.harmony.vts.test.vm.jni.static_methods.CallStaticFloatMethodTest.nativeExecute(Lorg/apache/harmony/vts/test/vm/jni/static_methods/TestClass;Lorg/apache/harmony/vts/test/vm/jni/static_methods/NativeTestClass;)Z
 */
JNIEXPORT jboolean JNICALL
Java_org_apache_harmony_vts_test_vm_jni_static_1methods_CallStaticFloatMethodTest_nativeExecute
    (JNIEnv *env, jobject this_object, jobject tc, jobject ntc)
{
    ...
    result1 = (*env)->CallStaticFloatMethod(env, class1, m1, ARG1);
    result2 = (*env)->CallStaticFloatMethod(env, class1, m2, ARG1, ARG22);
    result3 = (*env)->CallStaticFloatMethod(env, class1, m3, ar3);
    result4 = (*env)->CallStaticFloatMethod(env, class1, m4, ar3, ar42);
    result5 = (*env)->CallStaticFloatMethod(env, class1, m5, fo5);
    result6 = (*env)->CallStaticFloatMethod(env, class1, m6, fo5, fo62);

    nresult1 = (*env)->CallStaticFloatMethod(env, class2, nm1, ARG1);
    nresult2 = (*env)->CallStaticFloatMethod(env, class2, nm2, ARG1, ARG22);
    nresult3 = (*env)->CallStaticFloatMethod(env, class2, nm3, ar3);
    nresult4 = (*env)->CallStaticFloatMethod(env, class2, nm4, ar3, ar42);
    nresult5 = (*env)->CallStaticFloatMethod(env, class2, nm5, fo5);
    nresult6 = (*env)->CallStaticFloatMethod(env, class2, nm6, fo5, fo62);
