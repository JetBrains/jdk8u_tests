 ...
 *
 * Test for SetFloatField function.
 */
public class SetFloatFieldTest extends JNITest {
    private native boolean nativeExecute(Object obj, String field, float val); 
    ...
    public boolean execute() throws Exception {
        ...
        res1 = nativeExecute(tc, "fpub", arg1);
        res2 = nativeExecute(tc, "fprot", arg2);
        res3 = nativeExecute(tc, "fpriv", arg3);
        f1 = tc.getFpub();
        f2 = tc.getFprot();
        f3 = tc.getFpriv();
    ...
    public static void main(String[] args){
        System.exit(new SetFloatFieldTest().test());
    }
}