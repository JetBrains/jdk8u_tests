...
/**
 * Test for Get/ReleaseLongArrayElements function.
 */
public class GetReleaseLongArrayElementsTest extends JNITest {
    private native void nativeExecute(long [] array, int length);
    ...
    public boolean execute() throws Exception {
        int length = 15;
        long mass[] = new long[length];
        for (int i = 0; i < length; i++){ mass[i] = (long)(i*i); }
    ...
    public static void main(String[] args){
        System.exit(new GetReleaseLongArrayElementsTest().test());
    }
}