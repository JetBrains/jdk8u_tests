 ...
 *
 * Test for CallNonvirtualBooleanMethodA function.
 */
public class CallNonvirtualBooleanMethodATest extends JNITest {
    private native boolean nativeExecute(ChildTestClass tc, Class parenttc,
            ChildNativeTestClass ntc, Class parentntc);

    /**
     * Test calls various methods that return boolean of supplied
    ...
    public static void main(String[] args){
        System.exit(new CallNonvirtualBooleanMethodATest().test());
    }
}