 ...
 *
 * Test for GetStringChars and ReleaseStringChars functions
 */
public class GetReleaseStringCharsTest extends JNITest {
    ...
    public static void main(String[] args){
        System.exit(new GetReleaseStringCharsTest().test());
    }
}