...
static jobject callNI(JNIEnv *env, jobject obj, jmethodID mid, ...)
{
    va_list args;
        jobject result;
...
/*
 * Method: org.apache.harmony.vts.test.vm.jni.object_methods.CallObjectMethodVTest.nativeExecute(Lorg/apache/harmony/vts/test/vm/jni/object_methods/TestClass;Lorg/apache/harmony/vts/test/vm/jni/object_methods/NativeTestClass;)Z
 */
JNIEXPORT jboolean JNICALL
Java_org_apache_harmony_vts_test_vm_jni_object_1methods_CallObjectMethodVTest_nativeExecute
    (JNIEnv *env, jobject this_object, jobject tc, jobject ntc)
{
    ...
    oz = callNI(env, tc, zm, ZARG1, ZARG2, ZARG3);
    ob = callNI(env, tc, bm, BARG1, BARG2, BARG3);
    oc = callNI(env, tc, cm, CARG1, CARG2, CARG3);
    os = callNI(env, tc, sm, SARG1, SARG2, SARG3);
    oi = callNI(env, tc, im, IARG1, IARG2, IARG3);
    oj = callNI(env, tc, jm, JARG1, JARG2, JARG3);
    of = callNI(env, tc, fm, FARG1, FARG2, FARG3);
    od = callNI(env, tc, dm, DARG1, DARG2, DARG3);

    noz = callNI(env, ntc, nzm, ZARG1, ZARG2, ZARG3);
    nob = callNI(env, ntc, nbm, BARG1, BARG2, BARG3);
    noc = callNI(env, ntc, ncm, CARG1, CARG2, CARG3);
    nos = callNI(env, ntc, nsm, SARG1, SARG2, SARG3);
    noi = callNI(env, ntc, nim, IARG1, IARG2, IARG3);
    noj = callNI(env, ntc, njm, JARG1, JARG2, JARG3);
    nof = callNI(env, ntc, nfm, FARG1, FARG2, FARG3);
    nod = callNI(env, ntc, ndm, DARG1, DARG2, DARG3);
