...
static jfloat callNI(JNIEnv *env, jobject obj, jclass parentcl, jmethodID mid, ...)
{
    va_list args;
    jfloat result;

    va_start(args, mid);
    result = (*env)->CallNonvirtualFloatMethodV(env, obj, parentcl, mid, args);
    va_end(args);
    return result;
}

/*
 * Method: org.apache.harmony.vts.test.vm.jni.object_methods.CallNonvirtualFloatMethodVTest.nativeExecute(Lorg/apache/harmony/vts/test/vm/jni/object_methods/ChildTestClass;Ljava/lang/Class;Lorg/apache/harmony/vts/test/vm/jni/object_methods/ChildNativeTestClass;Ljava/lang/Class;)Z
 */
JNIEXPORT jboolean JNICALL
Java_org_apache_harmony_vts_test_vm_jni_object_1methods_CallNonvirtualFloatMethodVTest_nativeExecute
    (JNIEnv *env, jobject this_object, jobject tc, jclass parenttc, jobject ntc, jclass parentntc)
{
    ...
    result5 = callNI(env, tc, parenttc, m5, fo5);
    result6 = callNI(env, tc, parenttc, m6, fo5, fo62);
    ...
    nresult5 = callNI(env, ntc, parentntc, nm5, fo5);
    nresult6 = callNI(env, ntc, parentntc, nm6, fo5, fo62);
