 ...
 *
 * Test for CallNonvirtualCharMethodA function.
 */
public class CallNonvirtualCharMethodATest extends JNITest {
    ...
    public static void main(String[] args){
        System.exit(new CallNonvirtualCharMethodATest().test());
    }
}