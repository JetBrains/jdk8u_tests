 ...
 *
 * Test for SetObjectField function.
 */
public class SetObjectFieldTest extends JNITest {
    private native boolean nativeExecute(Object obj, String field, Object val); 
    ...
    public boolean execute() throws Exception {
        ...
        res1 = nativeExecute(tc, "lpub", arg1);
        res2 = nativeExecute(tc, "lprot", arg2);
        res3 = nativeExecute(tc, "lpriv", arg3);
        f1 = tc.getLpub();
        f2 = tc.getLprot();
        f3 = tc.getLpriv();
    ...
    public static void main(String[] args){
        System.exit(new SetObjectFieldTest().test());
    }
}