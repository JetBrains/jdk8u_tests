 ...
 *
 * Test for CallNonvirtualShortMethodV function.
 */
public class CallNonvirtualShortMethodVTest extends JNITest {
    ...
    public static void main(String[] args){
        System.exit(new CallNonvirtualShortMethodVTest().test());
    }
}