 ...
 * 
 * Test for GetStringUTFChars and ReleaseStringUTFChars functions
 */
public class GetReleaseStringUTFCharsTest extends JNITest {
    private native byte[] nativeExecute(String str);
    ...
    public static void main(String[] args){
        System.exit(new GetReleaseStringUTFCharsTest().test());
    }
}