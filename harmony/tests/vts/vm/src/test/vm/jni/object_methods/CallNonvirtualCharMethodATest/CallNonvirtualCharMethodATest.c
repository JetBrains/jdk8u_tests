...
/*
 * Method: org.apache.harmony.vts.test.vm.jni.object_methods.CallNonvirtualCharMethodATest.nativeExecute(Lorg/apache/harmony/vts/test/vm/jni/object_methods/ChildTestClass;Ljava/lang/Class;Lorg/apache/harmony/vts/test/vm/jni/object_methods/ChildNativeTestClass;Ljava/lang/Class;)Z
 */
JNIEXPORT jboolean JNICALL
Java_org_apache_harmony_vts_test_vm_jni_object_1methods_CallNonvirtualCharMethodATest_nativeExecute
    (JNIEnv *env, jobject this_object, jobject tc, jclass parenttc, jobject ntc, jclass parentntc)
{
    ...
    result1 = (*env)->CallNonvirtualCharMethodA(env, tc, parenttc, m1, args1);
    result2 = (*env)->CallNonvirtualCharMethodA(env, tc, parenttc, m2, args2);
    result3 = (*env)->CallNonvirtualCharMethodA(env, tc, parenttc, m3, args3);
    result4 = (*env)->CallNonvirtualCharMethodA(env, tc, parenttc, m4, args4);
    result5 = (*env)->CallNonvirtualCharMethodA(env, tc, parenttc, m5, args5);
    result6 = (*env)->CallNonvirtualCharMethodA(env, tc, parenttc, m6, args6);

    nresult1 = (*env)->CallNonvirtualCharMethodA(env, ntc, parentntc, nm1, args1);
    nresult2 = (*env)->CallNonvirtualCharMethodA(env, ntc, parentntc, nm2, args2);
    nresult3 = (*env)->CallNonvirtualCharMethodA(env, ntc, parentntc, nm3, args3);
    nresult4 = (*env)->CallNonvirtualCharMethodA(env, ntc, parentntc, nm4, args4);
    nresult5 = (*env)->CallNonvirtualCharMethodA(env, ntc, parentntc, nm5, args5);
    nresult6 = (*env)->CallNonvirtualCharMethodA(env, ntc, parentntc, nm6, args6);
