...
/**
 * Test for Get/ReleaseShortArrayElements function.
 */
public class GetReleaseShortArrayElementsTest extends JNITest {
    private native void nativeExecute(short [] array, int length);
    ...
    public boolean execute() throws Exception {
        int length = 15;
        short mass[] = new short[length];
        for (int i = 0; i < length; i++){ mass[i] = (short)i; }
    ...
    public static void main(String[] args){
        System.exit(new GetReleaseShortArrayElementsTest().test());
    }
}