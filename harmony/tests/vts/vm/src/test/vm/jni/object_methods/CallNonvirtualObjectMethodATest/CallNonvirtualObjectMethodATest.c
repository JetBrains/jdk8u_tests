...
/*
 * Method: org.apache.harmony.vts.test.vm.jni.object_methods.CallNonvirtualObjectMethodATest.nativeExecute(Lorg/apache/harmony/vts/test/vm/jni/object_methods/ChildTestClass;Ljava/lang/Class;Lorg/apache/harmony/vts/test/vm/jni/object_methods/ChildNativeTestClass;Ljava/lang/Class;)Z
 */
JNIEXPORT jboolean JNICALL
Java_org_apache_harmony_vts_test_vm_jni_object_1methods_CallNonvirtualObjectMethodATest_nativeExecute
    (JNIEnv *env, jobject this_object, jobject tc, jclass parenttc, jobject ntc, jclass parentntc)
{
    ...
    oz = (*env)->CallNonvirtualObjectMethodA(env, tc, parenttc, zm, zargs);
    ob = (*env)->CallNonvirtualObjectMethodA(env, tc, parenttc, bm, bargs);
    oc = (*env)->CallNonvirtualObjectMethodA(env, tc, parenttc, cm, cargs);
    os = (*env)->CallNonvirtualObjectMethodA(env, tc, parenttc, sm, sargs);
    oi = (*env)->CallNonvirtualObjectMethodA(env, tc, parenttc, im, iargs);
    oj = (*env)->CallNonvirtualObjectMethodA(env, tc, parenttc, jm, jargs);
    of = (*env)->CallNonvirtualObjectMethodA(env, tc, parenttc, fm, fargs);
    od = (*env)->CallNonvirtualObjectMethodA(env, tc, parenttc, dm, dargs);

    noz = (*env)->CallNonvirtualObjectMethodA(env, ntc, parentntc, nzm, zargs);
    nob = (*env)->CallNonvirtualObjectMethodA(env, ntc, parentntc, nbm, bargs);
    noc = (*env)->CallNonvirtualObjectMethodA(env, ntc, parentntc, ncm, cargs);
    nos = (*env)->CallNonvirtualObjectMethodA(env, ntc, parentntc, nsm, sargs);
    noi = (*env)->CallNonvirtualObjectMethodA(env, ntc, parentntc, nim, iargs);
    noj = (*env)->CallNonvirtualObjectMethodA(env, ntc, parentntc, njm, jargs);
    nof = (*env)->CallNonvirtualObjectMethodA(env, ntc, parentntc, nfm, fargs);
    nod = (*env)->CallNonvirtualObjectMethodA(env, ntc, parentntc, ndm, dargs);
