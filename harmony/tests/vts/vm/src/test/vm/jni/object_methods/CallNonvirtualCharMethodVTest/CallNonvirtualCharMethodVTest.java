 ...
 *
 * Test for CallNonvirtualCharMethodV function.
 */
public class CallNonvirtualCharMethodVTest extends JNITest {
    ...
    public static void main(String[] args){
        System.exit(new CallNonvirtualCharMethodVTest().test());
    }
}