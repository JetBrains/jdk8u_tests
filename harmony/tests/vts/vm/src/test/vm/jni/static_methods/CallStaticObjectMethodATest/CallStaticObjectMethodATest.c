...
/*
 * Method: org.apache.harmony.vts.test.vm.jni.static_methods.CallStaticObjectMethodATest.nativeExecute(Lorg/apache/harmony/vts/test/vm/jni/static_methods/TestClass;Lorg/apache/harmony/vts/test/vm/jni/static_methods/NativeTestClass;)Z
 */
JNIEXPORT jboolean JNICALL
Java_org_apache_harmony_vts_test_vm_jni_static_1methods_CallStaticObjectMethodATest_nativeExecute
    (JNIEnv *env, jobject this_object, jobject tc, jobject ntc)
{
    ...
    oz = (*env)->CallStaticObjectMethodA(env, class1, zm, zargs);
    ob = (*env)->CallStaticObjectMethodA(env, class1, bm, bargs);
    oc = (*env)->CallStaticObjectMethodA(env, class1, cm, cargs);
    os = (*env)->CallStaticObjectMethodA(env, class1, sm, sargs);
    oi = (*env)->CallStaticObjectMethodA(env, class1, im, iargs);
    oj = (*env)->CallStaticObjectMethodA(env, class1, jm, jargs);
    of = (*env)->CallStaticObjectMethodA(env, class1, fm, fargs);
    od = (*env)->CallStaticObjectMethodA(env, class1, dm, dargs);

    noz = (*env)->CallStaticObjectMethodA(env, class2, nzm, zargs);
    nob = (*env)->CallStaticObjectMethodA(env, class2, nbm, bargs);
    noc = (*env)->CallStaticObjectMethodA(env, class2, ncm, cargs);
    nos = (*env)->CallStaticObjectMethodA(env, class2, nsm, sargs);
    noi = (*env)->CallStaticObjectMethodA(env, class2, nim, iargs);
    noj = (*env)->CallStaticObjectMethodA(env, class2, njm, jargs);
    nof = (*env)->CallStaticObjectMethodA(env, class2, nfm, fargs);
    nod = (*env)->CallStaticObjectMethodA(env, class2, ndm, dargs);
