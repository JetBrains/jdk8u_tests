...
/*
 * Method: org.apache.harmony.vts.test.vm.jni.static_methods.CallStaticFloatMethodATest.nativeExecute(Lorg/apache/harmony/vts/test/vm/jni/static_methods/TestClass;Lorg/apache/harmony/vts/test/vm/jni/static_methods/NativeTestClass;)Z
 */
JNIEXPORT jboolean JNICALL
Java_org_apache_harmony_vts_test_vm_jni_static_1methods_CallStaticFloatMethodATest_nativeExecute
    (JNIEnv *env, jobject this_object, jobject tc, jobject ntc)
{
    ...
    result1 = (*env)->CallStaticFloatMethodA(env, class1, m1, args1);
    result2 = (*env)->CallStaticFloatMethodA(env, class1, m2, args2);
    result3 = (*env)->CallStaticFloatMethodA(env, class1, m3, args3);
    result4 = (*env)->CallStaticFloatMethodA(env, class1, m4, args4);
    result5 = (*env)->CallStaticFloatMethodA(env, class1, m5, args5);
    result6 = (*env)->CallStaticFloatMethodA(env, class1, m6, args6);

    nresult1 = (*env)->CallStaticFloatMethodA(env, class2, nm1, args1);
    nresult2 = (*env)->CallStaticFloatMethodA(env, class2, nm2, args2);
    nresult3 = (*env)->CallStaticFloatMethodA(env, class2, nm3, args3);
    nresult4 = (*env)->CallStaticFloatMethodA(env, class2, nm4, args4);
    nresult5 = (*env)->CallStaticFloatMethodA(env, class2, nm5, args5);
    nresult6 = (*env)->CallStaticFloatMethodA(env, class2, nm6, args6);
