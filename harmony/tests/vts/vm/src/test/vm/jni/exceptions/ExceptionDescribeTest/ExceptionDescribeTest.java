 ...
 *
 * Test for ExceptionDescribe function
 */
public class ExceptionDescribeTest extends JNITest {
    private native boolean nativeExecute();

    /**
     * Native code throws an exception and uses ExceptionDescribe
    ...
    public static void main(String[] args){
        System.exit(new ExceptionDescribeTest().test());
    }
}