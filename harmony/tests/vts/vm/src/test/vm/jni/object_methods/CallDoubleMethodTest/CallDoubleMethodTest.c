...
/*
 * Method: org.apache.harmony.vts.test.vm.jni.object_methods.CallDoubleMethodTest.nativeExecute(Lorg/apache/harmony/vts/test/vm/jni/object_methods/TestClass;Lorg/apache/harmony/vts/test/vm/jni/object_methods/NativeTestClass;)Z
 */
JNIEXPORT jboolean JNICALL
Java_org_apache_harmony_vts_test_vm_jni_object_1methods_CallDoubleMethodTest_nativeExecute
    (JNIEnv *env, jobject this_object, jobject tc, jobject ntc)
{
    ...
    result1 = (*env)->CallDoubleMethod(env, tc, m1, ARG1);
    result2 = (*env)->CallDoubleMethod(env, tc, m2, ARG1, ARG22);
    result3 = (*env)->CallDoubleMethod(env, tc, m3, ar3);
    result4 = (*env)->CallDoubleMethod(env, tc, m4, ar3, ar42);
    result5 = (*env)->CallDoubleMethod(env, tc, m5, do5);
    result6 = (*env)->CallDoubleMethod(env, tc, m6, do5, do62);

    nresult1 = (*env)->CallDoubleMethod(env, ntc, nm1, ARG1);
    nresult2 = (*env)->CallDoubleMethod(env, ntc, nm2, ARG1, ARG22);
    nresult3 = (*env)->CallDoubleMethod(env, ntc, nm3, ar3);
    nresult4 = (*env)->CallDoubleMethod(env, ntc, nm4, ar3, ar42);
    nresult5 = (*env)->CallDoubleMethod(env, ntc, nm5, do5);
    nresult6 = (*env)->CallDoubleMethod(env, ntc, nm6, do5, do62);
