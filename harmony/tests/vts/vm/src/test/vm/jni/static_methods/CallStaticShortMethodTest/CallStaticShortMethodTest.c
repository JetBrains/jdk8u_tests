...
/*
 * Method: org.apache.harmony.vts.test.vm.jni.static_methods.CallStaticShortMethodTest.nativeExecute(Lorg/apache/harmony/vts/test/vm/jni/static_methods/TestClass;Lorg/apache/harmony/vts/test/vm/jni/static_methods/NativeTestClass;)Z
 */
JNIEXPORT jboolean JNICALL
Java_org_apache_harmony_vts_test_vm_jni_static_1methods_CallStaticShortMethodTest_nativeExecute
    (JNIEnv *env, jobject this_object, jobject tc, jobject ntc)
{
    ...
    result1 = (*env)->CallStaticShortMethod(env, class1, m1, ARG1);
    result2 = (*env)->CallStaticShortMethod(env, class1, m2, ARG1, ARG22);
    result3 = (*env)->CallStaticShortMethod(env, class1, m3, ar3);
    result4 = (*env)->CallStaticShortMethod(env, class1, m4, ar3, ar42);
    result5 = (*env)->CallStaticShortMethod(env, class1, m5, so5);
    result6 = (*env)->CallStaticShortMethod(env, class1, m6, so5, so62);

    nresult1 = (*env)->CallStaticShortMethod(env, class2, nm1, ARG1);
    nresult2 = (*env)->CallStaticShortMethod(env, class2, nm2, ARG1, ARG22);
    nresult3 = (*env)->CallStaticShortMethod(env, class2, nm3, ar3);
    nresult4 = (*env)->CallStaticShortMethod(env, class2, nm4, ar3, ar42);
    nresult5 = (*env)->CallStaticShortMethod(env, class2, nm5, so5);
    nresult6 = (*env)->CallStaticShortMethod(env, class2, nm6, so5, so62);
