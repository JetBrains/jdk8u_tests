...
/*
 * Method: org.apache.harmony.vts.test.vm.jni.object_methods.CallFloatMethodATest.nativeExecute(Lorg/apache/harmony/vts/test/vm/jni/object_methods/TestClass;Lorg/apache/harmony/vts/test/vm/jni/object_methods/NativeTestClass;)Z
 */
JNIEXPORT jboolean JNICALL
Java_org_apache_harmony_vts_test_vm_jni_object_1methods_CallFloatMethodATest_nativeExecute
    (JNIEnv *env, jobject this_object, jobject tc, jobject ntc)
{
    ...
    result1 = (*env)->CallFloatMethodA(env, tc, m1, args1);
    result2 = (*env)->CallFloatMethodA(env, tc, m2, args2);
    result3 = (*env)->CallFloatMethodA(env, tc, m3, args3);
    result4 = (*env)->CallFloatMethodA(env, tc, m4, args4);
    result5 = (*env)->CallFloatMethodA(env, tc, m5, args5);
    result6 = (*env)->CallFloatMethodA(env, tc, m6, args6);

    nresult1 = (*env)->CallFloatMethodA(env, ntc, nm1, args1);
    nresult2 = (*env)->CallFloatMethodA(env, ntc, nm2, args2);
    nresult3 = (*env)->CallFloatMethodA(env, ntc, nm3, args3);
    nresult4 = (*env)->CallFloatMethodA(env, ntc, nm4, args4);
    nresult5 = (*env)->CallFloatMethodA(env, ntc, nm5, args5);
    nresult6 = (*env)->CallFloatMethodA(env, ntc, nm6, args6);
