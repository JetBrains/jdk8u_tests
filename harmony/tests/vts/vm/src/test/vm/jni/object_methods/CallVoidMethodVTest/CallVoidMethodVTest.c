...
static void callNI(JNIEnv *env, jobject obj, jmethodID mid, ...)
{
    va_list args;
...
/*
 * Method: org.apache.harmony.vts.test.vm.jni.object_methods.CallVoidMethodVTest.nativeExecute(Lorg/apache/harmony/vts/test/vm/jni/object_methods/TestClass;Lorg/apache/harmony/vts/test/vm/jni/object_methods/NativeTestClass;)Z
 */
JNIEXPORT jboolean JNICALL
Java_org_apache_harmony_vts_test_vm_jni_object_1methods_CallVoidMethodVTest_nativeExecute
    (JNIEnv *env, jobject this_object, jobject tc, jobject ntc)
{
    ...
    callNI(env, tc, zm, ZARG1, ZARG2, ZARG3, ZARG4);
    callNI(env, tc, bm, BARG1, BARG2, BARG3, BARG4);
    callNI(env, tc, cm, CARG1, CARG2, CARG3, CARG4);
    callNI(env, tc, sm, SARG1, SARG2, SARG3, SARG4);
    callNI(env, tc, im, IARG1, IARG2, IARG3, IARG4);
    callNI(env, tc, jm, JARG1, JARG2, JARG3, JARG4);
    callNI(env, tc, fm, FARG1, FARG2, FARG3, FARG4);
    callNI(env, tc, dm, DARG1, DARG2, DARG3, DARG4);

    callNI(env, ntc, nzm, ZARG1, ZARG2, ZARG3, ZARG4);
    callNI(env, ntc, nbm, BARG1, BARG2, BARG3, BARG4);
    callNI(env, ntc, ncm, CARG1, CARG2, CARG3, CARG4);
    callNI(env, ntc, nsm, SARG1, SARG2, SARG3, SARG4);
    callNI(env, ntc, nim, IARG1, IARG2, IARG3, IARG4);
    callNI(env, ntc, njm, JARG1, JARG2, JARG3, JARG4);
    callNI(env, ntc, nfm, FARG1, FARG2, FARG3, FARG4);
    callNI(env, ntc, ndm, DARG1, DARG2, DARG3, DARG4);
