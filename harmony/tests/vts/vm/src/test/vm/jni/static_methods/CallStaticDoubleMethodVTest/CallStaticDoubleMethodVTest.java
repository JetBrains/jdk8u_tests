 ...
 * @author Petr Ivanov
 *
 * Test for CallStaticDoubleMethodV function.
 */
public class CallStaticDoubleMethodVTest extends JNITest {
    private native boolean nativeExecute(TestClass tc, NativeTestClass ntc);

    /**
     * Test calls various methods that return double of supplied
    ...
    public static void main(String[] args){
        System.exit(new CallStaticDoubleMethodVTest().test());
    }
}