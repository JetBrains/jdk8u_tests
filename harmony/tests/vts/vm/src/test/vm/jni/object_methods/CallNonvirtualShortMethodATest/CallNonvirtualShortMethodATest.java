 ...
 *
 * Test for CallNonvirtualShortMethodA function.
 */
public class CallNonvirtualShortMethodATest extends JNITest {
    ...
    public static void main(String[] args){
        System.exit(new CallNonvirtualShortMethodATest().test());
    }
}