...
/*
 * Method: org.apache.harmony.vts.test.vm.jni.object_methods.CallLongMethodTest.nativeExecute(Lorg/apache/harmony/vts/test/vm/jni/object_methods/TestClass;Lorg/apache/harmony/vts/test/vm/jni/object_methods/NativeTestClass;)Z
 */
JNIEXPORT jboolean JNICALL
Java_org_apache_harmony_vts_test_vm_jni_object_1methods_CallLongMethodTest_nativeExecute
    (JNIEnv *env, jobject this_object, jobject tc, jobject ntc)
{
    ...
    result1 = (*env)->CallLongMethod(env, tc, m1, ARG1);
    result2 = (*env)->CallLongMethod(env, tc, m2, ARG1, ARG22);
    result3 = (*env)->CallLongMethod(env, tc, m3, ar3);
    result4 = (*env)->CallLongMethod(env, tc, m4, ar3, ar42);
    result5 = (*env)->CallLongMethod(env, tc, m5, jo5);
    result6 = (*env)->CallLongMethod(env, tc, m6, jo5, jo62);

    nresult1 = (*env)->CallLongMethod(env, ntc, nm1, ARG1);
    nresult2 = (*env)->CallLongMethod(env, ntc, nm2, ARG1, ARG22);
    nresult3 = (*env)->CallLongMethod(env, ntc, nm3, ar3);
    nresult4 = (*env)->CallLongMethod(env, ntc, nm4, ar3, ar42);
    nresult5 = (*env)->CallLongMethod(env, ntc, nm5, jo5);
    nresult6 = (*env)->CallLongMethod(env, ntc, nm6, jo5, jo62);
