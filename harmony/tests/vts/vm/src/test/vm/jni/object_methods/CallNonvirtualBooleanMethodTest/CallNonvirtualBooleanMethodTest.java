 ...
 *
 * Test for CallNonvirtualBooleanMethod function.
 */
public class CallNonvirtualBooleanMethodTest extends JNITest {
    ...
    public static void main(String[] args){
        System.exit(new CallNonvirtualBooleanMethodTest().test());
    }
}