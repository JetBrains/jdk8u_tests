 ...
 *
 * Test for CallNonvirtualVoidMethodA function.
 */
public class CallNonvirtualVoidMethodATest extends JNITest {
    ...
    public static void main(String[] args){
        System.exit(new CallNonvirtualVoidMethodATest().test());
    }
}