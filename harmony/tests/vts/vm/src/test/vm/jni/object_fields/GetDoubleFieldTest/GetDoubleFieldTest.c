...
/*
 * Method: org.apache.harmony.vts.test.vm.jni.object_fields.GetDoubleFieldTest.nativeExecute(Ljava/lang/Object;Ljava/lang/String;)D
 */
JNIEXPORT jdouble JNICALL
Java_org_apache_harmony_vts_test_vm_jni_object_1fields_GetDoubleFieldTest_nativeExecute
