...
static jobject callNI(JNIEnv *env, jobject obj, jclass parentcl, jmethodID mid, ...)
{
    va_list args;
    jobject result;

    va_start(args, mid);
    result = (*env)->CallNonvirtualObjectMethodV(env, obj, parentcl, mid, args);
    va_end(args);
    return result;
}

/*
 * Method: org.apache.harmony.vts.test.vm.jni.object_methods.CallNonvirtualObjectMethodVTest.nativeExecute(Lorg/apache/harmony/vts/test/vm/jni/object_methods/ChildTestClass;Ljava/lang/Class;Lorg/apache/harmony/vts/test/vm/jni/object_methods/ChildNativeTestClass;Ljava/lang/Class;)Z
 */
JNIEXPORT jboolean JNICALL
Java_org_apache_harmony_vts_test_vm_jni_object_1methods_CallNonvirtualObjectMethodVTest_nativeExecute
    (JNIEnv *env, jobject this_object, jobject tc, jclass parenttc, jobject ntc, jclass parentntc)
{
    ...
    oz = callNI(env, tc, parenttc, zm, ZARG1, ZARG2, ZARG3);
    ob = callNI(env, tc, parenttc, bm, BARG1, BARG2, BARG3);
    oc = callNI(env, tc, parenttc, cm, CARG1, CARG2, CARG3);
    os = callNI(env, tc, parenttc, sm, SARG1, SARG2, SARG3);
    oi = callNI(env, tc, parenttc, im, IARG1, IARG2, IARG3);
    oj = callNI(env, tc, parenttc, jm, JARG1, JARG2, JARG3);
    of = callNI(env, tc, parenttc, fm, FARG1, FARG2, FARG3);
    od = callNI(env, tc, parenttc, dm, DARG1, DARG2, DARG3);

    noz = callNI(env, ntc, parentntc, nzm, ZARG1, ZARG2, ZARG3);
    nob = callNI(env, ntc, parentntc, nbm, BARG1, BARG2, BARG3);
    noc = callNI(env, ntc, parentntc, ncm, CARG1, CARG2, CARG3);
    nos = callNI(env, ntc, parentntc, nsm, SARG1, SARG2, SARG3);
    noi = callNI(env, ntc, parentntc, nim, IARG1, IARG2, IARG3);
    noj = callNI(env, ntc, parentntc, njm, JARG1, JARG2, JARG3);
    nof = callNI(env, ntc, parentntc, nfm, FARG1, FARG2, FARG3);
    nod = callNI(env, ntc, parentntc, ndm, DARG1, DARG2, DARG3);
