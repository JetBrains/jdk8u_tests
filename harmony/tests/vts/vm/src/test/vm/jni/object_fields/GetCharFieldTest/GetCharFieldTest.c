...
/*
 * Method: org.apache.harmony.vts.test.vm.jni.object_fields.GetCharFieldTest.nativeExecute(Ljava/lang/Object;Ljava/lang/String;)C
 */
JNIEXPORT jchar JNICALL
Java_org_apache_harmony_vts_test_vm_jni_object_1fields_GetCharFieldTest_nativeExecute
