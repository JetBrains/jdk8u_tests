 ...
 * @author Petr Ivanov
 *
 * Test for CallStaticVoidMethodA function.
 */
public class CallStaticVoidMethodATest extends JNITest {
    private native boolean nativeExecute(TestClass tc, NativeTestClass ntc);

    /**
     * Test calls various methods that return void of supplied
    ...
    public static void main(String[] args){
        System.exit(new CallStaticVoidMethodATest().test());
    }
}