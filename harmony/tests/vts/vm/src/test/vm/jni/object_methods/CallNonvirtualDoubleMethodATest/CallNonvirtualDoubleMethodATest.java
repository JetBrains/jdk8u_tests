 ...
 *
 * Test for CallNonvirtualDoubleMethod function.
 */
public class CallNonvirtualDoubleMethodATest extends JNITest {
    ...
    public static void main(String[] args){
        System.exit(new CallNonvirtualDoubleMethodATest().test());
    }
}