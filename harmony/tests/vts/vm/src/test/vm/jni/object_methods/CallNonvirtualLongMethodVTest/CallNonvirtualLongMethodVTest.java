 ...
 *
 * Test for CallNonvirtualLongMethodV function.
 */
public class CallNonvirtualLongMethodVTest extends JNITest {
    ...
    public static void main(String[] args){
        System.exit(new CallNonvirtualLongMethodVTest().test());
    }
}