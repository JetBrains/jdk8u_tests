 ...
 * @author Petr Ivanov
 *
 * Test for CallStaticShortMethodA function.
 */
public class CallStaticShortMethodATest extends JNITest {
    private native boolean nativeExecute(TestClass tc, NativeTestClass ntc);

    /**
     * Test calls various methods that return short of supplied
    ...
    public static void main(String[] args){
        System.exit(new CallStaticShortMethodATest().test());
    }
}