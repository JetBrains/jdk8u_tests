...
/*
 * Method: org.apache.harmony.vts.test.vm.jni.object_methods.CallNonvirtualIntMethodTest.nativeExecute(Lorg/apache/harmony/vts/test/vm/jni/object_methods/ChildTestClass;Ljava/lang/Class;Lorg/apache/harmony/vts/test/vm/jni/object_methods/ChildNativeTestClass;Ljava/lang/Class;)Z
 */
JNIEXPORT jboolean JNICALL
Java_org_apache_harmony_vts_test_vm_jni_object_1methods_CallNonvirtualIntMethodTest_nativeExecute
    (JNIEnv *env, jobject this_object, jobject tc, jclass parenttc, jobject ntc, jclass parentntc)
{
    ...
    result1 = (*env)->CallNonvirtualIntMethod(env, tc, parenttc, m1, ARG1);
    result2 = (*env)->CallNonvirtualIntMethod(env, tc, parenttc, m2, ARG1, ARG22);
    result3 = (*env)->CallNonvirtualIntMethod(env, tc, parenttc, m3, ar3);
    result4 = (*env)->CallNonvirtualIntMethod(env, tc, parenttc, m4, ar3, ar42);
    result5 = (*env)->CallNonvirtualIntMethod(env, tc, parenttc, m5, io5);
    result6 = (*env)->CallNonvirtualIntMethod(env, tc, parenttc, m6, io5, io62);

    nresult1 = (*env)->CallNonvirtualIntMethod(env, ntc, parentntc, nm1, ARG1);
    nresult2 = (*env)->CallNonvirtualIntMethod(env, ntc, parentntc, nm2, ARG1, ARG22);
    nresult3 = (*env)->CallNonvirtualIntMethod(env, ntc, parentntc, nm3, ar3);
    nresult4 = (*env)->CallNonvirtualIntMethod(env, ntc, parentntc, nm4, ar3, ar42);
    nresult5 = (*env)->CallNonvirtualIntMethod(env, ntc, parentntc, nm5, io5);
    nresult6 = (*env)->CallNonvirtualIntMethod(env, ntc, parentntc, nm6, io5, io62);
