 ...
 *
 * Test for CallNonvirtualDoubleMethodV function.
 */
public class CallNonvirtualDoubleMethodVTest extends JNITest {
    ...
    public static void main(String[] args){
        System.exit(new CallNonvirtualDoubleMethodVTest().test());
    }
}