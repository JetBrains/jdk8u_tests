...
static jbyte callNI(JNIEnv *env, jclass par_cl, jmethodID mid, ...)
{
    va_list args;
        jbyte result;
...
/*
 * Method: org.apache.harmony.vts.test.vm.jni.static_methods.CallStaticByteMethodVTest.nativeExecute(Lorg/apache/harmony/vts/test/vm/jni/static_methods/TestClass;Lorg/apache/harmony/vts/test/vm/jni/static_methods/NativeTestClass;)Z
 */
