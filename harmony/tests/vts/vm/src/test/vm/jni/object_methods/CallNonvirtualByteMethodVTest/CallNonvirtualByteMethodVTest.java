 ...
 *
 * Test for CallNonvirtualByteMethodV function.
 */
public class CallNonvirtualByteMethodVTest extends JNITest {
    ...
    public static void main(String[] args){
        System.exit(new CallNonvirtualByteMethodVTest().test());
    }
}