 ...
 * @author Petr Ivanov
 *
 * Test for CallStaticCharMethodV function.
 */
public class CallStaticCharMethodVTest extends JNITest {
    private native boolean nativeExecute(TestClass tc, NativeTestClass ntc);

    /**
     * Test calls various methods that return char of supplied
    ...
    public static void main(String[] args){
        System.exit(new CallStaticCharMethodVTest().test());
    }
}