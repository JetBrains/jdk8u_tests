 ...
 *
 * Test for SetByteField function.
 */
public class SetByteFieldTest extends JNITest {
    private native boolean nativeExecute(Object obj, String field, byte val); 
    ...
    public boolean execute() throws Exception {
        ...
        res1 = nativeExecute(tc, "bpub", arg1);
        res2 = nativeExecute(tc, "bprot", arg2);
        res3 = nativeExecute(tc, "bpriv", arg3);
        f1 = tc.getBpub();
        f2 = tc.getBprot();
        f3 = tc.getBpriv();
    ...
    public static void main(String[] args){
        System.exit(new SetByteFieldTest().test());
    }
}