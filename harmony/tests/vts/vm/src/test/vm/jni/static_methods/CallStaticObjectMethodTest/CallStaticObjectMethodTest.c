...
/*
 * Method: org.apache.harmony.vts.test.vm.jni.static_methods.CallStaticObjectMethodTest.nativeExecute(Lorg/apache/harmony/vts/test/vm/jni/static_methods/TestClass;Lorg/apache/harmony/vts/test/vm/jni/static_methods/NativeTestClass;)Z
 */
JNIEXPORT jboolean JNICALL
Java_org_apache_harmony_vts_test_vm_jni_static_1methods_CallStaticObjectMethodTest_nativeExecute
    (JNIEnv *env, jobject this_object, jobject tc, jobject ntc)
{
    ...
    oz = (*env)->CallStaticObjectMethod(env, class1, zm, ZARG1, ZARG2, ZARG3);
    ob = (*env)->CallStaticObjectMethod(env, class1, bm, BARG1, BARG2, BARG3);
    oc = (*env)->CallStaticObjectMethod(env, class1, cm, CARG1, CARG2, CARG3);
    os = (*env)->CallStaticObjectMethod(env, class1, sm, SARG1, SARG2, SARG3);
    oi = (*env)->CallStaticObjectMethod(env, class1, im, IARG1, IARG2, IARG3);
    oj = (*env)->CallStaticObjectMethod(env, class1, jm, JARG1, JARG2, JARG3);
    of = (*env)->CallStaticObjectMethod(env, class1, fm, FARG1, FARG2, FARG3);
    od = (*env)->CallStaticObjectMethod(env, class1, dm, DARG1, DARG2, DARG3);

    noz = (*env)->CallStaticObjectMethod(env, class2, nzm, ZARG1, ZARG2, ZARG3);
    nob = (*env)->CallStaticObjectMethod(env, class2, nbm, BARG1, BARG2, BARG3);
    noc = (*env)->CallStaticObjectMethod(env, class2, ncm, CARG1, CARG2, CARG3);
    nos = (*env)->CallStaticObjectMethod(env, class2, nsm, SARG1, SARG2, SARG3);
    noi = (*env)->CallStaticObjectMethod(env, class2, nim, IARG1, IARG2, IARG3);
    noj = (*env)->CallStaticObjectMethod(env, class2, njm, JARG1, JARG2, JARG3);
    nof = (*env)->CallStaticObjectMethod(env, class2, nfm, FARG1, FARG2, FARG3);
    nod = (*env)->CallStaticObjectMethod(env, class2, ndm, DARG1, DARG2, DARG3);
