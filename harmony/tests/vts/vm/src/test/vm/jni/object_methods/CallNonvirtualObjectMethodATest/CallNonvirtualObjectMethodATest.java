 ...
 *
 * Test for CallNonvirtualObjectMethodA function.
 */
public class CallNonvirtualObjectMethodATest extends JNITest {
    ...
    public static void main(String[] args){
        System.exit(new CallNonvirtualObjectMethodATest().test());
    }
}