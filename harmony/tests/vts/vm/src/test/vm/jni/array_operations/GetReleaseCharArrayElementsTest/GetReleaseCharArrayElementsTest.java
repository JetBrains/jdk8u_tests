...
/**
 * Test for Get/ReleaseCharArrayElements function.
 */
public class GetReleaseCharArrayElementsTest extends JNITest {
    private native void nativeExecute(char [] array, int length);
    ...
    public boolean execute() throws Exception {
        ...
        for (int i = 0; i < length; i++){ mass[i] = (char)i; }
    ...
    public static void main(String[] args){
        System.exit(new GetReleaseCharArrayElementsTest().test());
    }
}