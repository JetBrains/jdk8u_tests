...
/*
 * Method: org.apache.harmony.vts.test.vm.jni.object_methods.CallLongMethodVTest.nativeExecute(Lorg/apache/harmony/vts/test/vm/jni/object_methods/TestClass;Lorg/apache/harmony/vts/test/vm/jni/object_methods/NativeTestClass;)Z
 */
JNIEXPORT jboolean JNICALL
Java_org_apache_harmony_vts_test_vm_jni_object_1methods_CallLongMethodVTest_nativeExecute
    (JNIEnv *env, jobject this_object, jobject tc, jobject ntc)
{
    ...
    result5 = callNI(env, tc, m5, jo5);
    result6 = callNI(env, tc, m6, jo5, jo62);
    ...
    nresult5 = callNI(env, ntc, nm5, jo5);
    nresult6 = callNI(env, ntc, nm6, jo5, jo62);
