 ...
 *
 * Test for GetLongField function.
 */
public class GetLongFieldTest extends JNITest {
    private native long nativeExecute(Object obj, String field);
    ...
    public boolean execute() throws Exception {
        ...
        tc.setJprot(arg2);
        tc.setJpriv(arg3);
        res1 = nativeExecute(tc, "jpub");
        res2 = nativeExecute(tc, "jprot");
        res3 = nativeExecute(tc, "jpriv");

        return res1 == arg1 && res2 == arg2 && res3 == arg3;
    }
    public static void main(String[] args){
        System.exit(new GetLongFieldTest().test());
    }
}
