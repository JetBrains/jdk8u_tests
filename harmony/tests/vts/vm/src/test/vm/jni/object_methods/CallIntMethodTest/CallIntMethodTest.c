...
/*
 * Method: org.apache.harmony.vts.test.vm.jni.object_methods.CallIntMethodTest.nativeExecute(Lorg/apache/harmony/vts/test/vm/jni/object_methods/TestClass;Lorg/apache/harmony/vts/test/vm/jni/object_methods/NativeTestClass;)Z
 */
JNIEXPORT jboolean JNICALL
Java_org_apache_harmony_vts_test_vm_jni_object_1methods_CallIntMethodTest_nativeExecute
    (JNIEnv *env, jobject this_object, jobject tc, jobject ntc)
{
    ...
    result1 = (*env)->CallIntMethod(env, tc, m1, ARG1);
    result2 = (*env)->CallIntMethod(env, tc, m2, ARG1, ARG22);
    result3 = (*env)->CallIntMethod(env, tc, m3, ar3);
    result4 = (*env)->CallIntMethod(env, tc, m4, ar3, ar42);
    result5 = (*env)->CallIntMethod(env, tc, m5, io5);
    result6 = (*env)->CallIntMethod(env, tc, m6, io5, io62);

    nresult1 = (*env)->CallIntMethod(env, ntc, nm1, ARG1);
    nresult2 = (*env)->CallIntMethod(env, ntc, nm2, ARG1, ARG22);
    nresult3 = (*env)->CallIntMethod(env, ntc, nm3, ar3);
    nresult4 = (*env)->CallIntMethod(env, ntc, nm4, ar3, ar42);
    nresult5 = (*env)->CallIntMethod(env, ntc, nm5, io5);
    nresult6 = (*env)->CallIntMethod(env, ntc, nm6, io5, io62);
