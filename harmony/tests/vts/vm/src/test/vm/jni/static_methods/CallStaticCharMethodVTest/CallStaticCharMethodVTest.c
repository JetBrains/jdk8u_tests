...
/*
 * Method: org.apache.harmony.vts.test.vm.jni.static_methods.CallStaticCharMethodVTest.nativeExecute(Lorg/apache/harmony/vts/test/vm/jni/static_methods/TestClass;Lorg/apache/harmony/vts/test/vm/jni/static_methods/NativeTestClass;)Z
 */
JNIEXPORT jboolean JNICALL
Java_org_apache_harmony_vts_test_vm_jni_static_1methods_CallStaticCharMethodVTest_nativeExecute
    (JNIEnv *env, jobject this_object, jobject tc, jobject ntc)
{
    ...
    result5 = callNI(env, class1, m5, co5);
    result6 = callNI(env, class1, m6, co5, co62);
    ...
    nresult5 = callNI(env, class2, nm5, co5);
    nresult6 = callNI(env, class2, nm6, co5, co62);
