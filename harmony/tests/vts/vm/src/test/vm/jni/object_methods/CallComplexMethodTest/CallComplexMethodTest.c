...
/*
 * Method: org.apache.harmony.vts.test.vm.jni.object_methods.CallComplexMethodTest.nativeExecute(Lorg/apache/harmony/vts/test/vm/jni/object_methods/TestClass;Lorg/apache/harmony/vts/test/vm/jni/object_methods/NativeTestClass;)Z
 */
JNIEXPORT jboolean JNICALL
Java_org_apache_harmony_vts_test_vm_jni_object_1methods_CallComplexMethodTest_nativeExecute
    (JNIEnv *env, jobject this_object, jobject tc, jobject ntc)
{
    ...
    mid = (*env)->GetMethodID(env, cl, "method", sig);
    nmid = (*env)->GetMethodID(env, ncl, "method", sig);
