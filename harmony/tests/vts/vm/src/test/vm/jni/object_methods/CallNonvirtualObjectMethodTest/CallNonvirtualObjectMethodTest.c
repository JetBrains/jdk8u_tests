...
/*
 * Method: org.apache.harmony.vts.test.vm.jni.object_methods.CallNonvirtualObjectMethodTest.nativeExecute(Lorg/apache/harmony/vts/test/vm/jni/object_methods/ChildTestClass;Ljava/lang/Class;Lorg/apache/harmony/vts/test/vm/jni/object_methods/ChildNativeTestClass;Ljava/lang/Class;)Z
 */
JNIEXPORT jboolean JNICALL
Java_org_apache_harmony_vts_test_vm_jni_object_1methods_CallNonvirtualObjectMethodTest_nativeExecute
    (JNIEnv *env, jobject this_object, jobject tc, jclass parenttc, jobject ntc, jclass parentntc)
{
    ...
    oz = (*env)->CallNonvirtualObjectMethod(env, tc, parenttc, zm, ZARG1, ZARG2, ZARG3);
    ob = (*env)->CallNonvirtualObjectMethod(env, tc, parenttc, bm, BARG1, BARG2, BARG3);
    oc = (*env)->CallNonvirtualObjectMethod(env, tc, parenttc, cm, CARG1, CARG2, CARG3);
    os = (*env)->CallNonvirtualObjectMethod(env, tc, parenttc, sm, SARG1, SARG2, SARG3);
    oi = (*env)->CallNonvirtualObjectMethod(env, tc, parenttc, im, IARG1, IARG2, IARG3);
    oj = (*env)->CallNonvirtualObjectMethod(env, tc, parenttc, jm, JARG1, JARG2, JARG3);
    of = (*env)->CallNonvirtualObjectMethod(env, tc, parenttc, fm, FARG1, FARG2, FARG3);
    od = (*env)->CallNonvirtualObjectMethod(env, tc, parenttc, dm, DARG1, DARG2, DARG3);

    noz = (*env)->CallNonvirtualObjectMethod(env, ntc, parentntc, nzm, ZARG1, ZARG2, ZARG3);
    nob = (*env)->CallNonvirtualObjectMethod(env, ntc, parentntc, nbm, BARG1, BARG2, BARG3);
    noc = (*env)->CallNonvirtualObjectMethod(env, ntc, parentntc, ncm, CARG1, CARG2, CARG3);
    nos = (*env)->CallNonvirtualObjectMethod(env, ntc, parentntc, nsm, SARG1, SARG2, SARG3);
    noi = (*env)->CallNonvirtualObjectMethod(env, ntc, parentntc, nim, IARG1, IARG2, IARG3);
    noj = (*env)->CallNonvirtualObjectMethod(env, ntc, parentntc, njm, JARG1, JARG2, JARG3);
    nof = (*env)->CallNonvirtualObjectMethod(env, ntc, parentntc, nfm, FARG1, FARG2, FARG3);
    nod = (*env)->CallNonvirtualObjectMethod(env, ntc, parentntc, ndm, DARG1, DARG2, DARG3);
