 ...
 */
public class GetMethodIDTest03 extends JNITest {
    ...
    public boolean execute() throws Exception {
        boolean test10 = nativeExecute(ChildNativeTestClass.class, "method", "(Z)Z"); 
        boolean test11 = nativeExecute(ChildNativeTestClass.class, "method", "([Z[Z)Z"); 
        boolean test12 = nativeExecute(ChildNativeTestClass.class, "method",
                "(Ljava/lang/Boolean;Ljava/lang/Boolean;)Z");

        return test10 && test11 && test12;
    }
    public static void main(String[] args){
        System.exit(new GetMethodIDTest03().test());
    }
}
