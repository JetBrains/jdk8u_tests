 ...
 * @author Petr Ivanov
 *
 * Test for NewWeakGlobalRef function.
 */
public class NewWeakGlobalRefTest extends JNITest {
     ...
     * this reference; Testing of weakness of this ref
    ...
    public static void main(String[] args){
        System.exit(new NewWeakGlobalRefTest().test());
    }
}
