...
/*
 * Method: org.apache.harmony.vts.test.vm.jni.references.NewWeakGlobalRefTest.nativeExecute(Lorg/apache/harmony/vts/test/vm/jni/references/RefTestsClass;)Z
 */
JNIEXPORT jboolean JNICALL
Java_org_apache_harmony_vts_test_vm_jni_references_NewWeakGlobalRefTest_nativeExecute
