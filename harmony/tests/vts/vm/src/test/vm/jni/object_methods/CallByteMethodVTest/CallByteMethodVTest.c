...
static jbyte callNI(JNIEnv *env, jobject obj, jmethodID mid, ...)
{
    va_list args;
        jbyte result;

        va_start(args, mid);
        result = (*env)->CallByteMethodV(env, obj, mid, args);
        va_end(args);
        return result;
}

/*
 * Method: org.apache.harmony.vts.test.vm.jni.object_methods.CallByteMethodVTest.nativeExecute(Lorg/apache/harmony/vts/test/vm/jni/object_methods/TestClass;Lorg/apache/harmony/vts/test/vm/jni/object_methods/NativeTestClass;)Z
 */
JNIEXPORT jboolean JNICALL
Java_org_apache_harmony_vts_test_vm_jni_object_1methods_CallByteMethodVTest_nativeExecute
    (JNIEnv *env, jobject this_object, jobject tc, jobject ntc)
{
    ...
    result5 = callNI(env, tc, m5, bo5);
    result6 = callNI(env, tc, m6, bo5, bo62);
    ...
    nresult5 = callNI(env, ntc, nm5, bo5);
    nresult6 = callNI(env, ntc, nm6, bo5, bo62);
