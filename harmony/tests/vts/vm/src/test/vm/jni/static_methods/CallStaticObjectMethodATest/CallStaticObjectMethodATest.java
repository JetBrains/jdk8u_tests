 ...
 * @author Petr Ivanov
 *
 * Test for CallStaticObjectMethodA function.
 */
public class CallStaticObjectMethodATest extends JNITest {
    private native boolean nativeExecute(TestClass tc, NativeTestClass ntc);

    /**
     * Test calls various methods that return object of supplied
    ...
    public static void main(String[] args){
        System.exit(new CallStaticObjectMethodATest().test());
    }
}