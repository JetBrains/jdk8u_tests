 ...
 *
 * Test for CallNonvirtualLongMethodA function.
 */
public class CallNonvirtualLongMethodATest extends JNITest {
    ...
    public static void main(String[] args){
        System.exit(new CallNonvirtualLongMethodATest().test());
    }
}