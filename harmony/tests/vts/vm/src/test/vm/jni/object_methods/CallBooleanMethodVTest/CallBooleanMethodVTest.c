...
static jboolean callNI(JNIEnv *env, jobject obj, jmethodID mid, ...)
{
    va_list args;
    jboolean result;
...
/*
 * Method: org.apache.harmony.vts.test.vm.jni.object_methods.CallBooleanMethodVTest.nativeExecute(Lorg/apache/harmony/vts/test/vm/jni/object_methods/TestClass;Lorg/apache/harmony/vts/test/vm/jni/object_methods/NativeTestClass;)Z
 */
JNIEXPORT jboolean JNICALL
Java_org_apache_harmony_vts_test_vm_jni_object_1methods_CallBooleanMethodVTest_nativeExecute
