...
/**
 * Test for Get/ReleaseFloatArrayElements function.
 */
public class GetReleaseFloatArrayElementsTest extends JNITest {
    private native void nativeExecute(float [] array, int length);
    ...
    public boolean execute() throws Exception {
        ...
        for (int i = 0; i < length; i++){ mass[i] = (float)i + 0.01f; }
    ...
    public static void main(String[] args){
        System.exit(new GetReleaseFloatArrayElementsTest().test());
    }
}