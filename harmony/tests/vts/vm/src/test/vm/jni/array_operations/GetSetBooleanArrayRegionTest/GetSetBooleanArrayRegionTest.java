 ...
 * @author Petr Ivanov
 *
 * Test for Get/SetBooleanArrayRegion function.
 */
public class GetSetBooleanArrayRegionTest extends JNITest {
    ...
    public boolean execute() throws Exception {
        ...
        for (int i = 0; i < length; i++){ mass[i] = i<8 ? true : false ; }
    ...
    public static void main(String[] args){
        System.exit(new GetSetBooleanArrayRegionTest().test());
    }
}