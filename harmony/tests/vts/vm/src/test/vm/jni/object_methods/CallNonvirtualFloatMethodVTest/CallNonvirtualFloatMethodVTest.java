 ...
 *
 * Test for CallNonvirtualFloatMethod function.
 */
public class CallNonvirtualFloatMethodVTest extends JNITest {
    ...
    public static void main(String[] args){
        System.exit(new CallNonvirtualFloatMethodVTest().test());
    }
}