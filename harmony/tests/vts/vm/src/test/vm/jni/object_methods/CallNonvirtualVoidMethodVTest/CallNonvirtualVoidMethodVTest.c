...
static void callNI(JNIEnv *env, jobject obj, jclass parentcl, jmethodID mid, ...)
{
    va_list args;

    va_start(args, mid);
    (*env)->CallNonvirtualVoidMethodV(env, obj, parentcl, mid, args);
    va_end(args);
}

/*
 * Method: org.apache.harmony.vts.test.vm.jni.object_methods.CallNonvirtualVoidMethodVTest.nativeExecute(Lorg/apache/harmony/vts/test/vm/jni/object_methods/ChildTestClass;Ljava/lang/Class;Lorg/apache/harmony/vts/test/vm/jni/object_methods/ChildNativeTestClass;Ljava/lang/Class;)Z
 */
JNIEXPORT jboolean JNICALL
Java_org_apache_harmony_vts_test_vm_jni_object_1methods_CallNonvirtualVoidMethodVTest_nativeExecute
    (JNIEnv *env, jobject this_object, jobject tc, jclass parenttc, jobject ntc, jclass parentntc)
{
    ...
    callNI(env, tc, parenttc, zm, ZARG1, ZARG2, ZARG3, ZARG4);
    callNI(env, tc, parenttc, bm, BARG1, BARG2, BARG3, BARG4);
    callNI(env, tc, parenttc, cm, CARG1, CARG2, CARG3, CARG4);
    callNI(env, tc, parenttc, sm, SARG1, SARG2, SARG3, SARG4);
    callNI(env, tc, parenttc, im, IARG1, IARG2, IARG3, IARG4);
    callNI(env, tc, parenttc, jm, JARG1, JARG2, JARG3, JARG4);
    callNI(env, tc, parenttc, fm, FARG1, FARG2, FARG3, FARG4);
    callNI(env, tc, parenttc, dm, DARG1, DARG2, DARG3, DARG4);

    callNI(env, ntc, parentntc, nzm, ZARG1, ZARG2, ZARG3, ZARG4);
    callNI(env, ntc, parentntc, nbm, BARG1, BARG2, BARG3, BARG4);
    callNI(env, ntc, parentntc, ncm, CARG1, CARG2, CARG3, CARG4);
    callNI(env, ntc, parentntc, nsm, SARG1, SARG2, SARG3, SARG4);
    callNI(env, ntc, parentntc, nim, IARG1, IARG2, IARG3, IARG4);
    callNI(env, ntc, parentntc, njm, JARG1, JARG2, JARG3, JARG4);
    callNI(env, ntc, parentntc, nfm, FARG1, FARG2, FARG3, FARG4);
    callNI(env, ntc, parentntc, ndm, DARG1, DARG2, DARG3, DARG4);
