...
static void callNI(JNIEnv *env, jclass par_cl, jmethodID mid, ...)
{
    va_list args;

        va_start(args, mid);
        (*env)->CallStaticVoidMethodV(env, par_cl, mid, args);
        va_end(args);
}

/*
 * Method: org.apache.harmony.vts.test.vm.jni.static_methods.CallStaticVoidMethodVTest.nativeExecute(Lorg/apache/harmony/vts/test/vm/jni/static_methods/TestClass;Lorg/apache/harmony/vts/test/vm/jni/static_methods/NativeTestClass;)Z
 */
JNIEXPORT jboolean JNICALL
Java_org_apache_harmony_vts_test_vm_jni_static_1methods_CallStaticVoidMethodVTest_nativeExecute
    (JNIEnv *env, jobject this_object, jobject tc, jobject ntc)
{
    ...
    callNI(env, class1, zm, ZARG1, ZARG2, ZARG3, ZARG4);
    callNI(env, class1, bm, BARG1, BARG2, BARG3, BARG4);
    callNI(env, class1, cm, CARG1, CARG2, CARG3, CARG4);
    callNI(env, class1, sm, SARG1, SARG2, SARG3, SARG4);
    callNI(env, class1, im, IARG1, IARG2, IARG3, IARG4);
    callNI(env, class1, jm, JARG1, JARG2, JARG3, JARG4);
    callNI(env, class1, fm, FARG1, FARG2, FARG3, FARG4);
    callNI(env, class1, dm, DARG1, DARG2, DARG3, DARG4);

    callNI(env, class2, nzm, ZARG1, ZARG2, ZARG3, ZARG4);
    callNI(env, class2, nbm, BARG1, BARG2, BARG3, BARG4);
    callNI(env, class2, ncm, CARG1, CARG2, CARG3, CARG4);
    callNI(env, class2, nsm, SARG1, SARG2, SARG3, SARG4);
    callNI(env, class2, nim, IARG1, IARG2, IARG3, IARG4);
    callNI(env, class2, njm, JARG1, JARG2, JARG3, JARG4);
    callNI(env, class2, nfm, FARG1, FARG2, FARG3, FARG4);
    callNI(env, class2, ndm, DARG1, DARG2, DARG3, DARG4);
