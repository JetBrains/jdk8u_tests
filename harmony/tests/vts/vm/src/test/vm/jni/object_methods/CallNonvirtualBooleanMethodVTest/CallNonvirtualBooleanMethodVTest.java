 ...
 *
 * Test for CallNonvirtualBooleanMethodV function.
 */
public class CallNonvirtualBooleanMethodVTest extends JNITest {
    ...
    public static void main(String[] args){
        System.exit(new CallNonvirtualBooleanMethodVTest().test());
    }
}