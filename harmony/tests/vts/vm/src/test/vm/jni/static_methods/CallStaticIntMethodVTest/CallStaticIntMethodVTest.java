 ...
 * @author Petr Ivanov
 *
 * Test for CallStaticIntMethodV function.
 */
public class CallStaticIntMethodVTest extends JNITest {
    private native boolean nativeExecute(TestClass tc, NativeTestClass ntc);

    /**
     * Test calls various methods that return int of supplied
    ...
    public static void main(String[] args){
        System.exit(new CallStaticIntMethodVTest().test());
    }
}