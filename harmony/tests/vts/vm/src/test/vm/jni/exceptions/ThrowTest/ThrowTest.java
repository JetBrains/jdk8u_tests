 ...
 * 
 * Test for Throw function.
 */
public class ThrowTest extends JNITest {
    private native void nativeExecute(int value) throws ExceptionClass;
    ...
    public boolean execute() throws Exception {
        try {
            ...
            return e.getField() == 10;
        }
        return false;
    }
    public static void main(String[] args){
        System.exit(new ThrowTest().test());
    }
}