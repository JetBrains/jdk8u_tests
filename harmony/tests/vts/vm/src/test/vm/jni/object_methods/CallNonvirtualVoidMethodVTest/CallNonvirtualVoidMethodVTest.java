 ...
 *
 * Test for CallNonvirtualVoidMethodV function.
 */
public class CallNonvirtualVoidMethodVTest extends JNITest {
    ...
    public static void main(String[] args){
        System.exit(new CallNonvirtualVoidMethodVTest().test());
    }
}