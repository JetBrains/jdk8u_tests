 ...
 */
public class GetMethodIDTest02 extends JNITest {
    ...
    public boolean execute() throws Exception {
        boolean test7 = nativeExecute(ChildTestClass.class, "method", "(Z)Z"); 
        boolean test8 = nativeExecute(ChildTestClass.class, "method", "([Z[Z)Z"); 
        boolean test9 = nativeExecute(ChildTestClass.class, "method",
                "(Ljava/lang/Boolean;Ljava/lang/Boolean;)Z");

        return test7 && test8 && test9;
    }
    public static void main(String[] args){
        System.exit(new GetMethodIDTest02().test());
    }
}
