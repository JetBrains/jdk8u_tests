...
static jdouble callNI(JNIEnv *env, jobject obj, jclass parentcl, jmethodID mid, ...)
{
    va_list args;
    jdouble result;

    va_start(args, mid);
    result = (*env)->CallNonvirtualDoubleMethodV(env, obj, parentcl, mid, args);
    va_end(args);
    return result;
}

/*
 * Method: org.apache.harmony.vts.test.vm.jni.object_methods.CallNonvirtualDoubleMethodVTest.nativeExecute(Lorg/apache/harmony/vts/test/vm/jni/object_methods/ChildTestClass;Ljava/lang/Class;Lorg/apache/harmony/vts/test/vm/jni/object_methods/ChildNativeTestClass;Ljava/lang/Class;)Z
 */
JNIEXPORT jboolean JNICALL
Java_org_apache_harmony_vts_test_vm_jni_object_1methods_CallNonvirtualDoubleMethodVTest_nativeExecute
    (JNIEnv *env, jobject this_object, jobject tc, jclass parenttc, jobject ntc, jclass parentntc)
{
    ...
    result5 = callNI(env, tc, parenttc, m5, do5);
    result6 = callNI(env, tc, parenttc, m6, do5, do62);
    ...
    nresult5 = callNI(env, ntc, parentntc, nm5, do5);
    nresult6 = callNI(env, ntc, parentntc, nm6, do5, do62);
