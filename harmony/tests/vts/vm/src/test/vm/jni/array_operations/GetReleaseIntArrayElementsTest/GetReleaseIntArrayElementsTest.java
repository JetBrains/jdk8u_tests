...
/**
 * Test for Get/ReleaseIntArrayElements function.
 */
public class GetReleaseIntArrayElementsTest extends JNITest {
    private native void nativeExecute(int [] array, int length);
    ...
    public boolean execute() throws Exception {
        ...
        for (int i = 0; i < length; i++){ mass[i] = i; }
    ...
    public static void main(String[] args){
        System.exit(new GetReleaseIntArrayElementsTest().test());
    }
}