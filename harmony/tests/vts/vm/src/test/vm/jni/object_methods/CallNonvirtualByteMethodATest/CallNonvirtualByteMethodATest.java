 ...
 *
 * Test for CallNonvirtualByteMethodA function.
 */
public class CallNonvirtualByteMethodATest extends JNITest {
    ...
    public static void main(String[] args){
        System.exit(new CallNonvirtualByteMethodATest().test());
    }
}