...
/*
 * Method: org.apache.harmony.vts.test.vm.jvms.instructions.invokeReturn.invokevirtual.invokevirtual21.invokevirtual2107.invokevirtual2107p.nativeMethod(FFFFFF)I
 */
JNIEXPORT int JNICALL
Java_org_apache_harmony_vts_test_vm_jvms_instructions_invokeReturn_invokevirtual_invokevirtual21_invokevirtual2107_invokevirtual2107p_nativeMethod
