...
.source threads11004p.j
.class public org/apache/harmony/vts/test/vm/jvms/threads/threads110/threads11004/threads11004p
...
.method public testTimed(I)I
    ...
    iconst_1
    istore_2
    ;        threads11004p t = this;
    aload_0
    astore_3
    ;        Thread t1 = new threads11004p$1();
    new org/apache/harmony/vts/test/vm/jvms/threads/threads110/threads11004/threads11004p$1
    dup
    aload_0
    invokespecial org/apache/harmony/vts/test/vm/jvms/threads/threads110/threads11004/threads11004p$1/<init>(Lorg/apache/harmony/vts/test/vm/jvms/threads/threads110/threads11004/threads11004p;)V
    astore 4
...
LoopStart:
    ...
    aload_0
    invokevirtual org/apache/harmony/vts/test/vm/jvms/threads/threads110/threads11004/threads11004p/interrupted()Z
    ifne Cleanup
    aload 4
...
.method public static main([Ljava/lang/String;)V
    ...
    new org/apache/harmony/vts/test/vm/jvms/threads/threads110/threads11004/threads11004p
    dup
    invokespecial org/apache/harmony/vts/test/vm/jvms/threads/threads110/threads11004/threads11004p/<init>()V
    aload_0
    invokevirtual org/apache/harmony/vts/test/vm/jvms/threads/threads110/threads11004/threads11004p/test([Ljava/lang/String;)I
