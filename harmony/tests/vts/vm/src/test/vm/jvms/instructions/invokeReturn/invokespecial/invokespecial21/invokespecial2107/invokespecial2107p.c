...
/*
 * Method: org.apache.harmony.vts.test.vm.jvms.instructions.invokeReturn.invokespecial.invokespecial21.invokespecial2107.invokespecial2107p.nativeMethod(FFFFFF)I
 */
JNIEXPORT int JNICALL
Java_org_apache_harmony_vts_test_vm_jvms_instructions_invokeReturn_invokespecial_invokespecial21_invokespecial2107_invokespecial2107p_nativeMethod(JNIEnv *, jobject, jfloat, jfloat, jfloat, jfloat, jfloat, jfloat);

JNIEXPORT int JNICALL
Java_org_apache_harmony_vts_test_vm_jvms_instructions_invokeReturn_invokespecial_invokespecial21_invokespecial2107_invokespecial2107p_nativeMethod
