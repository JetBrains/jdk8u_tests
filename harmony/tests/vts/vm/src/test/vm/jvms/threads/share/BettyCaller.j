...
; 
; public class BettyCaller extends Caller {
;     AnnyBetty t;
;     
;     public BettyCaller(AnnyBetty t) {
;         this.t = t;
;     }
; 
;     public void run() {
...
.source BettyCaller.j
.class public org/apache/harmony/vts/test/vm/jvms/threads/share/BettyCaller
...
;         this.t = t;
    aload_0
    aload_1
    putfield org/apache/harmony/vts/test/vm/jvms/threads/share/BettyCaller/t Lorg/apache/harmony/vts/test/vm/jvms/threads/share/AnnyBetty;
    return
.end method
...
LoopStart:
    ;         while (!isInterrupted()) {
    aload_0
    invokevirtual org/apache/harmony/vts/test/vm/jvms/threads/share/BettyCaller/isInterrupted()Z
    ifne End

    ;             t.betty();
    aload_0
    getfield org/apache/harmony/vts/test/vm/jvms/threads/share/BettyCaller/t Lorg/apache/harmony/vts/test/vm/jvms/threads/share/AnnyBetty;
    invokeinterface org/apache/harmony/vts/test/vm/jvms/threads/share/AnnyBetty/betty()V 1
