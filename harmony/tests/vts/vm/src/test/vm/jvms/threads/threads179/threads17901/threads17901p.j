...
.source threads17901p.j
.class public org/apache/harmony/vts/test/vm/jvms/threads/threads179/threads17901/threads17901p
...
.method public <init>()V
    ...
    aload_0
    iconst_1
    putfield org/apache/harmony/vts/test/vm/jvms/threads/threads179/threads17901/threads17901p/a I
    ; b = 2;
    aload_0
    iconst_2
    putfield org/apache/harmony/vts/test/vm/jvms/threads/threads179/threads17901/threads17901p/b I
    return
.end method
...
.method public synchronized anny()V
    ...
    aload_0
    aload_0
    getfield org/apache/harmony/vts/test/vm/jvms/threads/threads179/threads17901/threads17901p/b I
    putfield org/apache/harmony/vts/test/vm/jvms/threads/threads179/threads17901/threads17901p/a I
    return
.end method
...
.method public synchronized betty()V
    ...
    aload_0
    aload_0
    getfield org/apache/harmony/vts/test/vm/jvms/threads/threads179/threads17901/threads17901p/a I
    putfield org/apache/harmony/vts/test/vm/jvms/threads/threads179/threads17901/threads17901p/b I
    return
.end method
...
LoopStart:
    ; while (!interrupted()) {
    aload_0
    invokevirtual org/apache/harmony/vts/test/vm/jvms/threads/threads179/threads17901/threads17901p/interrupted()Z
    ifne Cleanup
...
Continue:
    ;         reset();
    aload_0
    invokevirtual org/apache/harmony/vts/test/vm/jvms/threads/threads179/threads17901/threads17901p/reset()V
...
.method public static main([Ljava/lang/String;)V
    ...
    new org/apache/harmony/vts/test/vm/jvms/threads/threads179/threads17901/threads17901p
    dup
    invokespecial org/apache/harmony/vts/test/vm/jvms/threads/threads179/threads17901/threads17901p/<init>()V
    aload_0
    invokevirtual org/apache/harmony/vts/test/vm/jvms/threads/threads179/threads17901/threads17901p/test([Ljava/lang/String;)I
