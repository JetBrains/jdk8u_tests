...
.source threads18901p.j
.class public org/apache/harmony/vts/test/vm/jvms/threads/threads189/threads18901/threads18901p
...
.method public <init>()V
    ...
    aload_0
    iconst_1
    putfield org/apache/harmony/vts/test/vm/jvms/threads/threads189/threads18901/threads18901p/a I
    aload_0
    iconst_2
    putfield org/apache/harmony/vts/test/vm/jvms/threads/threads189/threads18901/threads18901p/b I
    return
.end method
...
.method public synchronized reset()V
    ...
    aload_0
    iconst_0
    putfield org/apache/harmony/vts/test/vm/jvms/threads/threads189/threads18901/threads18901p/c I
    ; d = 0;
    aload_0
    iconst_0
    putfield org/apache/harmony/vts/test/vm/jvms/threads/threads189/threads18901/threads18901p/d I
    return
.end method
...
.method public betty()V
    ...
    aload_0
    aload_0
    getfield org/apache/harmony/vts/test/vm/jvms/threads/threads189/threads18901/threads18901p/a I
    putfield org/apache/harmony/vts/test/vm/jvms/threads/threads189/threads18901/threads18901p/c I

    ; d = b;
    aload_0
    aload_0
    getfield org/apache/harmony/vts/test/vm/jvms/threads/threads189/threads18901/threads18901p/b I
    putfield org/apache/harmony/vts/test/vm/jvms/threads/threads189/threads18901/threads18901p/d I
    return
.end method
...
LoopStart:
    ; while (!interrupted()) {
    aload_0
    invokevirtual org/apache/harmony/vts/test/vm/jvms/threads/threads189/threads18901/threads18901p/interrupted()Z
    ifne Cleanup
...
ThreadsReady:
    ...
    ;          if (c != 1 && c != 3)
    aload_0
    getfield org/apache/harmony/vts/test/vm/jvms/threads/threads189/threads18901/threads18901p/c I
    iconst_1
    if_icmpeq SecondPair
    aload_0
    getfield org/apache/harmony/vts/test/vm/jvms/threads/threads189/threads18901/threads18901p/c I
    iconst_3
    if_icmpne SetFailed
SecondPair:
    ;          || (d != 2 && d != 4)) {
    aload_0
    getfield org/apache/harmony/vts/test/vm/jvms/threads/threads189/threads18901/threads18901p/d I
    iconst_2
    if_icmpeq Continue
    aload_0
    getfield org/apache/harmony/vts/test/vm/jvms/threads/threads189/threads18901/threads18901p/d I
...
Continue:
    ;         reset();
    aload_0
    invokevirtual org/apache/harmony/vts/test/vm/jvms/threads/threads189/threads18901/threads18901p/reset()V
    ;         t1.setReady(false);
    aload_3
    iconst_0
...
.method public static main([Ljava/lang/String;)V
    ...
    new org/apache/harmony/vts/test/vm/jvms/threads/threads189/threads18901/threads18901p
    dup
    invokespecial org/apache/harmony/vts/test/vm/jvms/threads/threads189/threads18901/threads18901p/<init>()V
    aload_0
    invokevirtual org/apache/harmony/vts/test/vm/jvms/threads/threads189/threads18901/threads18901p/test([Ljava/lang/String;)I
