...
.source threads20101p.j
.class public org/apache/harmony/vts/test/vm/jvms/threads/threads201/threads20101/threads20101p
...
.method public betty()V
    ...
    aload_0
    aload_0
    getfield org/apache/harmony/vts/test/vm/jvms/threads/threads201/threads20101/threads20101p/a I
    putfield org/apache/harmony/vts/test/vm/jvms/threads/threads201/threads20101/threads20101p/c I

    ; d = b;
    aload_0
    aload_0
    getfield org/apache/harmony/vts/test/vm/jvms/threads/threads201/threads20101/threads20101p/b I
    putfield org/apache/harmony/vts/test/vm/jvms/threads/threads201/threads20101/threads20101p/d I
    return
.end method
...
LoopStart:
    ; while (!interrupted()) {
    aload_0
    invokevirtual org/apache/harmony/vts/test/vm/jvms/threads/threads201/threads20101/threads20101p/interrupted()Z
    ifne Cleanup
...
ThreadsReady:
    ...
    ;          if (c != 1 && c != 3)
    aload_0
    getfield org/apache/harmony/vts/test/vm/jvms/threads/threads201/threads20101/threads20101p/c I
    iconst_1
...
SecondPair:
    ;          || (d != 2 && d != 4)) {
    aload_0
    getfield org/apache/harmony/vts/test/vm/jvms/threads/threads201/threads20101/threads20101p/d I
    iconst_2
    if_icmpeq Continue
    aload_0
    getfield org/apache/harmony/vts/test/vm/jvms/threads/threads201/threads20101/threads20101p/d I
...
Continue:
    ;         reset();
    aload_0
    invokevirtual org/apache/harmony/vts/test/vm/jvms/threads/threads201/threads20101/threads20101p/reset()V
    ;         t1.setReady(false);
    aload_3
    iconst_0
...
.method public static main([Ljava/lang/String;)V
    ...
    new org/apache/harmony/vts/test/vm/jvms/threads/threads201/threads20101/threads20101p
    dup
    invokespecial org/apache/harmony/vts/test/vm/jvms/threads/threads201/threads20101/threads20101p/<init>()V
    aload_0
    invokevirtual org/apache/harmony/vts/test/vm/jvms/threads/threads201/threads20101/threads20101p/test([Ljava/lang/String;)I
