...
/*
 * Method: org.apache.harmony.vts.test.vm.jvms.instructions.invokeReturn.invokeinterface.invokeinterface11.invokeinterface1108.invokeinterface1108p.nativeMethod(DDDDDD)I
 */
JNIEXPORT int JNICALL
Java_org_apache_harmony_vts_test_vm_jvms_instructions_invokeReturn_invokeinterface_invokeinterface11_invokeinterface1108_invokeinterface1108p_nativeMethod(JNIEnv *, jobject, jdouble, jdouble, jdouble, jdouble, jdouble, jdouble);

JNIEXPORT int JNICALL
Java_org_apache_harmony_vts_test_vm_jvms_instructions_invokeReturn_invokeinterface_invokeinterface11_invokeinterface1108_invokeinterface1108p_nativeMethod
    (JNIEnv *env, jobject obj, jdouble f0, jdouble f1, jdouble f2, jdouble f3, jdouble f4, jdouble f5)
{
