...
/*
 * Method: org.apache.harmony.vts.test.vm.jvms.instructions.invokeReturn.invokevirtual.invokevirtual21.invokevirtual2108.invokevirtual2108p.nativeMethod(DDDDDD)I
 */
JNIEXPORT int JNICALL
Java_org_apache_harmony_vts_test_vm_jvms_instructions_invokeReturn_invokevirtual_invokevirtual21_invokevirtual2108_invokevirtual2108p_nativeMethod
