...
/*
 * Method: org.apache.harmony.vts.test.vm.jvms.instructions.invokeReturn.invokespecial.invokespecial21.invokespecial2108.invokespecial2108p.nativeMethod(DDDDDD)I
 */
JNIEXPORT int JNICALL
Java_org_apache_harmony_vts_test_vm_jvms_instructions_invokeReturn_invokespecial_invokespecial21_invokespecial2108_invokespecial2108p_nativeMethod(JNIEnv *, jobject, jdouble, jdouble, jdouble, jdouble, jdouble, jdouble);

JNIEXPORT int JNICALL
Java_org_apache_harmony_vts_test_vm_jvms_instructions_invokeReturn_invokespecial_invokespecial21_invokespecial2108_invokespecial2108p_nativeMethod
