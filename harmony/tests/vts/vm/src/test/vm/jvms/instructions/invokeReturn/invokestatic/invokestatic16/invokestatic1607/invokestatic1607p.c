...
/*
 * Method: org.apache.harmony.vts.test.vm.jvms.instructions.invokeReturn.invokestatic.invokestatic16.invokestatic1607.invokestatic1607p.nativeMethod(FFFFFF)I
 */
JNIEXPORT int JNICALL
Java_org_apache_harmony_vts_test_vm_jvms_instructions_invokeReturn_invokestatic_invokestatic16_invokestatic1607_invokestatic1607p_nativeMethod(JNIEnv *, jclass, jfloat, jfloat, jfloat, jfloat, jfloat, jfloat);

JNIEXPORT int JNICALL
Java_org_apache_harmony_vts_test_vm_jvms_instructions_invokeReturn_invokestatic_invokestatic16_invokestatic1607_invokestatic1607p_nativeMethod
    (JNIEnv *env, jclass this_cls, jfloat f0, jfloat f1, jfloat f2, jfloat f3, jfloat f4, jfloat f5)
{
