...
public final class Field {
    ...
    public Field(long id, long classID, String name, String signature, int modBits) {
        this.id = id;
	    	...
	    	case JDWPConstants.Tag.ARRAY_TAG:
    	        switch (signature.charAt(1)) {
	        		...
	        		case 's':
	        		    ...
	        		    break;
	        		case 'L':
	        		    type = signature.substring(2, signature.length() - 1 /*skip ending ';'*/).replaceAll("/", ".") + "[]"; // skip ending ';'
	        		    break;
    	        }    	        
	    		break;
	    	case JDWPConstants.Tag.OBJECT_TAG:
	    	    type = signature.substring(1, signature.length() - 1 /*skip ending ';'*/).replaceAll("/", "."); // skip ending ';'
    	    	break;
    ...
    public boolean equals(Object obj) {
        ...
        return this.id == field.id && this.classID== field.classID && this.name.equals(field.name) && 
        	this.signature.equals(field.signature) && this.modBits == field.modBits;
    }
