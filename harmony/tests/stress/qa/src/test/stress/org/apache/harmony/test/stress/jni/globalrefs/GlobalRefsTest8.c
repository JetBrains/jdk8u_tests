...
#include<stdio.h>
#include<jni.h>
#include"GlobalRefsTest8.h"
#include"share.h"

JNIEXPORT void JNICALL
Java_org_apache_harmony_test_stress_jni_globalrefs_GlobalRefsTest8_init(JNIEnv* env,
                                                                      jclass clazz) {
  GlobalRefsTest_init(env, clazz);
}

JNIEXPORT void JNICALL
Java_org_apache_harmony_test_stress_jni_globalrefs_GlobalRefsTest8_nativeMethod(JNIEnv* env,
                                                                              jobject thisObject,
                                                                              jint cnt,
                                                                              jint len) {
  int i;
