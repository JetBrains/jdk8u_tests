 ...
 */
package org.apache.harmony.test.stress.classloader.SynchThreads.WrongClasses;

import junit.framework.TestCase;

import org.apache.harmony.test.stress.classloader.share.ClassLoaderTestError;
import org.apache.harmony.test.share.stress.ReliabilityRunner;
import org.apache.harmony.test.stress.classloader.OneThread.WrongClasses.testNECLoad;

public class testNECLoad_ST extends TestCase {
        ...
        for (testArgsCount = 0; testArgsCount < ARGS_COUNT; testArgsCount++) {
            preTestArgs[testArgsCount] = System
                    .getProperty("org.apache.harmony.test."
                            ...
                            + "WrongClasses.testNECLoad_ST.arg" + testArgsCount);
    ...
    static class testThread extends Thread {
        ...
        public void run() {
            ...
            test00.cnt++;
            try {
                for (int i = 0; i < testNECLoad_ST.loopTest; i++) {
                    synchronized (test00.class) {
                        int ans = t.test1(argsForTest);
                        testNECLoad_ST.tableResults[index] += ans;
                    }
                }
            } catch (Throwable e) {
                e.printStackTrace(System.out);
                testNECLoad_ST.tableResults[index] += 105;
            }
        }
    }
...
class test00 extends testNECLoad {
