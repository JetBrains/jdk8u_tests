...
public class StackTest12 extends STStackTest {
    ...
    public void doTest() {
        arrSize = Integer.getInteger(
                "org.apache.harmony.test.stress.jni."
                        + "stack.StackTest12.arrSize", 7000).intValue();
        attCount = Integer.getInteger(
                "org.apache.harmony.test.stress.jni."
                        + "stack.StackTest12.attempts", 200).intValue();
        int[] arr = null;
        try {
            arr = new int[arrSize];
        ...
        try {
            ...
            testLog("Working thread", "StackTest12 FAILED: Exception caught "
                    + t.getClass().getName());
            testLog("Working thread", t);
            ReliabilityRunner.debug("Test error");
            ReliabilityRunner.mainTest.addError(this, new JNITestError());
        }
        testLog("Working thread", "StackTest12 PASSED");
    }
