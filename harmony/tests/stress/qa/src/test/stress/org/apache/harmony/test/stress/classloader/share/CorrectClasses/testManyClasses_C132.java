...
public class testManyClasses_C132 extends testManyClasses_CA {
    protected static int cntClss = 0;

    public static int PUBSTAT_F = 132;

    protected int cntArObj;

    testManyClasses_C132[] arObj;

    public boolean initArObj(int cnt) {
        cntArObj = -1;
        arObj = new testManyClasses_C132[cnt];
        for (int i = 0; i < cnt; i++) {
            try {
                arObj[i] = new testManyClasses_C132();
            } catch (Throwable e) {
