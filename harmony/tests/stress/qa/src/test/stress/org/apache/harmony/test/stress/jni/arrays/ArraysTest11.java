...
public class ArraysTest11 extends MTArraysTest {
        ...
        try {
            arrSize = Integer.getInteger(
                    "org.apache.harmony.test."
                            + "stress.jni.arrays.ArraysTest11.arrSize", 10000)
                    .intValue();
            maxArrCount = Integer.getInteger(
                    "org.apache.harmony.test."
                            + "stress.jni.arrays.ArraysTest11.maxCnt", 2000)
                    .intValue();
            ...
            testLog("Working thread",
                    "ArraysTest11: ERROR: Unexpected exception caught: ");
