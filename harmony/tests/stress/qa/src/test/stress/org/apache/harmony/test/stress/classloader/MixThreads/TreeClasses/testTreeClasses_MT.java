 ...
 */
package org.apache.harmony.test.stress.classloader.MixThreads.TreeClasses;
...
public class testTreeClasses_MT extends TestCase {
    ...
    public void test() {
        ...
        for (testArgsCount = 0; testArgsCount < ARGS_COUNT; testArgsCount++) {
            preTestArgs[testArgsCount] = System
                    .getProperty("org.apache.harmony.test."
                            ...
                            + "TreeClasses.testTreeClasses_MT.arg"
                            + testArgsCount);
        ...
        ReliabilityRunner.debug("Start testTreeClasses_MT");
    ...
    static class testThread1 extends Thread {
        ...
        public void run() {
            ...
            test00.cnt++;
            try {
                for (int i = 0; i < testTreeClasses_MT.loopTest; i++) {
                    synchronized (test00.class) {
                        int ans = t.test1(argsForTest);
                        testTreeClasses_MT.tableResults[index] += ans;
                    }
                }
            } catch (Throwable e) {
                e.printStackTrace(System.out);
                testTreeClasses_MT.tableResults[index] += 105;
            }
        }
    }
