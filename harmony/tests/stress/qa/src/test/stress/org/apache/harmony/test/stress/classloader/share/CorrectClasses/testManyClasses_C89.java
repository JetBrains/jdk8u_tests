...
public class testManyClasses_C89 extends testManyClasses_CA {
    protected static int cntClss = 0;
    public static int PUBSTAT_F  = 89;
    protected int cntArObj;
    testManyClasses_C89 [] arObj;
    public boolean initArObj(int cnt) {
        cntArObj = -1;
        arObj = new testManyClasses_C89[cnt];
        for (int i = 0; i < cnt; i ++) {
            try {
                arObj[i] = new testManyClasses_C89();
            } catch (Throwable e) {
