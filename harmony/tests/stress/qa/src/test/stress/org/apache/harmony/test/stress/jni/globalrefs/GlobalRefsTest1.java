...
public class GlobalRefsTest1 extends STTest {
    ...
    public void doTest() {
        ...
        try {
            ...
            testLog("Working thread",
                    "GlobalRefsTest1 FAILED: No expected exception caught");
            ...
            if (!(t instanceof OutOfMemoryError)) {
                testLog(
                        "Working thread",
                        "GlobalRefsTest1: ERROR: Unexpected exception caught during first native method invocation:");
        ...
        try {
            ...
            if (!(t instanceof OutOfMemoryError)) {
                testLog(
                        "Working thread",
                        "GlobalRefsTest1: ERROR: Unexpected exception caught during further native method invocations:");
                testLog("Working thread", t);
                ReliabilityRunner.debug("Test error");
                ReliabilityRunner.mainTest.addError(this, new JNITestError());
            }
        }
        testLog("Working thread", "GlobalRefsTest1 PASSED");
    }
