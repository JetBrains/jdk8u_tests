...
public class ArraysTest22 extends STArraysTest {
        ...
        try {
            arrSize = Integer.getInteger(
                    "org.apache.harmony.test."
                            + "stress.jni.arrays.ArraysTest22.arrSize",
                    1000000).intValue();
            maxArrCount = Integer.getInteger(
                    "org.apache.harmony.test."
                            + "stress.jni.arrays.ArraysTest22.maxCnt",
            ...
            testLog("Working thread", "ArraysTest22: ERROR: Exception caught:");
