...
public class ExceptionsTest11 extends STExceptionsTest {
    ...
    public void doTest() {
        try {
            ...
            testLog("Working thread",
                    "ExceptionsTest11 FAILED: expected exception"
            ...
            if (getCounter() == 0) {
                testLog("Working thread",
                        "ExceptionsTest11 PASSED: Expected exception caught.");
            } else {
                testLog("Working thread",
                        "ExceptionsTest11 FAILED: Invalid exceptions counter value: "
            ...
            testLog("Working thread",
                    "ExceptionsTest11: ERROR: Exception caught in Java code");
