...
public class GlobalRefsTest3 extends MTTest {

    public GlobalRefsTest3(int threadId) {
        super(threadId);
    }
    
    public GlobalRefsTest3() {
        super(-1);
    }
    ...
    public void doTest() {
        ...
        try {
            ...
            testLog("Working thread",
                    "GlobalRefsTest3 FAILED: No expected exception caught");
            ...
            if (!(t instanceof OutOfMemoryError)) {
                testLog(
                        "Working thread",
                        "GlobalRefsTest3: ERROR: Unexpected exception caught during first native method invocation:");
        ...
        try {
            ...
            if (!(t instanceof OutOfMemoryError)) {
                testLog(
                        "Working thread",
                        "GlobalRefsTest3: ERROR: Unexpected exception caught during further native method invocations:");
                testLog("Working thread", t);
                ReliabilityRunner.debug("Test error");
                ReliabilityRunner.mainTest.addError(this, new JNITestError());
            }
