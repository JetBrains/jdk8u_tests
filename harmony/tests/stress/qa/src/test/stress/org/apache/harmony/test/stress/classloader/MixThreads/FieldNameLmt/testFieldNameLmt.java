...
package org.apache.harmony.test.stress.classloader.MixThreads.FieldNameLmt;
        ...
        if ((testArgs.length - 3) <= 0) {
            ...
            if (l <= 2) {
                ...
                if (mode == 0) {
                    ...
                    loopTest = (Integer.valueOf(testThread1.argsForTest[1]))
                            .intValue();
                    testThread1.argsForTest[1] = Integer.toString(1);
                }
            }
        }
