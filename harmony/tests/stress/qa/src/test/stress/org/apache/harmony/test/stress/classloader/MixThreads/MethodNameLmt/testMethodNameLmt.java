...
package org.apache.harmony.test.stress.classloader.MixThreads.MethodNameLmt;

import junit.framework.TestCase;

import org.apache.harmony.test.stress.classloader.share.ClassLoaderTestError;
import org.apache.harmony.test.share.stress.ReliabilityRunner;
import org.apache.harmony.test.stress.classloader.NotSynchThreads.MethodNameLmt.testMethodNameLmt_0;
...
public class testMethodNameLmt extends TestCase {
    ...
    public void test() {
        ...
        ReliabilityRunner.debug("Start testMethodNameLmt");
...
class testThread1 extends Thread {
    ...
    public void run() {
        ...
        test00.cnt++;
        try {
            for (int i = 0; i < testMethodNameLmt.loopTest; i++) {
                synchronized (test00.class) {
                    int ans = t.test1(argsForTest);
                    testMethodNameLmt.tableResults[index] += ans;
                }
            }
        } catch (Throwable e) {
            e.printStackTrace(System.out);
            testMethodNameLmt.tableResults[index] += 105;
        }
    }
}
...
class test00 extends testMethodNameLmt_0 {
