...
public class testManyClasses_C98 extends testManyClasses_CA {
    protected static int cntClss = 0;

    public static int PUBSTAT_F = 98;

    protected int cntArObj;

    testManyClasses_C98[] arObj;

    public boolean initArObj(int cnt) {
        cntArObj = -1;
        arObj = new testManyClasses_C98[cnt];
        for (int i = 0; i < cnt; i++) {
            try {
                arObj[i] = new testManyClasses_C98();
            } catch (Throwable e) {
