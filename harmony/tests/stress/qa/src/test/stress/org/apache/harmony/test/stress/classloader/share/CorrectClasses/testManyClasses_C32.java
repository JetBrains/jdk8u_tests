...
public class testManyClasses_C32 extends testManyClasses_CA {
    protected static int cntClss = 0;

    public static int PUBSTAT_F = 32;

    protected int cntArObj;

    testManyClasses_C32[] arObj;

    public boolean initArObj(int cnt) {
        cntArObj = -1;
        arObj = new testManyClasses_C32[cnt];
        for (int i = 0; i < cnt; i++) {
            try {
                arObj[i] = new testManyClasses_C32();
            } catch (Throwable e) {
