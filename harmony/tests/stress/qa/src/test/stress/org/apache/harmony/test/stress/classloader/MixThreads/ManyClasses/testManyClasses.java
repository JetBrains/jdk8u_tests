 ...
 */
package org.apache.harmony.test.stress.classloader.MixThreads.ManyClasses;

import junit.framework.TestCase;

import org.apache.harmony.test.stress.classloader.share.ClassLoaderTestError;
import org.apache.harmony.test.share.stress.ReliabilityRunner;
import org.apache.harmony.test.stress.classloader.NotSynchThreads.ManyClasses.testManyClasses_0;
...
class testThread1 extends Thread {
    ...
    public void run() {
        ...
        test00.cnt++;
        try {
            for (int i = 0; i < testManyClasses.loopTest; i++) {
                synchronized (test00.class) {
                    int ans = t.test1(argsForTest);
                    testManyClasses.tableResults[index] += ans;
                }
            }
        } catch (Throwable e) {
            e.printStackTrace(System.out);
            testManyClasses.tableResults[index] += 105;
        }
...
class test00 extends testManyClasses_0 {
