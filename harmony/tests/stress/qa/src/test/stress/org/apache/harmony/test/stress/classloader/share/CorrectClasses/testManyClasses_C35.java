...
public class testManyClasses_C35 extends testManyClasses_CA {
    protected static int cntClss = 0;

    public static int PUBSTAT_F = 35;

    protected int cntArObj;

    testManyClasses_C35[] arObj;

    public boolean initArObj(int cnt) {
        cntArObj = -1;
        arObj = new testManyClasses_C35[cnt];
        for (int i = 0; i < cnt; i++) {
            try {
                arObj[i] = new testManyClasses_C35();
            } catch (Throwable e) {
