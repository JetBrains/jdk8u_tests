...
package org.apache.harmony.test.stress.classloader.SynchThreads.MethodsLmt;

import junit.framework.TestCase;

import org.apache.harmony.test.stress.classloader.share.ClassLoaderTestError;
import org.apache.harmony.test.share.stress.ReliabilityRunner;
import org.apache.harmony.test.stress.classloader.NotSynchThreads.MethodsLmt.testMethodsLmt_0;
...
public class testMethodsLmt extends TestCase {
    ...
    public void test() {
        ...
        ReliabilityRunner.debug("Start testMethodsLmt");
...
class testThread extends Thread {
    ...
    public void run() {
        ...
        test00.cnt++;
        try {
            for (int i = 0; i < testMethodsLmt.loopTest; i++) {
                synchronized (test00.class) {
                    int ans = t.test1(argsForTest);
                    testMethodsLmt.tableResults[index] += ans;
                }
            }
        } catch (Throwable e) {
            e.printStackTrace(System.out);
            testMethodsLmt.tableResults[index] += 105;
        }

    }
}

class test00 extends testMethodsLmt_0 {
