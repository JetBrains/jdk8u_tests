...
public class JDWPConstants {
    ...
    public static class Tag {
        ...
        public static String getName(byte tag) {
            switch (tag) {
            case ARRAY_TAG       : return "ARRAY_TAG";
            case BYTE_TAG        : return "BYTE_TAG";
            case CHAR_TAG        : return "CHAR_TAG";
            case OBJECT_TAG      : return "OBJECT_TAG";
            case FLOAT_TAG       : return "FLOAT_TAG";
            case DOUBLE_TAG      : return "DOUBLE_TAG";
            case INT_TAG         : return "INT_TAG";
            case LONG_TAG        : return "LONG_TAG";
            case SHORT_TAG       : return "SHORT_TAG";
            case VOID_TAG        : return "VOID_TAG";
            case BOOLEAN_TAG     : return "BOOLEAN_TAG";
            case STRING_TAG      : return "STRING_TAG";
            case THREAD_TAG      : return "THREAD_TAG";
            case THREAD_GROUP_TAG: return "THREAD_GROUP_TAG";
            case CLASS_LOADER_TAG: return "CLASS_LOADER_TAG";
            case CLASS_OBJECT_TAG: return "CLASS_OBJECT_TAG";
    ...
    public static class EventKind {
        ...
        public static String getName(byte eventKind) {
            ...
            case FRAME_POP          : return "FRAME_POP";
            case EXCEPTION          : return "EXCEPTION";
            case USER_DEFINED       : return "USER_DEFINED";
            case THREAD_START       : return "THREAD_START";
            case THREAD_END         : return "THREAD_END";
            case CLASS_PREPARE      : return "CLASS_PREPARE";
            case CLASS_UNLOAD       : return "CLASS_UNLOAD";
            case CLASS_LOAD         : return "CLASS_LOAD";
            case FIELD_ACCESS       : return "FIELD_ACCESS";
            case FIELD_MODIFICATION : return "FIELD_MODIFICATION";
            case EXCEPTION_CATCH    : return "EXCEPTION_CATCH";
            case METHOD_ENTRY       : return "METHOD_ENTRY";
            case METHOD_EXIT        : return "METHOD_EXIT";
            case VM_INIT            : return "VM_INIT";
            case VM_DEATH           : return "VM_DEATH";
            case VM_DISCONNECTED    : return "VM_DISCONNECTED";
            default                 : return "<unknown>";
            }
        }
    }
    ...
    public static class Error {
        ...
        public static String getName(int errorCode) {
            ...
            case INVALID_THREAD                         : return "INVALID_THREAD";
            case INVALID_THREAD_GROUP                   : return "INVALID_THREAD_GROUP";
            case INVALID_PRIORITY                       : return "INVALID_PRIORITY";
            case THREAD_NOT_SUSPENDED                   : return "THREAD_NOT_SUSPENDED";
            case THREAD_SUSPENDED                       : return "THREAD_SUSPENDED";
            case INVALID_OBJECT                         : return "INVALID_OBJECT";
            case INVALID_CLASS                          : return "INVALID_CLASS";
            case CLASS_NOT_PREPARED                     : return "CLASS_NOT_PREPARED";
            case INVALID_METHODID                       : return "INVALID_METHODID";
            case INVALID_LOCATION                       : return "INVALID_LOCATION";
            case INVALID_FIELDID                        : return "INVALID_FIELDID";
            case INVALID_FRAMEID                        : return "INVALID_FRAMEID";
            case NO_MORE_FRAMES                         : return "NO_MORE_FRAMES";
            case OPAQUE_FRAME                           : return "OPAQUE_FRAME";
            case NOT_CURRENT_FRAME                      : return "NOT_CURRENT_FRAME";
            case TYPE_MISMATCH                          : return "TYPE_MISMATCH";
            case INVALID_SLOT                           : return "INVALID_SLOT";
            case DUPLICATE                              : return "DUPLICATE";
            case NOT_FOUND                              : return "NOT_FOUND";
            case INVALID_MONITOR                        : return "INVALID_MONITOR";
            case NOT_MONITOR_OWNER                      : return "NOT_MONITOR_OWNER";
            case INTERRUPT                              : return "INTERRUPT";
            case INVALID_CLASS_FORMAT                   : return "INVALID_CLASS_FORMAT";
            case CIRCULAR_CLASS_DEFENITION              : return "CIRCULAR_CLASS_DEFENITION";
            case FAILS_VERIFICATION                     : return "FAILS_VERIFICATION";
            case ADD_METHOD_NOT_IMPLEMENTED             : return "ADD_METHOD_NOT_IMPLEMENTED";
            case SCHEMA_CHANGE_NOT_IMPLEMENTED          : return "SCHEMA_CHANGE_NOT_IMPLEMENTED";
            case INVALID_TYPESTATE                      : return "INVALID_TYPESTATE";
            case HIERARCHY_CHANGE_NOT_IMPLEMENTED       : return "HIERARCHY_CHANGE_NOT_IMPLEMENTED";
            case DELETE_METHOD_NOT_IMPLEMENTED          : return "DELETE_METHOD_NOT_IMPLEMENTED";
            case UNSUPPORTED_VERSION                    : return "UNSUPPORTED_VERSION";
            case NAMES_DONT_MATCH                       : return "NAMES_DONT_MATCH";
            case CLASS_MODIFIERS_CHANGE_NOT_IMPLEMENTED : return "CLASS_MODIFIERS_CHANGE_NOT_IMPLEMENTED";
            case METHOD_MODIFIERS_CHANGE_NOT_IMPLEMENTED: return "METHOD_MODIFIERS_CHANGE_NOT_IMPLEMENTED";
            case NOT_IMPLEMENTED                        : return "NOT_IMPLEMENTED";
            case NULL_POINTER                           : return "NULL_POINTER";
            case ABSENT_INFORMATION                     : return "ABSENT_INFORMATION";
            case INVALID_EVENT_TYPE                     : return "INVALID_EVENT_TYPE";
            case ILLEGAL_ARGUMENT                       : return "ILLEGAL_ARGUMENT";
            case OUT_OF_MEMORY                          : return "OUT_OF_MEMORY";
            case ACCESS_DENIED                          : return "ACCESS_DENIED";
            case VM_DEAD                                : return "VM_DEAD";
            case INTERNAL                               : return "INTERNAL";
            case UNATTACHED_THREAD                      : return "UNATTACHED_THREAD";
            case INVALID_TAG                            : return "INVALID_TAG";
            case ALREADY_INVOKING                       : return "ALREADY_INVOKING";
            case INVALID_INDEX                          : return "INVALID_INDEX";
            case INVALID_LENGTH                         : return "INVALID_LENGTH";
            case INVALID_STRING                         : return "INVALID_STRING";
            case INVALID_CLASS_LOADER                   : return "INVALID_CLASS_LOADER";
            case INVALID_ARRAY                          : return "INVALID_ARRAY";
            case TRANSPORT_LOAD                         : return "TRANSPORT_LOAD";
            case TRANSPORT_INIT                         : return "TRANSPORT_INIT";
            case NATIVE_METHOD                          : return "NATIVE_METHOD";
    ...
    public static class SuspendPolicy {
        ...
        public static String getName(int code) {
            switch (code) {
                case NONE:          return "NONE";
                case EVENT_THREAD:  return "EVENT_THREAD";
                case ALL:           return "ALL";
                default:            return "<unknown>";
            }
        }
	...
	public static class FieldAccess {
		public static final int ACC_PUBLIC = 0x0001; // Is public; may be accessed from outside its package; Any field
		public static final int ACC_PRIVATE = 0x0002; // Is private; usable only within the defining class; Class field
		public static final int ACC_PROTECTED = 0x0004; // Is protected; may be accessed within subclasses; Class field
		public static final int ACC_STATIC = 0x0008; // Is static; Any field
		public static final int ACC_FINAL = 0x0010; // Is final; no further overriding or assignment after initialization; Any field  
		public static final int ACC_VOLATILE = 0x0040; // Is volatile; cannot be cached; Class field 
		public static final int ACC_TRANSIENT = 0x0080; // Is transient; not written or read by a persistent object manager; Class field  

        public static String getName(int code) {
			switch (code) {
				case ACC_PUBLIC: 		return "ACC_PUBLIC";
				case ACC_PRIVATE: 		return "ACC_PRIVATE";
				case ACC_PROTECTED: 	return "ACC_PROTECTED";
				case ACC_STATIC: 		return "ACC_STATIC";
				case ACC_FINAL: 		return "ACC_FINAL";
				case ACC_VOLATILE: 		return "ACC_VOLATILE";
				case ACC_TRANSIENT:		return "ACC_TRANSIENT";
                default:                return "<unknown>";
			}
		}
	}
