...
public class StackTest3 extends STStackTest {
    ...
    public void doTest() {
        arrSize = Integer.getInteger(
                "org.apache.harmony.test.stress.jni."
                        + "stack.StackTest3.arrSize", 7000).intValue();
        attCount = Integer.getInteger(
                "org.apache.harmony.test.stress.jni."
                        + "stack.StackTest3.attempts", 200).intValue();
