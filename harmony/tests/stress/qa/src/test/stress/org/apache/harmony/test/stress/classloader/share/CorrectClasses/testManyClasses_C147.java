...
public class testManyClasses_C147 extends testManyClasses_CA {
    protected static int cntClss = 0;

    public static int PUBSTAT_F = 147;

    protected int cntArObj;

    testManyClasses_C147[] arObj;

    public boolean initArObj(int cnt) {
        cntArObj = -1;
        arObj = new testManyClasses_C147[cnt];
        for (int i = 0; i < cnt; i++) {
            try {
                arObj[i] = new testManyClasses_C147();
            } catch (Throwable e) {
