...
public class LocalRefsTest6 extends STTest {
    ...
    public void doTest() {
        ...
        numRefs = Integer.getInteger(
                "org.apache.harmony.test.stress.jni."
                        + "localrefs.LocalRefsTest6.numRefs", 50000000)
                .intValue();

        invCount = Integer.getInteger(
                "org.apache.harmony.test.stress.jni."
                        + "localrefs.LocalRefsTest6.invCount", 20).intValue();
            ...
            try {
                ...
                if (!(t instanceof OutOfMemoryError)) {
                    testLog("Working thread",
                            "LocalRefsTest6 ERROR: Exception caught:");
        ...
        testLog("Working thread", "LocalRefsTest6 PASSED");
    }
