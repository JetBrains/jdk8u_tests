...
#include<jni.h>
#include<stdlib.h>
#include"StackTest8.h"
#include"share.h"

JNIEXPORT void JNICALL
Java_org_apache_harmony_test_stress_jni_stack_StackTest8_init(JNIEnv *env,
                                                              jobject c,
                                                              jint cnt) {
...
Java_org_apache_harmony_test_stress_jni_stack_StackTest8_nativeMethod(JNIEnv* env,
                                                                      jclass c,
                                                                      jintArray intArray,
                                                                      jint len,
                                                                      jint cnt,
