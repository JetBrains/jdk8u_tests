...
public class Frame {
    ...
    public String toString() {
        String string = "Frame: id=" + id + ", threadID=" + threadID + ", location=" + loc.toString() + "\n";
        string += "--- Variables ---";        
    ...
    public boolean equals(Object obj) {
        ...
        if (this.threadID != frame.threadID || this.id != frame.id || !(this.loc.equals(frame.loc))) {
            return false;
        }
    ...
    public final class Variable {
        ...
        public String toString() {
            return "Variable: codeIndex=" + codeIndex + ", name=" + name + 
            		...
            		length + ", slot=" + slot + ", tag=" + JDWPConstants.Tag.getName(tag) + ", type=" + type;
        }
        ...
        public boolean equals(Object obj) {
            ...
            return this.codeIndex == var.codeIndex && this.name.equals(var.name) &&
            	   this.signature.equals(var.signature) && this.length == var.length && 
            	   this.slot == var.slot && this.tag == var.tag && this.type.equals(var.type);
