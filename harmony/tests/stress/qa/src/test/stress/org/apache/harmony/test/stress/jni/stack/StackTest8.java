...
public class StackTest8 extends MTStackTest {
    ...
    public StackTest8(int threadId) {
        super(threadId);
    }
    ...
    public void doTest() {
        arrSize = Integer.getInteger(
                "org.apache.harmony.test.stress.jni."
                        + "stack.StackTest8.arrSize", 7000).intValue();
        attCount = Integer.getInteger(
                "org.apache.harmony.test.stress.jni."
                        + "stack.StackTest8.attempts", 200).intValue();
        int[] arr = null;
        try {
            arr = new int[arrSize];
        ...
        try {
            ...
            testLog("Working thread",
                    "StackTest8 FAILED: Exception caught in thread " + threadId);
