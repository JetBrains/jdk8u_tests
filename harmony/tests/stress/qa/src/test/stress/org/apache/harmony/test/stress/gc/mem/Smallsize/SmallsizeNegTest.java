...
/**
 */
public class SmallsizeNegTest extends TestCase {
    ...
    public void test() {
        MAX_MEM = Integer.getInteger(
                "org.apache.harmony.test."
                        + "stress.gc.mem.Smallsize."
                        + "SmallsizeNegTest.MAX_MEM", 0).intValue();

        try {
            array = new byte[MAX_MEM];
        } catch (OutOfMemoryError e) {
            ReliabilityRunner.debug("OutOfMemoryError is thrown: " + e);
        }
    }
}
