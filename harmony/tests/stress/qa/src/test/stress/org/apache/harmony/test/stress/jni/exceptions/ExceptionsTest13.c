...
#include<jni.h>
#include<stdlib.h>
#include"ExceptionsTest13.h"
#include"share.h"

JNIEXPORT void JNICALL
Java_org_apache_harmony_test_stress_jni_exceptions_ExceptionsTest13_init(JNIEnv *env,
                                                                         jobject thisObject,
                                                                         jint cnt) {
...
JNIEXPORT void JNICALL
Java_org_apache_harmony_test_stress_jni_exceptions_ExceptionsTest13_nativeMethod(
    JNIEnv* env,
    jclass c,
    jint cnt,
    jint id){
