...
public class ArraysTest23 extends MTArraysTest {
        ...
        try {
            arrSize = Integer.getInteger(
                    "org.apache.harmony.test."
                            + "stress.jni.arrays.ArraysTest23.arrSize", 10000).intValue();
            maxArrCount = Integer.getInteger(
                    "org.apache.harmony.test."
                            + "stress.jni.arrays.ArraysTest23.maxCnt", 2000).intValue();
            ...
            testLog("Working thread", "ArraysTest23: ERROR: Exception caught:");
