...
#include<jni.h>
#include<stdlib.h>
#include"ArraysTest13.h"
#include"share.h"

JNIEXPORT void JNICALL
Java_org_apache_harmony_test_stress_jni_arrays_ArraysTest13_init(JNIEnv *env,
                                                                 jclass c) {
...
Java_org_apache_harmony_test_stress_jni_arrays_ArraysTest13_doNativeCalc(
    JNIEnv *env,
    jobject thisObject,
    jint len,
    jint maxCnt,
