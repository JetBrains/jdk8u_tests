...
public class ExceptionsTest15 extends MTExceptionsTest {
    ...
    public ExceptionsTest15(int id) {
        super(id);
    }

    public ExceptionsTest15() {
        super(-1);
    }
    ...
    public void doTest() {
        try {
            ...
            testLog("Working thread",
                    "ExceptionsTest15 FAILED: No exception caught in Java code");
            ...
            if (getCounter(threadId) != 0) {
                testLog("Working thread",
                        "ExceptionsTest15 FAILED: Invalid exceptions counter value: "
            ...
            testLog("Working thread",
                    "ExceptionsTest15: ERROR: Unexpected exception caught in Java code:");
