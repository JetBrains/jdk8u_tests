...
public class testManyClasses_C145 extends testManyClasses_CA {
    protected static int cntClss = 0;

    public static int PUBSTAT_F = 145;

    protected int cntArObj;

    testManyClasses_C145[] arObj;

    public boolean initArObj(int cnt) {
        cntArObj = -1;
        arObj = new testManyClasses_C145[cnt];
        for (int i = 0; i < cnt; i++) {
            try {
                arObj[i] = new testManyClasses_C145();
            } catch (Throwable e) {
