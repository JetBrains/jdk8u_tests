...
public class LocalRefsTest3 extends MTTest {

    public LocalRefsTest3(int threadId) {
        super(threadId);
    }

    public LocalRefsTest3() {
        super(-1);
    }
    ...
    public void doTest() {
        ...
        try {
            ...
            testLog("Working thread",
                    "LocalRefsTest3 FAILED: No expected exception caught");
            ...
            if (!(t instanceof OutOfMemoryError)) {
                testLog("Working thread",
                        "LocalRefsTest3: ERROR: Exception caught:");
