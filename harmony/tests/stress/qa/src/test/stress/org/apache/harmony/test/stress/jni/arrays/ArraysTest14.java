...
public class ArraysTest14 extends STArraysTest {
    ...
    public void doTest() {
        try {
            arrSize = Integer
                    .getInteger(
                            "org.apache.harmony.test."
                                    + "stress.jni.arrays.ArraysTest14.arrSize",
                            1000000).intValue();
            maxArrCount = Integer.getInteger(
                    "org.apache.harmony.test."
                            + "stress.jni.arrays.ArraysTest14.maxCnt",
            ...
            if (res == 0) {
                testLog("Working thread", "ArraysTest14 FAILED");
                ReliabilityRunner.debug("Test failed");
                ReliabilityRunner.mainTest.addError(this, new JNITestError());
            }
        } catch (Throwable t) {
            testLog("Working thread", "ArraysTest14: ERROR: Exception caught:");
