...
public class testManyClasses_C56 extends testManyClasses_CA {
    protected static int cntClss = 0;

    public static int PUBSTAT_F = 56;

    protected int cntArObj;

    testManyClasses_C56[] arObj;

    public boolean initArObj(int cnt) {
        cntArObj = -1;
        arObj = new testManyClasses_C56[cnt];
        for (int i = 0; i < cnt; i++) {
            try {
                arObj[i] = new testManyClasses_C56();
            } catch (Throwable e) {
