...
public class testWCLoad_ST extends TestCase {
    ...
    public void test() {
        ...
        for (testArgsCount = 0; testArgsCount < ARGS_COUNT; testArgsCount++) {
            preTestArgs[testArgsCount] = System
                    .getProperty("org.apache.harmony.test."
                            ...
                            + "WrongClasses.testWCLoad_ST.arg" + testArgsCount);
        ...
        ReliabilityRunner.debug("Start testWCLoad_ST");
    ...
    static class testThread extends Thread {
        ...
        public void run() {
            ...
            test01.cnt++;
            try {
                for (int i = 0; i < testWCLoad_ST.loopTest; i++) {
                    synchronized (test01.class) {
                        int ans = t.test1(argsForTest);
                        testWCLoad_ST.tableResults[index] += ans;
                    }
                }
            } catch (Throwable e) {
                e.printStackTrace(System.out);
                testWCLoad_ST.tableResults[index] += 105;
            }
        }
    }
...
class test01 extends testWCLoad {
