...
public class testManyClasses_C133 extends testManyClasses_CA {
    protected static int cntClss = 0;

    public static int PUBSTAT_F = 133;

    protected int cntArObj;

    testManyClasses_C133[] arObj;

    public boolean initArObj(int cnt) {
        cntArObj = -1;
        arObj = new testManyClasses_C133[cnt];
        for (int i = 0; i < cnt; i++) {
            try {
                arObj[i] = new testManyClasses_C133();
            } catch (Throwable e) {
