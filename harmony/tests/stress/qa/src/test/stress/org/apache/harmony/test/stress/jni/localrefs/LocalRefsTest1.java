...
public class LocalRefsTest1 extends STTest {
    ...
    public void doTest() {
        ...
        try {
            ...
            testLog("Working thread",
                    "LocalRefsTest1 FAILED: No expected exception caught");
            ...
            if (!(t instanceof OutOfMemoryError)) {
                testLog("Working thread",
                        "LocalRefsTest1: ERROR: Exception caught:");
        ...
        testLog("Working thread", "LocalRefsTest1 PASSED");
    }
