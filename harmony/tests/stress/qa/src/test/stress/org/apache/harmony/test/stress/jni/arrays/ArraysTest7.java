...
public class ArraysTest7 extends MTArraysTest {
        ...
        try {
            arrSize = Integer.getInteger(
                    "org.apache.harmony.test."
                            + "stress.jni.arrays.ArraysTest7.arrSize", 10000)
                    .intValue();
            maxArrCount = Integer.getInteger(
                    "org.apache.harmony.test."
                            + "stress.jni.arrays.ArraysTest7.maxCnt", 2000)
                    .intValue();
            ...
            if (res == 0) {
                 ...
                 */
                testLog("Working thread", "ArraysTest7 FAILED (zero returned)");
            ...
            testLog("Working thread",
                    "ArraysTest7: ERROR: Unexpected exception caught: ");
