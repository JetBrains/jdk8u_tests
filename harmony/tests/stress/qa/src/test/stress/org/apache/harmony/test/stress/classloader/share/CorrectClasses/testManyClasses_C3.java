...
public class testManyClasses_C3 extends testManyClasses_CA {
    protected static int cntClss = 0;

    public static int PUBSTAT_F = 3;

    protected int cntArObj;

    testManyClasses_C3[] arObj;

    public boolean initArObj(int cnt) {
        cntArObj = -1;
        arObj = new testManyClasses_C3[cnt];
        for (int i = 0; i < cnt; i++) {
            try {
                arObj[i] = new testManyClasses_C3();
            } catch (Throwable e) {
