...
public class testWCLoad_MT extends TestCase {
    ...
    public void test() {
        ...
        for (testArgsCount = 0; testArgsCount < ARGS_COUNT; testArgsCount++) {
            preTestArgs[testArgsCount] = System
                    .getProperty("org.apache.harmony.test."
                            ...
                            + "WrongClasses.testWCLoad_MT.arg" + testArgsCount);
        ...
        ReliabilityRunner.debug("Start testWCLoad_MT");
    ...
    static class testThread1 extends Thread {
        ...
        public void run() {
            ...
            test01.cnt++;
            try {
                for (int i = 0; i < testWCLoad_MT.loopTest; i++) {
                    synchronized (test01.class) {
                        int ans = t.test1(argsForTest);
                        testWCLoad_MT.tableResults[index] += ans;
                    }
                }
            } catch (Throwable e) {
                e.printStackTrace(System.out);
                testWCLoad_MT.tableResults[index] += 105;
            }
        }
    }
