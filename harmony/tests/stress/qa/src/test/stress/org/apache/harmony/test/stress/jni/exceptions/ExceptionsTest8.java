...
public class ExceptionsTest8 extends MTExceptionsTest {
    ...
    public ExceptionsTest8(int id) {
        super(id);
    }

    public ExceptionsTest8() {
        super(-1);
    }
    ...
    public void doTest() {
        try {
            ...
            testLog("Working thread",
                    "ExceptionsTest8 FAILED: No exception caught in Java code");
            ...
            if (getCounter(threadId) != 0) {
                testLog("Working thread",
                        "ExceptionsTest8 FAILED: Invalid exceptions counter value: "
            ...
            testLog("Working thread",
                    "ExceptionsTest8: ERROR: Unexpected exception caught in Java code:");
