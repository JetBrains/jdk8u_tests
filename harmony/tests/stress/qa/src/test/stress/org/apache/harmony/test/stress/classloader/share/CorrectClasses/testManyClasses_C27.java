...
public class testManyClasses_C27 extends testManyClasses_CA {
    protected static int cntClss = 0;

    public static int PUBSTAT_F = 27;

    protected int cntArObj;

    testManyClasses_C27[] arObj;

    public boolean initArObj(int cnt) {
        cntArObj = -1;
        arObj = new testManyClasses_C27[cnt];
        for (int i = 0; i < cnt; i++) {
            try {
                arObj[i] = new testManyClasses_C27();
            } catch (Throwable e) {
