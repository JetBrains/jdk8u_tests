...
public class testManyClasses_C84 extends testManyClasses_CA {
    protected static int cntClss = 0;

    public static int PUBSTAT_F = 84;

    protected int cntArObj;

    testManyClasses_C84[] arObj;

    public boolean initArObj(int cnt) {
        cntArObj = -1;
        arObj = new testManyClasses_C84[cnt];
        for (int i = 0; i < cnt; i++) {
            try {
                arObj[i] = new testManyClasses_C84();
            } catch (Throwable e) {
