...
public class ArraysTest9 extends STArraysTest {
    ...
    public void doTest() {
        arrSize = Integer.getInteger(
                "org.apache.harmony.test."
                        + "stress.jni.arrays.ArraysTest9.arrSize", 10000)
                .intValue();
        maxArrCount = Integer.getInteger(
                "org.apache.harmony.test."
                        + "stress.jni.arrays.ArraysTest9.maxCnt",
        ...
        try {
            ...
            testLog("Working thread", "ArraysTest9: ERROR:");
