...
public class testManyClasses_C30 extends testManyClasses_CA {
    protected static int cntClss = 0;

    public static int PUBSTAT_F = 30;

    protected int cntArObj;

    testManyClasses_C30[] arObj;

    public boolean initArObj(int cnt) {
        cntArObj = -1;
        arObj = new testManyClasses_C30[cnt];
        for (int i = 0; i < cnt; i++) {
            try {
                arObj[i] = new testManyClasses_C30();
            } catch (Throwable e) {
