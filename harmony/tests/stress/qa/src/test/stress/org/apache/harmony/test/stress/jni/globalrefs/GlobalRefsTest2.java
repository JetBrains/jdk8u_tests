...
public class GlobalRefsTest2 extends STTest {
    ...
    public void doTest() {
        ...
        numRefs = Integer.getInteger(
                "org.apache.harmony.test.stress.jni."
                        + "globalrefs.GlobalRefsTest2.numRefs", 50000000)
                .intValue();

        invCount = Integer.getInteger(
                "org.apache.harmony.test.stress.jni."
                        + "globalrefs.GlobalRefsTest2.invCount", 20)
                .intValue();
            ...
            try {
                ...
                if (!(t instanceof OutOfMemoryError)) {
                    testLog("Working thread",
                            "GlobalRefsTest2 ERROR: Exception caught:");
        ...
        testLog("Working thread", "GlobalRefsTest2 PASSED");
    }
