...
#include<jni.h>
#include<stdlib.h>
#include"ArraysTest14.h"
#include"share.h"

JNIEXPORT void JNICALL
Java_org_apache_harmony_test_stress_jni_arrays_ArraysTest14_init(JNIEnv *env,
                                                               jclass c) {
...
Java_org_apache_harmony_test_stress_jni_arrays_ArraysTest14_doNativeCalc(
    JNIEnv *env,
    jobject thisObject,
    jint len,
    jint maxCnt,
  ...
  //allocate possible number of arrays of type Object (at most maxCnt)
