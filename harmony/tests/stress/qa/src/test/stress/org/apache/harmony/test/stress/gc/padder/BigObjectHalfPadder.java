...
/**
 * Memory padder by big objects (int[100][100][100]).
 * 
 * @author Alexander D. Shipilov
 * @version $Revision: 1.4 $
 * 
 */
public class BigObjectHalfPadder extends ObjectPadder {
    private static boolean skip;

    /**
     * Adds big object to list specified.
     * 
     * @param arrayOfObjects
     *            List to add big object.
     */
