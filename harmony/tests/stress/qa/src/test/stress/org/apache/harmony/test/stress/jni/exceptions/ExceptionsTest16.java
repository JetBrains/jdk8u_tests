...
public class ExceptionsTest16 extends MTExceptionsTest {
    ...
    public ExceptionsTest16(int id) {
        super(id);
    }

    public ExceptionsTest16() {
        super(-1);
    }
    ...
    public void doTest() {
        try {
            ...
            testLog("Working thread",
                    "ExceptionsTest16 FAILED: No exception caught in Java code");
            ...
            if (getCounter(threadId) != 0) {
                testLog("Working thread",
                        "ExceptionsTest16 FAILED: Invalid exceptions counter value: "
            ...
            testLog("Working thread",
                    "ExceptionsTest16: ERROR: Unexpected exception caught in Java code:");
