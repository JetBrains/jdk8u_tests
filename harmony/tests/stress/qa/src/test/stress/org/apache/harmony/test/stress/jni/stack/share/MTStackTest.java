...
package org.apache.harmony.test.stress.jni.stack.share;
...
public abstract class MTStackTest extends MTTest {
    ...
    public MTStackTest(int threadId) {
        super(threadId);
    }

    public void test() {
        int invCount = Integer.getInteger(
                "org.apache.harmony.test.stress.jni.stack."
                        + "share.STStackTest.invCount", 0).intValue();
        init(invCount);
        int fillMemory = Integer.getInteger(
                "org.apache.harmony.test.stress.jni.stack."
                        + "share.STStackTest.fillMemory", 1).intValue();
    ...
    protected static void fillMemory() {
        int objectSize = Integer.getInteger(
                "org.apache.harmony.test.stress."
                        + "jni.stack.share.STStackTest.objectSize", 1000)
                .intValue();
        int bufSize = Integer.getInteger(
                "org.apache.harmony.test.stress."
                        + "jni.stack.share.STStackTest.bufSize", 15000)
                .intValue();
    ...
    protected abstract void init(int cnt);
