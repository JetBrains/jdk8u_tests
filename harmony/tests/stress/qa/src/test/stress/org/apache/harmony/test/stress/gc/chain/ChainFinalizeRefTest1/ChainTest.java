 ...
 * 
 */
package org.apache.harmony.test.stress.gc.chain.ChainFinalizeRefTest1;
...
public class ChainTest extends TestCase {
    ...
    public void test() {
        SoftReference[] sr = new SoftReference[NUM / 2];
        WeakReference[] wr = new WeakReference[NUM / 2];
        ...
        try {
            for (; i < NUM; ++i) {
                ...
                if (i % 2 == 0) {
                    sr[i / 2] = new SoftReference(chain);
                } else {
                    wr[i / 2] = new WeakReference(chain);
                }
            }
