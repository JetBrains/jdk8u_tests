 ...
 */
public class ObjectTest005 extends StressTestCase {
    
    public final static String DEBUGGEE_CLASS_NAME = 
        "org.apache.harmony.test.stress.jpda.jdwp.scenario.OBJECT005.ObjectDebuggee005";
    ...
    public long[] arrayForCompare1 = new long[StressDebuggee.OBJECT005_ARRAY_LENGTH];
    public long[] arrayForCompare2 = new long[StressDebuggee.OBJECT005_ARRAY_LENGTH];
     ...
     * same array, checks if the same ObjectIDs are returned.
     */
    public Result  testObject005() {
        logWriter.println("==> testObject005: START (" + new Date() + ")...");
...
try {
        ...
        logWriter.println("\n");
        logWriter.println("==> Wait for debuggee to create big array of objects and Memory Stressing...");
        ...
        logWriter.println("==> testObject005: running time(mlsecs) = " + testRunTimeMlsec);
        if ( testCaseStatus == FAILURE ) {
            logWriter.println("==> testObject005: FAILED");
            return failed("testObject005:");
        } else {
            logWriter.println("==> testObject005: OK");
            return passed("testObject005: OK");
        }
    ...
    logWriter.println("==> testObject005: FAILED");
    return failed("==> testObject005: Unexpected Exception! ");
}
    }
    
       
    public static void main(String[] args) {
        System.exit(new ObjectTest005().test(args));
    }
}
