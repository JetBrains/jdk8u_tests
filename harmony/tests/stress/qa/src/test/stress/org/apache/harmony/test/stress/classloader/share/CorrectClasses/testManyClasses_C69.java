...
public class testManyClasses_C69 extends testManyClasses_CA {
    protected static int cntClss = 0;

    public static int PUBSTAT_F = 69;

    protected int cntArObj;

    testManyClasses_C69[] arObj;

    public boolean initArObj(int cnt) {
        cntArObj = -1;
        arObj = new testManyClasses_C69[cnt];
        for (int i = 0; i < cnt; i++) {
            try {
                arObj[i] = new testManyClasses_C69();
            } catch (Throwable e) {
