...
public class ExceptionsTest5 extends MTExceptionsTest {
    ...
    public ExceptionsTest5(int id) {
        super(id);
    }

    public ExceptionsTest5() {
        super(-1);
    }
    ...
    public void doTest() {
        int depth = Integer.getInteger(
                "org.apache.harmony.test.stress.jni."
                        + "exceptions.ExceptionsTest1.depth", 100).intValue();

        try {
            nativeMethod(depth, threadId);
            testLog("Working thread",
                    "ExceptionsTest5 FAILED: No exception caught in Java code");
            ...
            if (getCounter(threadId) != depth) {
                testLog("Working thread",
                        "ExceptionsTest5 FAILED: Invalid exceptions counter value: "
            ...
            testLog("Working thread",
                    "ExceptionsTest5: ERROR: Unexpected exception caught in Java code:");
