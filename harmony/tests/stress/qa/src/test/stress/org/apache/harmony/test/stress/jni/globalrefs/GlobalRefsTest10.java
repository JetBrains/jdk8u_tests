...
public class GlobalRefsTest10 extends MTTest {

    private int numRefs;

    private int invCount;

    public GlobalRefsTest10(int threadId) {
        super(threadId);
    }

    public GlobalRefsTest10() {
        super(-1);
    }
    ...
    public void doTest() {
        ...
        numRefs = Integer.getInteger(
                "org.apache.harmony.test.stress.jni."
                        + "globalrefs.GlobalRefsTest10.numRefs", 50000000)
                .intValue();

        invCount = Integer.getInteger(
                "org.apache.harmony.test.stress.jni."
                        + "globalrefs.GlobalRefsTest10.invCount", 20)
                .intValue();
            ...
            try {
                ...
                if (!(t instanceof OutOfMemoryError)) {
                    testLog("Working thread",
                            "GlobalRefsTest10 ERROR: Exception caught:");
