...
package org.apache.harmony.test.stress.classloader.NotSynchThreads.TreeClasses;
...
public class testTreeClasses_NST extends TestCase {
    ...
    public void test() {
        ...
        for (testArgsCount = 0; testArgsCount < ARGS_COUNT; testArgsCount++) {
            preTestArgs[testArgsCount] = System
                    .getProperty("org.apache.harmony.test."
                            ...
                            + "TreeClasses.testTreeClasses_NST.arg"
                            + testArgsCount);
        ...
        ReliabilityRunner.debug("Start testNECoad_NST");
    ...
    static class testThread extends Thread {
        ...
        public void run() {
            testTreeClasses_NST.tableResults[index] = new testTreeClasses()
                    .test1(argsForTest);
