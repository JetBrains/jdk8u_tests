...
public class testManyClasses_C25 extends testManyClasses_CA {
    protected static int cntClss = 0;

    public static int PUBSTAT_F = 25;

    protected int cntArObj;

    testManyClasses_C25[] arObj;

    public boolean initArObj(int cnt) {
        cntArObj = -1;
        arObj = new testManyClasses_C25[cnt];
        for (int i = 0; i < cnt; i++) {
            try {
                arObj[i] = new testManyClasses_C25();
            } catch (Throwable e) {
