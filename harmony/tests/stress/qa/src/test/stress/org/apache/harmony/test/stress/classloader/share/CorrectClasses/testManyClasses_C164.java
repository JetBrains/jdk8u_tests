...
public class testManyClasses_C164 extends testManyClasses_CA {
    protected static int cntClss = 0;

    public static int PUBSTAT_F = 164;

    protected int cntArObj;

    testManyClasses_C164[] arObj;

    public boolean initArObj(int cnt) {
        cntArObj = -1;
        arObj = new testManyClasses_C164[cnt];
        for (int i = 0; i < cnt; i++) {
            try {
                arObj[i] = new testManyClasses_C164();
            } catch (Throwable e) {
