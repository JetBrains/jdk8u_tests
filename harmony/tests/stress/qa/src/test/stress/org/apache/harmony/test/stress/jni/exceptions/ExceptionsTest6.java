...
public class ExceptionsTest6 extends MTExceptionsTest {
    ...
    public ExceptionsTest6(int id) {
        super(id);
    }

    public ExceptionsTest6() {
        super(-1);
    }
    ...
    public void doTest() {
        int depth = Integer.getInteger(
                "org.apache.harmony.test.stress.jni."
                        + "exceptions.ExceptionsTest6.depth", 100).intValue();

        try {
            nativeMethod(depth, threadId);
            testLog("Working thread",
                    "ExceptionsTest6 FAILED: No exception caught in Java code");
            ...
            if (getCounter(threadId) != depth) {
                testLog("Working thread",
                        "ExceptionsTest6 FAILED: Invalid exceptions counter value: "
            ...
            testLog("Working thread",
                    "ExceptionsTest6: ERROR: Unexpected exception caught in Java code:");
