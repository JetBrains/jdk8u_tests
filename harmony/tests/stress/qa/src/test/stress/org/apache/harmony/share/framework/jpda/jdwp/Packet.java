...
public class Packet {
    ...
    /**
     * Creates an empty CommandPacket with empty header fields and no data.
     */
    public Packet() {
    ...
    /**
     * Creates Packet from array of bytes including header and data sections.
     * 
     * @param array of bytes for new packet.
     */
     ...
     * 
     * @param i the id value of the header of the Packet.
     */
     ...
     * 
     * @param f the flags value of the header of the Packet.
     */
     ...
     * 
     * @param tag Type tag (see JDWP.tag)
     * @return the flags value of the header of the Packet.
     */
    public boolean isValuePrimitiveType(byte tag) {
        ...
        default: {
            throw new TestErrorException("Improper JDWP.tag value = "
                    + tag);
        }
        }
    }
    ...
    public void setNextValueAsShort(short val) {
        ...
        this.writeAtByteArray((long)val, data, new_data_size
            - TypesLengths.getTypeLength(TypesLengths.SHORT_ID), TypesLengths
            .getTypeLength(TypesLengths.SHORT_ID));
    }
    ...
    public void setNextValueAsFloat(float fval) {
        ...
        System.arraycopy(data_temp, 0, data, 0, new_data_size
            - TypesLengths.getTypeLength(TypesLengths.FLOAT_ID));
        this.writeAtByteArray((long)val, data, new_data_size
            - TypesLengths.getTypeLength(TypesLengths.FLOAT_ID), TypesLengths
            .getTypeLength(TypesLengths.FLOAT_ID));
    }
     ...
     * Chatset.
     * 
     * @param val the String in the "UTF-8" Chatset.
     */
    ...
    public void setNextValueAsObjectID(long val) {
        if (TypesLengths.getTypeLength(TypesLengths.OBJECT_ID) < 0
            ...
            throw new TestErrorException(
                "Improper ObjectID value length = "
        ...
        System.arraycopy(data_temp, 0, data, 0, new_data_size
            - TypesLengths.getTypeLength(TypesLengths.OBJECT_ID));
        this.writeAtByteArray(val, data, new_data_size
            - TypesLengths.getTypeLength(TypesLengths.OBJECT_ID), TypesLengths
     ...
     * 
     * @param val the ThreadGroupID value.
     */
     ...
     * bits in the val value will be ignored.
     * 
     * @param val the ClassLoaderID value.
     */
     ...
     * bits in the val value will be ignored.
     * 
     * @param val the ClassObjectID value.
     */
     ...
     * bits in the val value will be ignored.
     * 
     * @param val the ReferenceTypeID value.
     */
     ...
     * val value will be ignored.
     * 
     * @param val the InterfaceID value.
     */
     ...
     * val value will be ignored.
     * 
     * @param val the ArrayTypeID value.
     */
     ...
     * bits in the val value will be ignored.
     * 
     * @param taggedObject TaggedObject value.
     */
    ...
    /**
     * Gets the next value of the data of the Packet as tagged-objectID VM-sensitive
     * value. If length is less than 8 bytes, the appropriate high bits in the
     * returned value can be ignored.
     * 
     * @return the next value of the data of the Packet as VM-sensitive value.
     ...
     * val value will be ignored.
     * 
     * @param taggedObject MethodID value.
     */
    public void setNextValueAsMethodID(long methodID) {
        if (TypesLengths.getTypeLength(TypesLengths.METHOD_ID) < 0
            ...
            throw new TestErrorException(
                "Improper MethodID value length = "
        ...
        this.writeAtByteArray(methodID, data, new_data_size
            - TypesLengths.getTypeLength(TypesLengths.METHOD_ID), TypesLengths
            .getTypeLength(TypesLengths.METHOD_ID));
    }
     ...
     * val value will be ignored.
     * 
     * @param taggedObject FieldID value.
     */
    public void setNextValueAsFieldID(long fieldID) {
        ...
        this.writeAtByteArray(fieldID, data, new_data_size
            - TypesLengths.getTypeLength(TypesLengths.FIELD_ID), TypesLengths
            .getTypeLength(TypesLengths.FIELD_ID));
    }
     ...
     * val value will be ignored.
     * 
     * @param taggedObject FrameID value.
     */
    public void setNextValueAsFrameID(long frameID) {
        ...
        this.writeAtByteArray(frameID, data, new_data_size
            - TypesLengths.getTypeLength(TypesLengths.FRAME_ID), TypesLengths
            .getTypeLength(TypesLengths.FRAME_ID));
    }
     ...
     * bits in the val value will be ignored.
     * 
     * @param value UntaggedValue value.
     * @throws UnsupportedEncodingException
     */
    public void setNextValueAsUntaggedValue(Value value) {
    	...
    	case JDWPConstants.Tag.THREAD_TAG:
    		...
    		break;
    	default: 
            throw new TestErrorException("Illegal tag value = " + value.getTag());
        }
    }
     ...
     * val value will be ignored.
     * 
     * @param array ArrayRegion value.
     * @throws UnsupportedEncodingException
     */
//    public void setNextValueAsArrayRegion(ArrayRegion array) throws UnsupportedEncodingException {
    public void setNextValueAsArrayRegion(ArrayRegion array) {
        ...
        for (int i = 0; i < array.getLength(); i++) {
            if (isValuePrimitiveType(array.getTag())) {
                switch (array.getTag()) {
                    case JDWPConstants.Tag.BOOLEAN_TAG: 
                        this.setNextValueAsBoolean(array.getValue(i).getBooleanValue());
                        break;
                    case JDWPConstants.Tag.BYTE_TAG: 
                        this.setNextValueAsByte(array.getValue(i).getByteValue());
                        break;
                    case JDWPConstants.Tag.DOUBLE_TAG: 
                        this.setNextValueAsDouble(array.getValue(i).getDoubleValue());
                        break;
                    case JDWPConstants.Tag.FLOAT_TAG: 
                    ...
                    case JDWPConstants.Tag.SHORT_TAG: 
                        ...
                        break;
                    default:
                        throw new TestErrorException("Illegal tag value = " + array.getTag()); 
                }
            } else {
    ...
    /**
     * Reads value from array of bytes ar[] starting form index and reading size bytes.
     * If size is less than 8, the appropriate high bits in the resulting long value 
     * will be zero.
     * 
     * @param ar the array of bytes where the value is read from.
     * @param index index to start reading bytes.
     ...
     * 
     * @param val the value, which will be written in the array.
     * @param ar the array of bytes where the value is read from.
     * @param to the beginning index in the array of bytes.
     ...
     * 
     * @param p bytes representation of packet
     ...
     * 
     * @param p bytes array to enwrap into packet
