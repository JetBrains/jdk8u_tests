...
public class testManyClasses_C125 extends testManyClasses_CA {
    protected static int cntClss = 0;

    public static int PUBSTAT_F = 125;

    protected int cntArObj;

    testManyClasses_C125[] arObj;

    public boolean initArObj(int cnt) {
        cntArObj = -1;
        arObj = new testManyClasses_C125[cnt];
        for (int i = 0; i < cnt; i++) {
            try {
                arObj[i] = new testManyClasses_C125();
            } catch (Throwable e) {
