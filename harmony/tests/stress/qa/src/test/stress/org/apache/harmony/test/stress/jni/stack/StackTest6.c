...
#include<jni.h>
#include<stdlib.h>
#include"StackTest6.h"
#include"share.h"

JNIEXPORT void JNICALL
Java_org_apache_harmony_test_stress_jni_stack_StackTest6_init(JNIEnv *env,
                                                              jclass c,
                                                              jint cnt) {
...
Java_org_apache_harmony_test_stress_jni_stack_StackTest6_nativeMethod(JNIEnv* env,
                                                                      jclass c,
                                                                      jintArray intArray,
                                                                      jint len,
                                                                      jint cnt,
