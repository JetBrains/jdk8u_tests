...
public class testManyClasses_C63 extends testManyClasses_CA {
    protected static int cntClss = 0;

    public static int PUBSTAT_F = 63;

    protected int cntArObj;

    testManyClasses_C63[] arObj;

    public boolean initArObj(int cnt) {
        cntArObj = -1;
        arObj = new testManyClasses_C63[cnt];
        for (int i = 0; i < cnt; i++) {
            try {
                arObj[i] = new testManyClasses_C63();
            } catch (Throwable e) {
