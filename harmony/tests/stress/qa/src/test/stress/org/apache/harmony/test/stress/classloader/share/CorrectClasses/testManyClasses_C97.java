...
public class testManyClasses_C97 extends testManyClasses_CA {
    protected static int cntClss = 0;
    public static int PUBSTAT_F  = 97;
    protected int cntArObj;
    testManyClasses_C97 [] arObj;
    public boolean initArObj(int cnt) {
        cntArObj = -1;
        arObj = new testManyClasses_C97[cnt];
        for (int i = 0; i < cnt; i ++) {
            try {
                arObj[i] = new testManyClasses_C97();
            } catch (Throwable e) {
