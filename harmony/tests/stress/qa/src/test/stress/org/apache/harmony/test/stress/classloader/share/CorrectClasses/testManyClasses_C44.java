...
public class testManyClasses_C44 extends testManyClasses_CA {
    protected static int cntClss = 0;

    public static int PUBSTAT_F = 44;

    protected int cntArObj;

    testManyClasses_C44[] arObj;

    public boolean initArObj(int cnt) {
        cntArObj = -1;
        arObj = new testManyClasses_C44[cnt];
        for (int i = 0; i < cnt; i++) {
            try {
                arObj[i] = new testManyClasses_C44();
            } catch (Throwable e) {
