...
public class ExceptionsTest4 extends STExceptionsTest {
    ...
    public void doTest() {
        try {
            ...
            testLog("Working thread",
                    "ExceptionsTest4 FAILED: expected exception was not caught in Java code");
            ReliabilityRunner.debug("Test failed");
            ReliabilityRunner.mainTest.addError(this, new JNITestError());
        } catch (JNITestException e) {
            if (getCounter() == 0) {
                testLog("Working thread",
                        "ExceptionsTest4 PASSED: Expected exception caught.");
            } else {
                testLog("Working thread",
                        "ExceptionsTest4 FAILED: Invalid exceptions counter value: "
            ...
            testLog("Working thread",
                    "ExceptionsTest4: ERROR: Exception caught in Java code");
