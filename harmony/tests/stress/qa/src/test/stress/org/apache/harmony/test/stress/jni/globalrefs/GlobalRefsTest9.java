...
public class GlobalRefsTest9 extends MTTest {

    public GlobalRefsTest9(int threadId) {
        super(threadId);
    }
    
    public GlobalRefsTest9() {
        super(-1);
    }
    ...
    public void doTest() {
        ...
        try {
            ...
            testLog("Working thread",
                    "GlobalRefsTest9 FAILED: No expected exception caught");
            ...
            if (!(t instanceof OutOfMemoryError)) {
                testLog(
                        "Working thread",
                        "GlobalRefsTest9: ERROR: Unexpected exception caught during first native method invocation:");
        ...
        try {
            ...
            if (!(t instanceof OutOfMemoryError)) {
                testLog(
                        "Working thread",
                        "GlobalRefsTest9: ERROR: Unexpected exception caught during further native method invocations:");
                testLog("Working thread", t);
                ReliabilityRunner.debug("Test error");
                ReliabilityRunner.mainTest.addError(this, new JNITestError());
            }
