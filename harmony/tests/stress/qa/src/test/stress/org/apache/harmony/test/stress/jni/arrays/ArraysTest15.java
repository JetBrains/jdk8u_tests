...
public class ArraysTest15 extends MTArraysTest {
        ...
        try {
            arrSize = Integer.getInteger(
                    "org.apache.harmony.test."
                            + "stress.jni.arrays.ArraysTest15.arrSize", 10000)
                    .intValue();
            maxArrCount = Integer.getInteger(
                    "org.apache.harmony.test."
                            + "stress.jni.arrays.ArraysTest15.maxCnt", 2000)
                    .intValue();
            ...
            int res = doNativeCalc(arrSize, maxArrCount, tmp1, arrays);

            if (res == 0) {
                testLog("Working thread", "ArraysTest15 FAILED");
                ReliabilityRunner.debug("Test failed");
                ReliabilityRunner.mainTest.addError(this, new JNITestError());
            }
        } catch (Throwable t) {
            testLog("Working thread", "ArraysTest15: ERROR: Exception caught:");
