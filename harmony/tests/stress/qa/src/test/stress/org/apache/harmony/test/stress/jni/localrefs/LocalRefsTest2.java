...
public class LocalRefsTest2 extends STTest {
    ...
    public void doTest() {
        ...
        numRefs = Integer.getInteger(
                "org.apache.harmony.test.stress.jni."
                        + "localrefs.LocalRefsTest2.numRefs", 50000000)
                .intValue();

        invCount = Integer.getInteger(
                "org.apache.harmony.test.stress.jni."
                        + "localrefs.LocalRefsTest2.invCount", 20).intValue();
            ...
            try {
                ...
                if (!(t instanceof OutOfMemoryError)) {
                    testLog("Working thread",
                            "LocalRefsTest2 ERROR: Exception caught:");
        ...
        testLog("Working thread", "LocalRefsTest2 PASSED");
    }
