...
public class testManyClasses_C186 extends testManyClasses_CA {
    protected static int cntClss = 0;

    public static int PUBSTAT_F = 186;

    protected int cntArObj;

    testManyClasses_C186[] arObj;

    public boolean initArObj(int cnt) {
        cntArObj = -1;
        arObj = new testManyClasses_C186[cnt];
        for (int i = 0; i < cnt; i++) {
            try {
                arObj[i] = new testManyClasses_C186();
            } catch (Throwable e) {
