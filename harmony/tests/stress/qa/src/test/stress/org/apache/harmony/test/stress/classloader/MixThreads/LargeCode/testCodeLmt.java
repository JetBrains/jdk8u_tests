...
package org.apache.harmony.test.stress.classloader.MixThreads.LargeCode;

import junit.framework.TestCase;

import org.apache.harmony.test.stress.classloader.share.ClassLoaderTestError;
import org.apache.harmony.test.share.stress.ReliabilityRunner;
import org.apache.harmony.test.stress.classloader.NotSynchThreads.LargeCode.testCodeLmt_0;
...
public class testCodeLmt extends TestCase {
    ...
    public void test() {
        ...
        ReliabilityRunner.debug("Start testCodeLmt");
...
class testThread1 extends Thread {
    ...
    public void run() {
        ...
        test00.cnt++;
        try {
            for (int i = 0; i < testCodeLmt.loopTest; i++) {
                synchronized (test00.class) {
                    int ans = t.test1(argsForTest);
                    testCodeLmt.tableResults[index] += ans;
                }
            }
        } catch (Throwable e) {
            e.printStackTrace(System.out);
            testCodeLmt.tableResults[index] += 105;
        }
    }
...
class test00 extends testCodeLmt_0 {
