...
public class ArraysTest20 extends MTArraysTest {
        ...
        try {
            arrSize = Integer.getInteger(
                    "org.apache.harmony.test."
                            + "stress.jni.arrays.ArraysTest20.arrSize",
                    1000000).intValue();
            maxArrCount = Integer.getInteger(
                    "org.apache.harmony.test."
                            + "stress.jni.arrays.ArraysTest20.maxCnt", 20)
                    .intValue();
            ...
            testLog("Working thread", "ArraysTest20: ERROR: Exception caught:");
