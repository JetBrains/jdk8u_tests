...
public class ExceptionsTest1 extends STExceptionsTest {
    ...
    public void doTest() {
        ...
        try {
            ...
            testLog("Working thread",
                    "ExceptionsTest1 FAILED: Expected exception"
            ...
            if (getCounter() == depth) {
                testLog("Working thread",
                        "ExceptionsTest1 PASSED: Expected exception caught.");
            } else {
                testLog("Working thread",
                        "ExceptionsTest1 FAILED: Invalid exceptions counter value: "
            ...
            testLog("Working thread",
                    "ExceptionsTest1: ERROR: Unexpected exception caught in Java code");
