...
public class testManyClasses_C130 extends testManyClasses_CA {
    protected static int cntClss = 0;

    public static int PUBSTAT_F = 130;

    protected int cntArObj;

    testManyClasses_C130[] arObj;

    public boolean initArObj(int cnt) {
        cntArObj = -1;
        arObj = new testManyClasses_C130[cnt];
        for (int i = 0; i < cnt; i++) {
            try {
                arObj[i] = new testManyClasses_C130();
            } catch (Throwable e) {
