...
public class testManyClasses_C60 extends testManyClasses_CA {
    protected static int cntClss = 0;

    public static int PUBSTAT_F = 60;

    protected int cntArObj;

    testManyClasses_C60[] arObj;

    public boolean initArObj(int cnt) {
        cntArObj = -1;
        arObj = new testManyClasses_C60[cnt];
        for (int i = 0; i < cnt; i++) {
            try {
                arObj[i] = new testManyClasses_C60();
            } catch (Throwable e) {
