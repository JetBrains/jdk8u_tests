...
public class LocalRefsTest5 extends STTest {
    ...
    public void doTest() {
        ...
        try {
            ...
            testLog("Working thread",
                    "LocalRefsTest5 FAILED: No expected exception caught");
            ...
            if (!(t instanceof OutOfMemoryError)) {
                testLog("Working thread",
                        "LocalRefsTest5: ERROR: Exception caught:");
        ...
        testLog("Working thread", "LocalRefsTest5 PASSED");
    }
