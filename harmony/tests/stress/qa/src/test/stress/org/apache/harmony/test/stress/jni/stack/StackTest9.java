...
public class StackTest9 extends STStackTest {
    ...
    public void doTest() {
        arrSize = Integer.getInteger(
                "org.apache.harmony.test.stress."
                        + "jni.stack.StackTest9.arrSize", 100000).intValue();
        invCount = Integer.getInteger(
                "org.apache.harmony.test.stress."
                        + "jni.stack.StackTest9.invCount", 200).intValue();
