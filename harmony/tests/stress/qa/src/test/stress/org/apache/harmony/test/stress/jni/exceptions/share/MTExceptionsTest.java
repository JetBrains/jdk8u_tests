...
public abstract class MTExceptionsTest extends MTTest {
    ...
    public MTExceptionsTest(int id) {
        super(id);
    }
    ...
    public void test() {
        int threadsCount = Integer.getInteger(
                "org.apache.harmony.test."
                        ...
                        + "MTExceptionsTest.threadsCount", 100).intValue();
        ...
        int fillMemory = Integer.getInteger(
                "org.apache.harmony.test."
                        + "stress.jni.exceptions.share."
                        + "MTExceptionsTest.fillMemory", 1).intValue();
    ...
    protected static void fillMemory() {
        int objectSize = Integer.getInteger(
                "org.apache.harmony.test."
                        + "stress.jni.exceptions.share."
                        + "MTExceptionsTest.objectSize", 1000).intValue();
        int bufSize = Integer.getInteger(
                "org.apache.harmony.test."
                        + "stress.jni.exceptions.share."
                        + "MTExceptionsTest.bufSize", 10000).intValue();
    ...
    protected abstract void init(int threadsCount);
