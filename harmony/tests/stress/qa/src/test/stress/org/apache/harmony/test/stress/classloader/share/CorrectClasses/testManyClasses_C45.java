...
public class testManyClasses_C45 extends testManyClasses_CA {
    protected static int cntClss = 0;

    public static int PUBSTAT_F = 45;

    protected int cntArObj;

    testManyClasses_C45[] arObj;

    public boolean initArObj(int cnt) {
        cntArObj = -1;
        arObj = new testManyClasses_C45[cnt];
        for (int i = 0; i < cnt; i++) {
            try {
                arObj[i] = new testManyClasses_C45();
            } catch (Throwable e) {
