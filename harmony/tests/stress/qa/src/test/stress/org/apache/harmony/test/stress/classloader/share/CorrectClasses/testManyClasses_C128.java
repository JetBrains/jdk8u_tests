...
public class testManyClasses_C128 extends testManyClasses_CA {
    protected static int cntClss = 0;

    public static int PUBSTAT_F = 128;

    protected int cntArObj;

    testManyClasses_C128[] arObj;

    public boolean initArObj(int cnt) {
        cntArObj = -1;
        arObj = new testManyClasses_C128[cnt];
        for (int i = 0; i < cnt; i++) {
            try {
                arObj[i] = new testManyClasses_C128();
            } catch (Throwable e) {
