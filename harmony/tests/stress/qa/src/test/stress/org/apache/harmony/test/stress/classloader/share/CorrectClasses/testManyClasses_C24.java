...
public class testManyClasses_C24 extends testManyClasses_CA {
    protected static int cntClss = 0;

    public static int PUBSTAT_F = 24;

    protected int cntArObj;

    testManyClasses_C24[] arObj;

    public boolean initArObj(int cnt) {
        cntArObj = -1;
        arObj = new testManyClasses_C24[cnt];
        for (int i = 0; i < cnt; i++) {
            try {
                arObj[i] = new testManyClasses_C24();
            } catch (Throwable e) {
