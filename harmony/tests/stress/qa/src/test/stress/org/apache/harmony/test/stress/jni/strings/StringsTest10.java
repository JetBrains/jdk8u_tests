...
public class StringsTest10 extends STTest {
        ...
        try {
            int length = Integer.getInteger(
                    "org.apache.harmony.test.stress.jni."
                            + "strings.StringsTest10.length", 1000000)
                    .intValue();
            int maxStrCount = Integer.getInteger(
                    "org.apache.harmony.test.stress.jni."
                            + "strings.StringsTest10.maxStrCount", 100)
                    .intValue();
