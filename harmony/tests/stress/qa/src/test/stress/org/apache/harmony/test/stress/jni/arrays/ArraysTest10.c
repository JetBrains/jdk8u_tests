...
#include<jni.h>
#include<stdlib.h>
#include"ArraysTest10.h"
#include"share.h"

JNIEXPORT void JNICALL
Java_org_apache_harmony_test_stress_jni_arrays_ArraysTest10_init(JNIEnv *env,
                                                               jclass c) {
...
JNIEXPORT void JNICALL
Java_org_apache_harmony_test_stress_jni_arrays_ArraysTest10_doNativeCalc(
    JNIEnv *env,
    jobject thisObject,
    jint len,
    jint maxCnt,
  ...
  for (i = 0; i < cnt; i++) {
    ...
    //call Java method to perform calculation on array
