...
public class testManyClasses_C110 extends testManyClasses_CA {
    protected static int cntClss = 0;

    public static int PUBSTAT_F = 110;

    protected int cntArObj;

    testManyClasses_C110[] arObj;

    public boolean initArObj(int cnt) {
        cntArObj = -1;
        arObj = new testManyClasses_C110[cnt];
        for (int i = 0; i < cnt; i++) {
            try {
                arObj[i] = new testManyClasses_C110();
            } catch (Throwable e) {
