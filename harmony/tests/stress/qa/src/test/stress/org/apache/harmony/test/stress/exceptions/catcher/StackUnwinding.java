...
public class StackUnwinding extends Catcher {
    ...
    private void screwAndThrow(int deepUnwinding) throws Throwable {
        if (deepUnwinding > 0) {
            screwAndThrow(deepUnwinding - 1);
        } else {
            doThrow();
        }
    }
