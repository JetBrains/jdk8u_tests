...
#include<jni.h>
#include<stdlib.h>
#include"ExceptionsTest11.h"
#include"share.h"

JNIEXPORT void JNICALL
Java_org_apache_harmony_test_stress_jni_exceptions_ExceptionsTest11_init(JNIEnv *env,
                                                                         jclass c) {
  ExceptionsTest_init(env, c);
}

JNIEXPORT void JNICALL
Java_org_apache_harmony_test_stress_jni_exceptions_ExceptionsTest11_nativeMethod(
    JNIEnv* env,
    jclass c,
    jint cnt){
