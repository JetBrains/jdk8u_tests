...
public class testNECLoad_MT extends TestCase {
    ...
    public void test() {
        ...
        for (testArgsCount = 0; testArgsCount < ARGS_COUNT; testArgsCount++) {
            preTestArgs[testArgsCount] = System
                    .getProperty("org.apache.harmony.test."
                            ...
                            + "WrongClasses.testNECLoad_MT.arg" + testArgsCount);
        ...
        ReliabilityRunner.debug("Start testNECLoad_MT");
    ...
    static class testThread1 extends Thread {
        ...
        public void run() {
            ...
            test00.cnt++;
            try {
                for (int i = 0; i < testNECLoad_MT.loopTest; i++) {
                    synchronized (test00.class) {
                        int ans = t.test1(argsForTest);
                        testNECLoad_MT.tableResults[index] += ans;
                    }
                }
            } catch (Throwable e) {
                e.printStackTrace(System.out);
                testNECLoad_MT.tableResults[index] += 105;
            }
        }
    }
