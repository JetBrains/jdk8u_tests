...
#include<jni.h>
#include<stdlib.h>
#include"StringsTest5.h"
#include"share.h"

JNIEXPORT void JNICALL
Java_org_apache_harmony_test_stress_jni_strings_StringsTest5_init(JNIEnv* env,
                                                                  jclass c) {
  StringsTest_init_no_Java_method(env,c);
}

JNIEXPORT jint JNICALL
Java_org_apache_harmony_test_stress_jni_strings_StringsTest5_nativeMethod(JNIEnv *env,
                                                                          jobject this,
                                                                          jint len,
                                                                          jint maxCnt) {
  int i,cnt;
