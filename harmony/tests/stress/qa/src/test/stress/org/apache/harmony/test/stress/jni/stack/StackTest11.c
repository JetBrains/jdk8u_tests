...
#include<jni.h>
#include<stdlib.h>
#include"StackTest11.h"
#include"share.h"

JNIEXPORT void JNICALL
Java_org_apache_harmony_test_stress_jni_stack_StackTest11_init(JNIEnv *env,
                                                               jobject obj,
                                                               jint cnt) {
...
Java_org_apache_harmony_test_stress_jni_stack_StackTest11_nativeMethod(JNIEnv* env,
                                                                       jobject thisObject,
                                                                       jintArray intArray,
                                                                       jint len,
                                                                       jint cnt){
