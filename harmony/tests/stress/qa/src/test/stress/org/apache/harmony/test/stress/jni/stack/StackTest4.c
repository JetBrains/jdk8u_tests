...
#include<jni.h>
#include<stdlib.h>
#include"StackTest4.h"
#include"share.h"

JNIEXPORT void JNICALL
Java_org_apache_harmony_test_stress_jni_stack_StackTest4_init(JNIEnv *env,
                                                              jclass c,
                                                              jint cnt) {
...
Java_org_apache_harmony_test_stress_jni_stack_StackTest4_nativeMethod(JNIEnv* env,
                                                                      jclass c,
                                                                      jintArray intArray,
                                                                      jint len,
                                                                      jint cnt){
  ...
  if ((*env)->ExceptionCheck(env)) {
    ...
    printf("Native code: Exception caught during recursive native method call\n");
  }
