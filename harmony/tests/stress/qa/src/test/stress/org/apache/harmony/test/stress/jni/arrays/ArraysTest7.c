...
#include<stdlib.h>
#include"share.h"
#include"ArraysTest7.h"

JNIEXPORT void JNICALL
Java_org_apache_harmony_test_stress_jni_arrays_ArraysTest7_init(JNIEnv *env,
                                                                jclass c) {
...
Java_org_apache_harmony_test_stress_jni_arrays_ArraysTest7_doNativeCalc(
    JNIEnv *env,
    jobject thisObject,
    jint len,
    jint maxCnt,
