...
package org.apache.harmony.test.stress.classloader.SynchThreads.FieldNameLmt;

import junit.framework.TestCase;

import org.apache.harmony.test.stress.classloader.share.ClassLoaderTestError;
import org.apache.harmony.test.share.stress.ReliabilityRunner;
import org.apache.harmony.test.stress.classloader.NotSynchThreads.FieldNameLmt.testFieldNameLmt_0;
...
public class testFieldNameLmt extends TestCase {
    ...
    public void test() {
        ...
        ReliabilityRunner.debug("Start testFieldNameLmt");
...
class testThread extends Thread {
    ...
    public void run() {
        ...
        test00.cnt++;
        try {
            for (int i = 0; i < testFieldNameLmt.loopTest; i++) {
                synchronized (test00.class) {
                    int ans = t.test1(argsForTest);
                    testFieldNameLmt.tableResults[index] += ans;
                }
            }
        } catch (Throwable e) {
            e.printStackTrace(System.out);
            testFieldNameLmt.tableResults[index] += 105;
        }
...
class test00 extends testFieldNameLmt_0 {
