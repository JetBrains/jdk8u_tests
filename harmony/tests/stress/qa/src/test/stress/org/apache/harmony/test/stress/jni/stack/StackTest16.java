...
public class StackTest16 extends MTStackTest {
    ...
    public StackTest16(int threadId) {
        super(threadId);
    }
    ...
    public void doTest() {
        synchronized (StackTest16.class) {
            if (arrSize == 0) {
                arrSize = Integer.getInteger(
                        "org.apache.harmony.test.stress."
                                + "jni.stack.StackTest16.arrSize", 1000)
                        .intValue();
                attCount = Integer.getInteger(
                        "org.apache.harmony.test.stress."
                                + "jni.stack.StackTest16.attempts", 200)
                        .intValue();
            }
        }
        int[] arr = null;
        ...
        try {
            ...
            testLog("Working thread",
                    "StackTest16 FAILED: Exception caught in thread "
                            + threadId);
