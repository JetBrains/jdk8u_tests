...
public class GlobalRefsTest8 extends MTTest {
    ...
    public GlobalRefsTest8(int threadId) {
        super(threadId);
    }

    public GlobalRefsTest8() {
        super(-1);
    }
    ...
    public void doTest() {
        objCount = Integer.getInteger(
                "org.apache.harmony.test.stress.jni."
                        + "globalrefs.GlobalRefsTest8.objCount", 10000000)
                .intValue();

        invCount = Integer.getInteger(
                "org.apache.harmony.test.stress.jni."
                        + "globalrefs.GlobalRefsTest8.invCount", 20).intValue();

        numRefs = objCount / invCount;

        synchronized (GlobalRefsTest8.class) {
            if (objs == null) {
            ...
            try {
                ...
                if (!(t instanceof OutOfMemoryError)) {
                    testLog("Working thread",
                            "GlobalRefsTest8: ERROR: Exception caught:");
