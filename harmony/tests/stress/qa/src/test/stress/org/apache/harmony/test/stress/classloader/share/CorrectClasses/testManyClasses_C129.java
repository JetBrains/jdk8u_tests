...
public class testManyClasses_C129 extends testManyClasses_CA {
    protected static int cntClss = 0;

    public static int PUBSTAT_F = 129;

    protected int cntArObj;

    testManyClasses_C129[] arObj;

    public boolean initArObj(int cnt) {
        cntArObj = -1;
        arObj = new testManyClasses_C129[cnt];
        for (int i = 0; i < cnt; i++) {
            try {
                arObj[i] = new testManyClasses_C129();
            } catch (Throwable e) {
