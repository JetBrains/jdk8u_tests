...
#include<jni.h>
#include<stdlib.h>
#include"StringsTest11.h"
#include"share.h"

JNIEXPORT void JNICALL
Java_org_apache_harmony_test_stress_jni_strings_StringsTest11_init(JNIEnv* env,
                                                                   jclass c) {
  StringsTest_init(env,c);
}

JNIEXPORT jint JNICALL
Java_org_apache_harmony_test_stress_jni_strings_StringsTest11_nativeMethod(JNIEnv *env,
                                                                           jobject this,
                                                                           jint len,
                                                                           jint maxCnt) {
  int i,cnt;
