 ...
 */
package org.apache.harmony.test.stress.classloader.SynchThreads.SubClasses;

import junit.framework.TestCase;

import org.apache.harmony.test.stress.classloader.share.ClassLoaderTestError;
import org.apache.harmony.test.share.stress.ReliabilityRunner;
import org.apache.harmony.test.stress.classloader.NotSynchThreads.SubClasses.testManySubClasses_0;
...
public class testManySubClasses extends TestCase {
    ...
    public void test() {
        ...
        ReliabilityRunner.debug("Start testManySubClasses");
...
class testThread extends Thread {
    ...
    public void run() {
        ...
        test00.cnt++;
        try {
            for (int i = 0; i < testManySubClasses.loopTest; i++) {
                synchronized (test00.class) {
                    int ans = t.test1(argsForTest);
                    testManySubClasses.tableResults[index] += ans;
                }
            }
        } catch (Throwable e) {
            e.printStackTrace(System.out);
            testManySubClasses.tableResults[index] += 105;
        }
...
class test00 extends testManySubClasses_0 {
