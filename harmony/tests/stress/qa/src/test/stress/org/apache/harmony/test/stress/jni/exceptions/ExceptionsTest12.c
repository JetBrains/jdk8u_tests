...
#include<jni.h>
#include<stdlib.h>
#include"ExceptionsTest12.h"
#include"share.h"

JNIEXPORT void JNICALL
Java_org_apache_harmony_test_stress_jni_exceptions_ExceptionsTest12_init(JNIEnv *env,
                                                                         jclass c) {
  ExceptionsTest_init(env, c);
}

JNIEXPORT void JNICALL
Java_org_apache_harmony_test_stress_jni_exceptions_ExceptionsTest12_nativeMethod(
    JNIEnv* env,
    jclass c,
    jint cnt){
