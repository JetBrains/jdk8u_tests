...
public class ArraysTest4 extends MTArraysTest {
    ...
    public void doTest() {
        try {
            arrSize = Integer
                    .getInteger(
                            "org.apache.harmony.test."
                                    + "stress.jni.arrays.ArraysTest4.arrSize",
                            1000000).intValue();
            maxArrCount = Integer.getInteger(
                    "org.apache.harmony.test."
                            + "stress.jni.arrays.ArraysTest4.maxCnt", 20)
                    .intValue();
            ...
            if (res == 0) {
                 ...
                 */
                testLog("Working thread", "ArraysTest4 FAILED");
            ...
            testLog("Working thread",
                    "ArraysTest4: ERROR: Unexpected exception caught:");
