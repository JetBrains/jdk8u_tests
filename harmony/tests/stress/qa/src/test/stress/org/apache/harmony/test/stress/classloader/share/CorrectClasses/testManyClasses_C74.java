...
public class testManyClasses_C74 extends testManyClasses_CA {
    protected static int cntClss = 0;

    public static int PUBSTAT_F = 74;

    protected int cntArObj;

    testManyClasses_C74[] arObj;

    public boolean initArObj(int cnt) {
        cntArObj = -1;
        arObj = new testManyClasses_C74[cnt];
        for (int i = 0; i < cnt; i++) {
            try {
                arObj[i] = new testManyClasses_C74();
            } catch (Throwable e) {
