...
/**
 * This class provides types legth for VM-independent and VM-dependent types.
 */
public class TypesLengths {
     ...
     * @return type length
     */
    public static void setTypeLength(byte typeID, int typeLength) throws TestErrorException {
        switch (typeID) {
        case BYTE_ID: {
