...
#include<jni.h>
#include<stdlib.h>
#include"StackTest16.h"
#include"share.h"

JNIEXPORT void JNICALL
Java_org_apache_harmony_test_stress_jni_stack_StackTest16_init(JNIEnv *env,
                                                               jobject obj,
                                                               jint cnt) {
...
Java_org_apache_harmony_test_stress_jni_stack_StackTest16_nativeMethod(JNIEnv* env,
                                                                       jobject thisObject,
                                                                       jintArray intArray,
                                                                       jint len,
                                                                       jint cnt,
  ...
  res2 = (*env)->CallObjectMethod(env, thisObject, mid, res, len, 0);
  if ((*env)->ExceptionCheck(env)) {
