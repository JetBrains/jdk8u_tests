...
public class testManyClasses_C196 extends testManyClasses_CA {
    protected static int cntClss = 0;

    public static int PUBSTAT_F = 196;

    protected int cntArObj;

    testManyClasses_C196[] arObj;

    public boolean initArObj(int cnt) {
        cntArObj = -1;
        arObj = new testManyClasses_C196[cnt];
        for (int i = 0; i < cnt; i++) {
            try {
                arObj[i] = new testManyClasses_C196();
            } catch (Throwable e) {
