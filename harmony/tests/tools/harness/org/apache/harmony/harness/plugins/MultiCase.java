...
public class MultiCase extends MultiCaseDRL {

    private final String classID = "MultiCase";
    ...
    public int runOther(String[] args) {
        ...
        try {
            // by default: copy the system.out to outMsg (merge with system.err)
            // for frameworks use the runners with suffix that divide
            // these streams to separated fields
