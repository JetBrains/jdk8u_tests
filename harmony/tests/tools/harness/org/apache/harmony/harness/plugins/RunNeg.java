...
public class RunNeg extends RunNegDRL {

    private final String classID = "RunNeg";
    ...
    public int runOther(String[] args) {
        ...
        try {
            ...
            //for frameworks use the runners with suffix that divide these
            //streams to separated fields
