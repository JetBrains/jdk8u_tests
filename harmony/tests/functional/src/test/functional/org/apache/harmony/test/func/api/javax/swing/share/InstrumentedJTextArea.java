...
public class InstrumentedJTextArea extends JTextArea {


    public void append(String arg0) {
        InstrumentedUILog.add(new Object[] {"JTextArea.append",  arg0} );
        super.append(arg0);
    }

    public Document createDefaultModel() {
        InstrumentedUILog.add(new Object[] {"JTextArea.createDefaultModel"} );
        return super.createDefaultModel();
    }

    public AccessibleContext getAccessibleContext() {
        InstrumentedUILog.add(new Object[] {"JTextArea.getAccessibleContext"} );
        return super.getAccessibleContext();
    }

    public int getColumns() {
        InstrumentedUILog.add(new Object[] {"JTextArea.getColumns"} );
        return super.getColumns();
    }

    public int getColumnWidth() {
        InstrumentedUILog.add(new Object[] {"JTextArea.getColumnWidth"} );
        return super.getColumnWidth();
    }

    public int getLineCount() {
        InstrumentedUILog.add(new Object[] {"JTextArea.getLineCount"} );
        return super.getLineCount();
    }

    public int getLineEndOffset(int arg0) throws BadLocationException {
        InstrumentedUILog.add(new Object[] {"JTextArea.getLineEndOffset", "" +  arg0} );
        return super.getLineEndOffset(arg0);
    }

    public int getLineOfOffset(int arg0) throws BadLocationException {
        InstrumentedUILog.add(new Object[] {"JTextArea.getLineOfOffset", "" +  arg0} );
        return super.getLineOfOffset(arg0);
    }

    public int getLineStartOffset(int arg0) throws BadLocationException {
        InstrumentedUILog.add(new Object[] {"JTextArea.getLineStartOffset", "" +  arg0} );
        return super.getLineStartOffset(arg0);
    }

    public boolean getLineWrap() {
        InstrumentedUILog.add(new Object[] {"JTextArea.getLineWrap"} );
        return super.getLineWrap();
    }

    public Dimension getPreferredScrollableViewportSize() {
        InstrumentedUILog.add(new Object[] {"JTextArea.getPreferredScrollableViewportSize"} );
        return super.getPreferredScrollableViewportSize();
    }

    public Dimension getPreferredSize() {
        InstrumentedUILog.add(new Object[] {"JTextArea.getPreferredSize"} );
        return super.getPreferredSize();
    }

    protected int getRowHeight() {
        InstrumentedUILog.add(new Object[] {"JTextArea.getRowHeight"} );
        return super.getRowHeight();
    }

    public int getRows() {
        InstrumentedUILog.add(new Object[] {"JTextArea.getRows"} );
        return super.getRows();
    }

    public boolean getScrollableTracksViewportWidth() {
        InstrumentedUILog.add(new Object[] {"JTextArea.getScrollableTracksViewportWidth"} );
        return super.getScrollableTracksViewportWidth();
    }

    public int getScrollableUnitIncrement(Rectangle arg0, int arg1, int arg2) {
        InstrumentedUILog.add(new Object[] {"JTextArea.getScrollableUnitIncrement",  arg0, "" +  arg1, "" +  arg2} );
        return super.getScrollableUnitIncrement(arg0, arg1, arg2);
    }

    public int getTabSize() {
        InstrumentedUILog.add(new Object[] {"JTextArea.getTabSize"} );
        return super.getTabSize();
    }

    public String getUIClassID() {
        InstrumentedUILog.add(new Object[] {"JTextArea.getUIClassID"} );
        return super.getUIClassID();
    }

    public boolean getWrapStyleWord() {
        InstrumentedUILog.add(new Object[] {"JTextArea.getWrapStyleWord"} );
        return super.getWrapStyleWord();
    }

    public void insert(String arg0, int arg1) {
        InstrumentedUILog.add(new Object[] {"JTextArea.insert",  arg0, "" +  arg1} );
        super.insert(arg0, arg1);
    }

    protected String paramString() {
        InstrumentedUILog.add(new Object[] {"JTextArea.paramString"} );
        return super.paramString();
    }

    public void replaceRange(String arg0, int arg1, int arg2) {
        InstrumentedUILog.add(new Object[] {"JTextArea.replaceRange",  arg0, "" +  arg1, "" +  arg2} );
        super.replaceRange(arg0, arg1, arg2);
    }

    public void setColumns(int arg0) {
        InstrumentedUILog.add(new Object[] {"JTextArea.setColumns", "" +  arg0} );
        super.setColumns(arg0);
    }

    public void setFont(Font arg0) {
        InstrumentedUILog.add(new Object[] {"JTextArea.setFont",  arg0} );
        super.setFont(arg0);
    }

    public void setLineWrap(boolean arg0) {
        InstrumentedUILog.add(new Object[] {"JTextArea.setLineWrap", "" +  arg0} );
        super.setLineWrap(arg0);
    }

    public void setRows(int arg0) {
        InstrumentedUILog.add(new Object[] {"JTextArea.setRows", "" +  arg0} );
        super.setRows(arg0);
    }

    public void setTabSize(int arg0) {
        InstrumentedUILog.add(new Object[] {"JTextArea.setTabSize", "" +  arg0} );
        super.setTabSize(arg0);
    }

    public void setWrapStyleWord(boolean arg0) {
        InstrumentedUILog.add(new Object[] {"JTextArea.setWrapStyleWord", "" +  arg0} );
        super.setWrapStyleWord(arg0);
    }
    
    // methods of InstrumentedJComponent
    ...
    public void firePropertyChange(String arg0, int arg1, int arg2) {
        InstrumentedUILog.add(new Object [] {"firePropertyChange", arg0,
                    "" + arg1 + "" + arg2 });
        super.firePropertyChange(arg0, arg1, arg2);
    }
    ...
    public Insets getInsets() {
        InstrumentedUILog.add(new Object [] {"Insets"});
    ...
    public void removeAll() {
        InstrumentedUILog.add(new Object[] { "awt.Container.removeAll" });
        super.removeAll();
    }
    ...
    public ComponentOrientation getComponentOrientation() {
                InstrumentedUILog.add(new Object[] { "awt.Component.getComponentOrientation" });
    ...
    public FontMetrics getFontMetrics(Font arg0) {
        InstrumentedUILog.add(new Object [] {"awt.Component.getFontMetrics", arg0});
    ...
    public Dimension getSize() {
        InstrumentedUILog.add(new Object[] {"awt.Component.getSize"});
    ...
    public boolean isValid() {
        InstrumentedUILog.add("awt.Component 70");
    ...
    public Dimension size() {
        InstrumentedUILog.add(new Object[] { "awt.Component.size"});
        return super.size();
    }
    ...
    public int hashCode() {
        InstrumentedUILog.add(new Object[] { "lang.Object.hashCode" });
