 ...
 * <p>
 * Purpose: verify that when a method of listener is invoked, method on target
 * class is invoked.
 * <p>
 ...
 * <li>Verify that method of class created in item#2 is invoked.
 * 
 */
public class InvocationOfMethodTest extends Test {
    /**
    ...
    public static void main(String[] args) {
        ...
        System.exit(new InvocationOfMethodTest().test(args));
    }

    public int test() {
        try {
            MakeInvocation makeInvocation = new MakeInvocation(
                "methodWithoutParam", null, null);
