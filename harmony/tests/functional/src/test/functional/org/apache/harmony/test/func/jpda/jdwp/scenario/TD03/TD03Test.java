 ...
 */
package org.apache.harmony.test.func.jpda.jdwp.scenario.TD03;
...
/**
 * Test launches debuggee and wait for connection as server. Then stops at
 * breakpoint inside debuggee. Then sends VirtualMachine::Dispose command to
 * debuggee.
 */
public class TD03Test extends JDWPQATestCase {
    ...
    protected void setUp() throws Exception {        
        server = false;
        System.setProperty("jpda.settings.transportAddress", "localhost:9896");
        super.setUp();
    }
    
    public Result testTD03() {
        ...
        logWriter.println("Disconnect from debuggee VM");
...
//        reply = debuggeeWrapper.vmMirror.performCommand(command);
        reply = debuggeeWrapper.vmMirror.dispose();
    ...
    public static void main(String[] args) {
        System.exit(new TD03Test().test(args));
    }
}
