...
import org.apache.harmony.test.func.api.java.io.share.BufferedWriter.BufferedWriterThreadTestShared;
import org.apache.harmony.share.Result;

public final class BufferedWriterThreadTest extends BufferedWriterThreadTestShared {

    public static void main(String[] args) {
        System.exit(new BufferedWriterThreadTest().test(args));
    }
