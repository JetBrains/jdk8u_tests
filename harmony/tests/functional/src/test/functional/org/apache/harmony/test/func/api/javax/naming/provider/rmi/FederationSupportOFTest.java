 ...
 * 
 */
public class FederationSupportOFTest extends MultiCase {
    /**
     * Initial context.
     */
     ...
     */
    public static final String bindingName = "SimpleCtx";
    ...
    public FederationSupportOFTest() throws InvalidNameException {
    ...
    /**
     * Create registry, construct initial context object, bind HelloImpl object
    ...
    private void init(String[] args) throws Exception {
        ...
        String initFactory = Utils.getArg(args, "factory");
        initFactory = initFactory == null ? factory : initFactory;
        Hashtable env = new Hashtable();
        env.put(Context.INITIAL_CONTEXT_FACTORY, initFactory);
        env.put(Context.OBJECT_FACTORIES, "org.apache.harmony.test.func.api."
            + "javax.naming.provider.rmi.share.SimpleObjectFactory");
        env.put(Context.PROVIDER_URL, "rmi://:" + port);
        ctx = new InitialContext(env);
        log.info("Initial context has been created. "
            + "Initial context factory: " + initFactory);
        LocateRegistry.getRegistry(port).bind(bindingName, new HelloImpl());
        log.info("The object has been successfully bound: "
    ...
    /**
     * Replaces composite names with simple names.
     * 
     * @param o
     * @return
     */
    ...
    public static void main(String[] args) {
        try {
            ...
            FederationSupportOFTest t = new FederationSupportOFTest();
            t.init(args);
            int res = t.test(args);
