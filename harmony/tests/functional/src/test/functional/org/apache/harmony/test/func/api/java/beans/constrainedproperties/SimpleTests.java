...
public class SimpleTests extends Variables {
     ...
     * <li>Call fireVetoableChange method for selected property.</li>
     ...
     * <li>Call fireVetoableChange method for the selected property.</li>
    ...
    /*
     * <p> Step-by-step decoding: <ul><li> 1. This test adds two listeners for
     * selected property. </li><li> 2. Send signal about property change </li>
    ...
    /*
     * <p> Step-by-step decoding: <ul><li> 1. This test adds listener for all
     * properties. </li><li> 2. Send signal about property change. </li><li>
     * 3. Verify, that only listener registered for all properties is notified.
     * </li></ul>
     */
    ...
    /*
     * <p> Step-by-step decoding: <ul><li> 1. This test adds the second
     * listener for all selected properties. </li><li> 2. Send signal about
     * property change. </li><li> 3. Verify, that only listener registered for
     * all selected properties is notified. </li></ul>
     */
    ...
    /*
     * <p> Step-by-step decoding: <ul><li> 1. This test adds the third listener
     * for all selected properties. </li><li> 2. Send signal about property
     * change. </li><li> 3. Verify, that only listener registered for all
     * selected properties is notified. </li></ul>
     */
    ...
    /*
     * <p> Step-by-step decoding: <ul><li> 1. This test removes the first
     * listener for all selected properties. </li><li> 2. Send signal about
     * property change. </li><li> 3. Verify, that only listener registered for
     * all selected properties is notified. </li></ul>
     */
    ...
    /*
     * <p> Step-by-step decoding: <ul><li> 1. This test removes the second
     * listener for all selected properties. </li><li> 2. Send signal about
     * property change. </li><li> 3. Verify, that only listener registered for
     * all selected properties is notified. </li></ul>
     */
    ...
    /*
     * <p> Step-by-step decoding: <ul><li> 1. This test adds 6 listeners for
     * selected property. </li><li> 2. Send signal about property change. </li>
    ...
    /*
     * <p> Step-by-step decoding: <ul><li> 1. This test removes 6 listeners for
     * selected property. </li><li> 2. Send signal about property change. </li>
     * <li> 3. Verify, that only listeners registered for selected property is
     * notified. </li></ul>
     */
    ...
    /*
     * <p> Step-by-step decoding: <ul><li> 1. This test adds 5 listeners for
     * selected property. </li><li> 2. Send signal about property change. </li>
     * <li> 3. Verify, that only listeners registered for selected property is
     * notified. </li></ul>
     */
    ...
    /*
     * <p> Step-by-step decoding: <ul><li> 1. This test removes 5 listeners for
     * selected property. </li><li> 2. Send signal about property change. </li>
     * <li> 3. Verify, that only listeners registered for selected property is
     * notified. </li></ul>
     */
    ...
    /*
     * <p> Step-by-step decoding: <ul><li> 1. This test adds 4 listeners for
     * all properties. </li><li> 2. Call fireVetoableChange method </li><li>
     * 3. Verify that only listeners registered for all property is notified.
     * </li></ul>
     */
