...
package org.apache.harmony.test.func.api.java.lang.Thread.Thread.Thread10.Thread1016;
...
public class Thread1016 extends Test {
    ...
    Runnable    trsR[]       = { null, (Runnable) new ThreadThread10161(),
                                       (Runnable) new ThreadThread10162()
                               };
    ...
    void Thread1016() {
            ...
            trsT[1] = new Thread( trsTgs[1], trsR[1], trsNames[1], 0);
            trsT[2] = new Thread( trsTgs[2], trsR[2], trsNames[2], 0);
            trsT[3] = new Thread( trsTgs[3], trsR[0], trsNames[3], 0);
            trsT[4] = new Thread( trsTgs[2], trsR[1], trsNames[4], 0);
...
class ThreadThread10162 implements Runnable {
    ThreadThread10162() {}
...
class ThreadThread10161 implements Runnable {
    ThreadThread10161() {}

    public void run() {
addLog(Thread.currentThread().getName());

        trsT[5] = new Thread( trsTgs[3], trsR[2], trsNames[5], 0);
    }
}
    ...
    public int test() {
        ...
        try {
            ...
            addLog("*********  Test Thread1016 begins ");
Thread1016();
            addLog("*********  Test Thread1016 results: ");
    ...
    public static void main(String args[]) {
        System.exit(new Thread1016().test());
    }
}
