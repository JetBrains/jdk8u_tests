 ...
 * <li>Invoke one of implemented methods of listener.
 * <li>Verify that method of class created in item#3 is invoked.
 * <li>Invoke other implemented methods of listener.
 * <li>Verify that method of class created in item#3 is invoked.
 * 
 */
public class ImplementationOfAllMethodsInListenerTest extends Test {
    ...
    public static void main(String[] args) {
        ...
        System.exit(new ImplementationOfAllMethodsInListenerTest().test(args));
    }
