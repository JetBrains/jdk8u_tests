...
import org.apache.harmony.test.func.api.java.io.share.FileWriter.FileWriterThreadTestShared;
import org.apache.harmony.share.Result;

public final class FileWriterThreadTest extends FileWriterThreadTestShared {
    public static void main(String[] args) {
       System.exit(new FileWriterThreadTest().test(args));
    }
