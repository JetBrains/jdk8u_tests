...
package org.apache.harmony.test.func.api.java.lang.Thread.setName.setName20.setName2010;

import org.apache.harmony.share.Test;
import java.security.Permission;

public class setName2010 extends Test {
...
/* This Security Manager blocks any access to the thtread wint given name */
    ...
    public static void main(String args[]) {
        System.exit(new setName2010().test());
    }
    ...
    public int test() {
        ...
        try{
            t1.setName( "newNamefor" + TESTED_THREAD_NAME );
            tStop = true;
