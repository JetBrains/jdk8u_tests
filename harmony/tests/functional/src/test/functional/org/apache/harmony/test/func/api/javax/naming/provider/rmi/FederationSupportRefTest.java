...
import org.apache.harmony.test.func.api.javax.naming.provider.rmi.share.SimpleCtxFactory;
 ...
 * 
 */
public class FederationSupportRefTest extends MultiCase {
    ...
    public FederationSupportRefTest() throws InvalidNameException {
    ...
    /**
     * Create registry, construct initial context object, bind the reference to
     * the SimpleCtx in the registry.
     * 
    ...
    private void init(String[] args) throws Exception {
        ...
        ctx.bind(bindingName, new Reference(SimpleCtxFactory.class.getName()));
    ...
    public static void main(String[] args) {
        try {
            ...
            FederationSupportRefTest t = new FederationSupportRefTest();
            t.init(args);
            int res = t.test(args);
