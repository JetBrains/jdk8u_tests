...
public class InstrumentedJTextField extends JTextField {

    public InstrumentedJTextField() {
        new JTextField();
    }
    
    public InstrumentedJTextField(int arg0) {
        new JTextField(arg0);
    }
    
    public InstrumentedJTextField(Document arg0, String arg1, int arg2) {
        new JTextField(arg0,arg1,arg2);
    }

    public synchronized void addActionListener(ActionListener arg0) {
        InstrumentedUILog.add(new Object[] {"JTextField.addActionListener", arg0});
        super.addActionListener(arg0);
    }
    
    protected void configurePropertiesFromAction(Action arg0) {
        InstrumentedUILog.add(new Object[] {"JTextField.configurePropertiesFromAction", arg0});
        super.configurePropertiesFromAction(arg0);
    }    

    protected PropertyChangeListener createActionPropertyChangeListener(
            Action arg0) {
        InstrumentedUILog.add(new Object[] {"JTextField.createActionPropertyChangeListener", arg0});
        return super.createActionPropertyChangeListener(arg0);
    }
    
    public Document createDefaultModel() {
        InstrumentedUILog.add(new Object[] {"JTextField.createDefaultModel"});
        return super.createDefaultModel();
    }
    
    public void fireActionPerformed() {
        InstrumentedUILog.add(new Object[] {"JTextField.fireActionPerformed"});
        super.fireActionPerformed();
    }
    
    public AccessibleContext getAccessibleContext() {
        InstrumentedUILog.add(new Object[] {"JTextField 6"});
        return super.getAccessibleContext();
    }
    
    public synchronized ActionListener[] getActionListeners() {
        InstrumentedUILog.add(new Object[] {"JTextField.getActionListeners"});
        return super.getActionListeners();
    }
    
    public Action[] getActions() {
        InstrumentedUILog.add(new Object[] {"JTextField.getActions"});
        return super.getActions();
    }
    
    public int getColumns() {
        InstrumentedUILog.add(new Object[] {"JTextField.getColumns"});
        return super.getColumns();
    }

    public int getColumnsWidth() {
        InstrumentedUILog.add(new Object[] {"JTextField.getColumnsWidth"});
        return super.getColumns();
    }

    public int getColumnWidth() {
        InstrumentedUILog.add(new Object[] {"JTextField.getColumnWidth"});
        return super.getColumnWidth();
    }
    
    public int getHorizontalAlignment() {
        InstrumentedUILog.add(new Object[] {"JTextField.getHorizontalAlignment"});
        return super.getHorizontalAlignment();
    }
    
    public BoundedRangeModel getHorizontalVisibility() {
        InstrumentedUILog.add(new Object[] {"JTextField.getHorizontalVisibility"});
        return super.getHorizontalVisibility();
    }
    
    public Dimension getPreferredSize() {
        InstrumentedUILog.add(new Object[] {"JTextField.Dimension"});
        return super.getPreferredSize();
    }
    
    public int getScrollOffset() {
        InstrumentedUILog.add(new Object[] {"JTextField 13"});
        return super.getScrollOffset();
    }
    
    public String getUIClassID() {
        InstrumentedUILog.add(new Object[] {"JTextField.getUIClassID"});
        return super.getUIClassID();
    }
    
    public boolean isValidateRoot() {
        InstrumentedUILog.add(new Object[] {"JTextField.isValidateRoot"});
        return super.isValidateRoot();
    }
    
    protected String paramString() {
        InstrumentedUILog.add(new Object[] {"JTextField 14"});
        return super.paramString();
    }
    
    public void postActionEvent() {
        InstrumentedUILog.add(new Object[] {"JTextField.postActionEvent"});
        super.postActionEvent();
    }
    
    public synchronized void removeActionListener(ActionListener arg0) {
        InstrumentedUILog.add(new Object[] {"JTextField.removeActionListener", arg0});
        super.removeActionListener(arg0);
    }
    
    public void scrollRectToVisible(Rectangle arg0) {
        InstrumentedUILog.add(new Object[] {"JTextField.scrollRectToVisible", arg0});
        super.scrollRectToVisible(arg0);
    }
    
    public void setAction(Action arg0) {
        InstrumentedUILog.add(new Object[] {"JTextField.setAction", arg0});
        super.setAction(arg0);
    }
    
    public void setActionCommand(String arg0) {
        InstrumentedUILog.add(new Object[] {"JTextField.setActionCommand", arg0});
        super.setActionCommand(arg0);
    }
    
    public void setColumns(int arg0) {
        InstrumentedUILog.add(new Object[] {"JTextField.setColumns", "" + arg0});
        super.setColumns(arg0);
    }
    
    public void setDocument(Document arg0) {
        InstrumentedUILog.add(new Object[] {"JTextField.setDocument", arg0});
        super.setDocument(arg0);
    }
    
    public void setFont(Font arg0) {
        InstrumentedUILog.add(new Object[] {"JTextField.setFont", arg0});
        super.setFont(arg0);
    }
    
    public void setHorizontalAlignment(int arg0) {
        InstrumentedUILog.add(new Object[] {"JTextField.setHorizontalAlignment", "" + arg0});
        super.setHorizontalAlignment(arg0);
    }
    
    public void setScrollOffset(int arg0) {
        InstrumentedUILog.add(new Object[] {"JTextField 22"});
        super.setScrollOffset(arg0);
    }
