...
import org.apache.harmony.test.func.api.java.io.share.BufferedOutputStream.BufferedOutputStreamThreadTestShared;
import org.apache.harmony.share.Result;

public final class BufferedOutputStreamThreadTest extends BufferedOutputStreamThreadTestShared {

    public static void main(String[] args) {
        System.exit(new BufferedOutputStreamThreadTest().test(args));
    }
