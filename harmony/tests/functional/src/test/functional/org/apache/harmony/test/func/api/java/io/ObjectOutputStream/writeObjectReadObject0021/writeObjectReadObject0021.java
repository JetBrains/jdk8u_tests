...
/** 
 */  
package org.apache.harmony.test.func.api.java.io.ObjectOutputStream.writeObjectReadObject0021;
...
public class writeObjectReadObject0021 extends SerializationTestFramework {
    public static void main(String[] args) {
        System.exit(new writeObjectReadObject0021().test(args));
    }
    ...
    protected int testIn(ObjectInputStream ois) throws IOException,
        ...
        int[] ia = (int[]) o;
        if (ia.length == 4 && ia[0] == 2 && ia[1] == 4 && ia[2] == 6
                && ia[3] == 8) {
            return pass();
        }
