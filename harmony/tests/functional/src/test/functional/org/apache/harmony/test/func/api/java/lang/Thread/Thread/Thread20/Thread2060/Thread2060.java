...
package org.apache.harmony.test.func.api.java.lang.Thread.Thread.Thread20.Thread2060;
...
public class Thread2060  extends Test {
...
/*  tested representation of Thread */
    class T extends Thread {
        ...
        public T(ThreadGroup group, Runnable target, String name){
...
/* This Security Manager blocks any access to the thtread wint given name  */
    ...
    public static void main(String args[]) {
        System.exit(new Thread2060().test());
    }
...
//test Thread(ThreadGroup group,Runnable target, String name)
            t1 = new T(tg, r1, TESTED_THREAD_NAME );
            tStop = true;
