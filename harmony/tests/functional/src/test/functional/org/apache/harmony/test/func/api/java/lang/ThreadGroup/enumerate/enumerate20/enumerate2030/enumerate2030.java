...
package org.apache.harmony.test.func.api.java.lang.ThreadGroup.enumerate.enumerate20.enumerate2030;

import org.apache.harmony.share.Test;

import java.security.Permission;

public class enumerate2030  extends Test {
...
/* This Security Manager blocks any access to the ThreadGroup wint given name
   and any access to the any threads */
    ...
    public static void main(String args[]) {
        System.exit(new enumerate2030().test());
    }
...
// ----------------
        ...
        try{
            rootTG.enumerate(threadGroupList);
            tStop = true;
