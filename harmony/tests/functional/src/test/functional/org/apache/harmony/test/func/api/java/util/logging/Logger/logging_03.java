...
public class logging_03 extends MultiCase{
    public static void main(String[] args) {
        System.exit(new logging_03().test(args));
    }

    public Result testInitLogging () {
        String loggerName = "org.apache.harmony.test.func.api.java.util.logging.Logger.logging_02";
        //String bundleName = "org.apache.harmony.test.func.api.java.util.logging.Logger.logging_02_en";
        ...
        if (!logger.getName().equals(loggerName)) {
            return failed ("Logger name is wrong: " + logger.getName());
        }
        if (!logger.getResourceBundleName().equals(bundleName)) {
            return failed ("Bundle name is wrong: " + logger.getResourceBundleName());
        }
        return passed();    
    }
}
