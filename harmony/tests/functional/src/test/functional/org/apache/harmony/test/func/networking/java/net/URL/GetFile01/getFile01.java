 ...
 *
 */
package org.apache.harmony.test.func.networking.java.net.URL.GetFile01;
 ...
 * 
 */
public class getFile01 extends URLTestFramework {
    ...
    public int test () {
        ...
        if (urlFile.equals(urlFileWithRef)) {
            ...
            return (fail ("File names don't match! File = " + urlFile 
                    + "; getFile() returns " + urlFileReturned));
        }
    }
    
    public static void main (String[] args) {
        System.exit(new getFile01().test(args));
    }
}
