...
public class Btest4513_case1 {   
    
    public static void main(String[] args) throws Exception  {    
        System.err.println("Start Btest4513_case1 ...");
        
        System.err.println("foo() ...");
        boolean ret1 = foo();

        System.err.println("(new Btest4513_case1()).test() ...");
        boolean ret2 = (new Btest4513_case1()).test();
    ...
    public static boolean foo() throws Exception {
        boolean ret = true;
        CertificateFactory cf = new myCertificateFactory(null, null, null);
