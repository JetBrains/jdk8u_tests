...
package org.apache.harmony.test.func.api.java.lang.Runtime.exec.exec10.exec1015;
...
public class exec1015 extends Test {
...
addLog("------- Process exec(String command, String[] envp, File dir) -------");
...
addLog("-----1.1");
                ...
                p = rt.exec(tokens[1] + " " + tokens[2], envp, null );
...
//-1)
    ...
    public int test() {
        ...
        try {
            ...
            addLog("*********  Test exec1015 begins ");
exec1015();
            addLog("*********  Test exec1015 results: ");
