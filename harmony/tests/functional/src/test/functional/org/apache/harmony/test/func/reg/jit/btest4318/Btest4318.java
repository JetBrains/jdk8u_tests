...
package org.apache.harmony.test.func.reg.jit.btest4318;

public class Btest4318 {   
    public static void main(String[] args) {
        // first argument - number of threads, second - number of objects
        System.exit(new Btest4318().test());
    }
    ...
    public int test() {
        ...
        Btest4318Object1 arrayOfObjects[]; // array of big padding objects

        // creating arrays
        arrayOfThreads = new Thread[numThreads]; // array of threads
        arrayOfObjects = new Btest4318Object1[numObjects]; 
        ...
        System.err.println("Threads created (ok)");
        ...
        if (OOMError == 1) {
            ...
            try {
                for (int cnt2 = 0; cnt2 < numObjects; cnt2++) {
                    arrayOfObjects[cnt2] = new Btest4318Object1(); 
