 ...
 */
package org.apache.harmony.test.func.jpda.jdwp.scenario.TD02;
 ...
 * breakpoint inside debuggee. Then sends VirtualMachine::Exit command to
 * debuggee.
 */
public class TD02Test extends JDWPQATestCase {
    ...
    /* (non-Javadoc)
     * @see org.apache.harmony.test.share.jpda.jdwp.JDWPQATestCase#setUp()
     */
    protected void setUp() throws Exception {
        server = false;
        System.setProperty("jpda.settings.transportAddress", "localhost:9897");
        super.setUp();
    }
    
    public Result testTD02() {
...
//        reply = debuggeeWrapper.vmMirror.performCommand(command);
    ...
    public static void main(String[] args) {
        System.exit(new TD02Test().test(args));
    }
}
