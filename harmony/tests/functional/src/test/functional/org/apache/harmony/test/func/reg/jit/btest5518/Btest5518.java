...
package org.apache.harmony.test.func.reg.jit.btest5518;

public class Btest5518 {   
            ...
            for (int i = 0; i < LMT_LOOP; i++) {
                ...
                for (int j = 0; j < THREADS_COUNT; j++) {
                    if (tableResults[j] != 104) {
                        System.err.println("Test fails: thread: " + j + "  " 
...
class testThread extends Thread {
    ...
    public void run() {
        ...
        try {
            ...
            Btest5518.tableResults[index] += t.test1();
        } catch (Throwable e) {
            System.err.println("Unexpected exception was thrown:");
            e.printStackTrace();
            Btest5518.tableResults[index] += 105;
        }
    } 
}
