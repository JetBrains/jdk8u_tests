...
package org.apache.harmony.test.func.api.java.lang.ThreadGroup.enumerate.enumerate20.enumerate2040;

import org.apache.harmony.share.Test;

import java.security.Permission;

public class enumerate2040  extends Test {
...
/* This Security Manager blocks any access to the ThreadGroup wint given name
   and any access to the any threads */
    ...
    public static void main(String args[]) {
        System.exit(new enumerate2040().test());
    }
...
// ----------------
        ...
        ThreadGroup [] threadGroupList = new ThreadGroup [ rootTG.activeGroupCount() ];
        try{
            rootTG.enumerate(threadGroupList, true);
            tStop = true;
