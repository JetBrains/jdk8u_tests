...
package org.apache.harmony.test.func.api.java.lang.Thread.stop.stop20.stop2020;

import org.apache.harmony.share.Test;

import java.security.Permission;

public class stop2020  extends Test {
...
/* This Security Manager blocks any access to the thtread wint given name */
    ...
    public int test() {
        ...
        try{
            t1.stop(new Throwable("testing Throwable"));
            tStop = true;
