...
package org.apache.harmony.test.func.api.java.io.BufferedInputStream;

import java.io.IOException;
import java.io.InputStream;

import org.apache.harmony.test.func.api.java.io.share.MultiThreadRunner;
import org.apache.harmony.test.func.api.java.io.share.BufferedInputStream.BufferedInputStreamTestShared;
import org.apache.harmony.share.Result;


public final class BufferedInputStreamTest extends BufferedInputStreamTestShared {
    public static void main(String[] args) {
        System.exit(MultiThreadRunner.run(new BufferedInputStreamTest(), args));
    }
    ...
    public Result testReadBytes0005() throws IOException {
        return super.testReadBytes0005();
    }
