...
package org.apache.harmony.test.func.reg.jit.btest3120;
...
public class Btest3120 extends RegressionTest {

    public static void main(String[] args) {
        System.exit(new Btest3120().test(Logger.global, args));
    }
    
    public int test(Logger logger, String [] args) {
        Character character1 = new Character('d');
        Character character2 = encodeDecode(character1);
        System.err.println("character1 is '" + character1 + "'");
        System.err.println("character2 is '" + character2 + "'");
        System.err.println(
        ...
        System.err.println("character1.equals(character2) is " + res);
