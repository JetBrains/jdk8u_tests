...
package org.apache.harmony.test.func.api.java.lang.Runtime.exec.exec10.exec1013;
...
public class exec1013 extends Test {
...
addLog("------- Process exec(String[] cmdarray, String[] envp, File dir) -------");
...
addLog("-----1.1");
                ...
                p = rt.exec( cmdarrays[1], envp, dir );
...
addLog("-----2.1");
                ...
                p = rt.exec( cmdarrays[2], envp, dir );
...
//-1)
    ...
    public int test() {
        ...
        try {
            ...
            addLog("*********  Test exec1013 begins ");
exec1013();
            addLog("*********  Test exec1013 results: ");
