...
package org.apache.harmony.test.func.api.java.lang.Thread.Thread.Thread10.Thread1012;
...
public class Thread1012 extends Test {
    ...
    Runnable    trsR[]       = { null, (Runnable) new ThreadThread10121(),
                                       (Runnable) new ThreadThread10122()
                               };
    ...
    void Thread1012() {
            ...
            trsT[1] = new Thread( trsR[1], trsNames[1]);
            trsT[2] = new Thread( trsR[2], trsNames[2]);
            trsT[3] = new Thread( trsR[0], trsNames[3]);
            trsT[4] = new Thread( trsR[1], trsNames[4]);
...
class ThreadThread10122 implements Runnable {
    ThreadThread10122() {}
...
class ThreadThread10121 implements Runnable {
    ThreadThread10121() {}

    public void run() {
addLog(Thread.currentThread().getName());

        trsT[5] = new Thread( trsR[2], trsNames[5]);
    }
}
    ...
    public int test() {
        ...
        try {
            ...
            addLog("*********  Test Thread1012 begins ");
Thread1012();
            addLog("*********  Test Thread1012 results: ");
    ...
    public static void main(String args[]) {
        System.exit(new Thread1012().test());
    }
}
