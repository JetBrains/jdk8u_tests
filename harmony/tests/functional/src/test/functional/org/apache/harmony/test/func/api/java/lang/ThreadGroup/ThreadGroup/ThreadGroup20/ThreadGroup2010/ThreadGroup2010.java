...
package org.apache.harmony.test.func.api.java.lang.ThreadGroup.ThreadGroup.ThreadGroup20.ThreadGroup2010;

import org.apache.harmony.share.Test;

import java.security.Permission;

public class ThreadGroup2010  extends Test {
...
/* This Security Manager blocks any access to the ThreadGroup wint given name
   and any access to the any threads */
    ...
    public static void main(String args[]) {
        System.exit(new ThreadGroup2010().test());
    }
...
// ----------------
        ...
        try{
            subTG1  = new ThreadGroup( rootTG, TESTED_THREADSUBGROUP_NAME );
            tStop = true;
