...
package org.apache.harmony.test.func.api.java.lang.Thread.Thread.Thread20.Thread2030;
...
public class Thread2030  extends Test {
...
/*  tested representation of Thread */
    class T extends Thread {
        ...
        public T(Runnable target, String str){
            super( target,str );
        }
...
/* This Security Manager blocks any access to the thtread wint given name  */
    ...
    public static void main(String args[]) {
        System.exit(new Thread2030().test());
    }
    ...
    public int test() {
        ...
        try{
//test Thread(Runnable target, String name )
            t1 = new T(r1, TESTED_THREAD_NAME );
            tStop = true;
