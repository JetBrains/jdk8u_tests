 ...
 */
package org.apache.harmony.test.func.api.java.beans.introspector.location.beans.subclasses;
...
/**
 */
public class Bean2BeanInfo extends SimpleBeanInfo implements BeanInfoStatus {
    private static boolean                invoked = false;
    private static IntrospectionException exception;

    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            PropertyDescriptor _property1 = new PropertyDescriptor("property2",
                Bean2.class, "g2getI", "s2setI");
