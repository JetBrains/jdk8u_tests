...
package org.apache.harmony.test.func.api.java.lang.Thread.Thread.Thread20.Thread2050;
...
public class Thread2050  extends Test {
...
/*  tested representation of Thread */
    class T extends Thread {
        ...
        public T(ThreadGroup group,Runnable target){
            super( group, target );
        }
    }
...
/* This Security Manager blocks any access to any thtread  */
    ...
    public static void main(String args[]) {
        System.exit(new Thread2050().test());
    }
    ...
    public int test() {
        ...
        try{
//test Thread(ThreadGroup group,Runnable target)
            t1 = new T(tg, r1 );
            tStop = true;
