...
import org.apache.harmony.test.func.api.java.io.share.DataOutputStream.DataOutputStreamThreadTestShared;
import org.apache.harmony.share.Result;

public final class DataOutputStreamThreadTest extends DataOutputStreamThreadTestShared {

    public static void main(String[] args) {
        System.exit(new DataOutputStreamThreadTest().test(args));
    }
