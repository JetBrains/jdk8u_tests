 ...
 */
package org.apache.harmony.test.func.api.javax.xml.F_DocumentBuilderFactoryTest_02;
...
/**
 */
public class F_DocumentBuilderFactoryTest_02 extends ScenarioTest {
    ...
    public static void main(String[] args) {
        System.exit(new F_DocumentBuilderFactoryTest_02().test(args));
    }
    ...
    public int test() {
        try {
            ...
            if (!document_builder_factory.isIgnoringComments() == false) {
            ...
            for (int i = 0; i < treeXML_map.size(); i++) {
                if (treeXML_map.get(new Integer(i)).equals("comment")) {
                    return error("Error in test: method setIgnoringComments error");
                }
            }
            if (flag == 1) {
    ...
    public static void treeXML(Node treeXML_node) {
        ...
        case Node.COMMENT_NODE: {
            treeXML_map.put(new Integer(treeXML_count), "comment");
            treeXML_count++;
            break;
        }
