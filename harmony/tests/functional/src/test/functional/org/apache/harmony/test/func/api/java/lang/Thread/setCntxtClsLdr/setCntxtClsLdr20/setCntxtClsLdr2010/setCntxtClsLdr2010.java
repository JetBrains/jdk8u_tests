...
package org.apache.harmony.test.func.api.java.lang.Thread.setCntxtClsLdr.setCntxtClsLdr20.setCntxtClsLdr2010;
...
public class setCntxtClsLdr2010 extends Test {
    public static final String TESTED_THREAD_NAME = "SecurityManagerTestThread";
    public static final String TESTED_CLASS_LOADER = "TestedClassLoader";
...
/* This Security Manager blocks any access to the thtread wint given name */
        ...
        public void checkPermission( Permission perm ){
            ...
            } else if( perm.equals( new RuntimePermission("setContextClassLoader") ) ) {
    ...
    public static void main(String args[]) {
        System.exit(new setCntxtClsLdr2010().test());
    }
    ...
    public int test() {
        ...
        try{
            t1.setContextClassLoader( new cl(TESTED_CLASS_LOADER) );
            tStop = true;
