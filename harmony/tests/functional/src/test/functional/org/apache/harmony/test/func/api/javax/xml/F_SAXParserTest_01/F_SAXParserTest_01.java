 ...
 */
package org.apache.harmony.test.func.api.javax.xml.F_SAXParserTest_01;
...
/**
 */
public class F_SAXParserTest_01 extends ScenarioTest {
    static HashMap sax_map;
    static HashMap args_map;
    static int     count = 0;

    public static void main(String[] args) {
        System.exit(new F_SAXParserTest_01().test(args));
    }
