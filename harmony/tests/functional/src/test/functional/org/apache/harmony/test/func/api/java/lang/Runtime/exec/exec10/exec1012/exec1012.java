...
package org.apache.harmony.test.func.api.java.lang.Runtime.exec.exec10.exec1012;
...
public class exec1012 extends Test {
...
addLog("------- Process exec(String[] cmdarray, String[] envp) -------");
...
//-1)
    ...
    public int test() {
        ...
        try {
            ...
            addLog("*********  Test exec1012 begins ");
exec1012();
            addLog("*********  Test exec1012 results: ");
