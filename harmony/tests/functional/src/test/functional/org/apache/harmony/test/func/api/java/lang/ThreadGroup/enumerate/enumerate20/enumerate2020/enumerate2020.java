...
package org.apache.harmony.test.func.api.java.lang.ThreadGroup.enumerate.enumerate20.enumerate2020;

import org.apache.harmony.share.Test;

import java.security.Permission;

public class enumerate2020  extends Test {
            ...
            if( tg.getName().equals( prohibitedThreadGroupName))
{
    ...
    public static void main(String args[]) {
        System.exit(new enumerate2020().test());
    }
...
//--------- Create Thread Group and its subgroupe
        ...
        ThreadGroup subTG  = new ThreadGroup(rootTG, TESTED_THREADSUBGROUP_NAME);
// Create and start threads
        T t1 = new T( rootTG, TESTED_THREAD_NAME + "_1" );
        T t2 = new T( subTG,  TESTED_THREAD_NAME + "_2" );
        T t3 = new T( subTG,  TESTED_THREAD_NAME + "_3" );
...
// ----------------
        ...
        Thread [] threadList = new Thread[ rootTG.activeCount() ];
        try{
            rootTG.enumerate(threadList, true);
            tStop = true;
