...
package org.apache.harmony.test.func.api.java.lang.Thread.Thread.Thread10.Thread1014;
...
public class Thread1014 extends Test {
    ...
    Runnable    trsR[]       = { null, (Runnable) new ThreadThread10141(),
                                       (Runnable) new ThreadThread10142()
                               };
    ...
    void Thread1014() {
            ...
            trsT[1] = new Thread( trsTgs[1], trsR[1] ); trsNames[1] = trsT[1].getName();
            trsT[2] = new Thread( trsTgs[2], trsR[2] ); trsNames[2] = trsT[2].getName();
            trsT[3] = new Thread( trsTgs[3], trsR[0] ); trsNames[3] = trsT[3].getName();
            trsT[4] = new Thread( trsTgs[2], trsR[1] ); trsNames[4] = trsT[4].getName();
...
class ThreadThread10142 implements Runnable {
    ThreadThread10142() {}
...
class ThreadThread10141 implements Runnable {
    ThreadThread10141() {}

    public void run() {
addLog(Thread.currentThread().getName());

        trsT[5] = new Thread( trsTgs[3], trsR[2]);
    }
}
    ...
    public int test() {
        ...
        try {
            ...
            addLog("*********  Test Thread1014 begins ");
Thread1014();
            addLog("*********  Test Thread1014 results: ");
    ...
    public static void main(String args[]) {
        System.exit(new Thread1014().test());
    }
}
