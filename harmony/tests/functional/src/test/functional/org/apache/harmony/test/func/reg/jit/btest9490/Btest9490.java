...
package org.apache.harmony.test.func.reg.jit.btest9490;

public class Btest9490 {
    ...
    public static void main(String[] args) {
        ...
        if (res == Integer.MAX_VALUE) {
            ...
            System.err.println("Testcase 1 failed: result is " + res +
          ...
          if (res == Integer.MIN_VALUE) {
              ...
              System.err.println("Testcase 2 failed: result is " + res +
