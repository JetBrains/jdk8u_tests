...
import org.apache.harmony.test.func.api.java.io.share.FileInputStream.FileInputStreamThreadTestShared;
import org.apache.harmony.share.Result;

public final class FileInputStreamThreadTest extends FileInputStreamThreadTestShared {
    public static void main(String[] args) {
        System.exit(new FileInputStreamThreadTest().test(args));
    }
