 ...
 *
 */
package org.apache.harmony.test.func.networking.java.net.URL.GetQuery01;
...
public class getQuery01 extends URLTestFramework {
    ...
    public int test () {
        ...
        if (urlFile2.equals(urlFile)) {
            ...
            return (fail ("getQuery() returns a wrong result: File with Query = " 
                    + urlPath + ", getQuery() returns " + urlQuery));
        }
    }
    
    public static void main (String[] args) {
        System.exit(new getQuery01().test(args));
    }
}
