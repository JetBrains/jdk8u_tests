...
package org.apache.harmony.test.func.api.java.lang.Thread.Thread.Thread20.Thread2080;
...
public class Thread2080  extends Test {
    ...
    public static final long TESTED_STACK_SIZE = 2048;
...
/*  tested representation of Thread */
    class T extends Thread {
        ...
        public T(ThreadGroup group, Runnable target, String name,long stackSize ){
...
/* This Security Manager blocks any access to the thtread wint given name  */
    ...
    public static void main(String args[]) {
        System.exit(new Thread2080().test());
    }
    ...
    public int test() {
        ...
        try{
//test Thread(ThreadGroup group,Runnable target, String name, long stackSize)
            t1 = new T(tg, r1, TESTED_THREAD_NAME, TESTED_STACK_SIZE);
            tStop = true;
