...
import org.apache.harmony.test.func.api.java.io.share.PrintWriter.PrintWriterThreadTestShared;
import org.apache.harmony.share.Result;

public final class PrintWriterThreadTest extends PrintWriterThreadTestShared {
    public static void main(String[] args) {
        System.exit(new PrintWriterThreadTest().test(args));
    }
