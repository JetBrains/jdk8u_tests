...
package org.apache.harmony.test.func.reg.jit.btest1963;

import java.util.logging.Logger;

import org.apache.harmony.test.share.reg.RegressionTest;

public class Btest1963 extends RegressionTest {
    
    public static void main(String[] args) {
         System.exit(new Btest1963().test(Logger.global, args));
    }
...
*/
        ...
        System.err.println("End TIME = " + totalTime/1000.0);
