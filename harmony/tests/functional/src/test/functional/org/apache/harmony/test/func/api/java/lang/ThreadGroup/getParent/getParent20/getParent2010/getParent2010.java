...
package org.apache.harmony.test.func.api.java.lang.ThreadGroup.getParent.getParent20.getParent2010;

import org.apache.harmony.share.Test;

import java.security.Permission;

public class getParent2010  extends Test {
...
/* This Security Manager blocks any access to the ThreadGroup wint given name
   and any access to the any threads */
    ...
    public static void main(String args[]) {
        System.exit(new getParent2010().test());
    }
...
//--------- Create Thread Group and its subgroupe
        ...
        ThreadGroup subTG2  = new ThreadGroup(subTG1 /*rootTG*/, TESTED_THREADSUBGROUP_NAME + "_2");
