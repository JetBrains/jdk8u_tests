...
package org.apache.harmony.test.func.reg.jit.btest9492;

public class Btest9492 {
    ...
    public static void main(String[] args) {            
        ...
        if (Float.compare(res, 0.0f) == 0) {
            System.err.println("Float.MAX_VALUE: testcase passed");
        } else {
            System.err.println("Float.MAX_VALUE is " + res + 
        ...
        if (Double.compare(dres, 8.0) == 0) {
            System.err.println("Double.MAX_VALUE: testcase passed");
        } else {
            System.err.println("Double.MAX_VALUE is " + dres + 
        ...
        if (Double.compare(dres, -0.0) == 0) {
            System.err.println("-Double.MAX_VALUE is testcase passed");
        } else {
            System.err.println("Double.MAX_VALUE: " + dres + 
