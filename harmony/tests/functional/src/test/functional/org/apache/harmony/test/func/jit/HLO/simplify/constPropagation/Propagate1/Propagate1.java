 ...
 */
package org.apache.harmony.test.func.jit.HLO.simplify.constPropagation.Propagate1;
...
public class Propagate1 extends Test {
    ...
    public int test() {
        ...
        System.loadLibrary("constPropagation");
        s = 3;
        int result1 = s*2+(s-1)+(s+100)+s*s;
        //log.info("result1=" + result1);
        nativeMethod();
        int result2 = s*2+(s-1)+(s+100)+s*s;
        //log.info("result2=" + result2);
        if (s==7 && result1==120 && result2==176) return pass();
