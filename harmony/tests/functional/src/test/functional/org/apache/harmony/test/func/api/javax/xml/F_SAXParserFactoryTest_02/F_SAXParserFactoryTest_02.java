 ...
 */
package org.apache.harmony.test.func.api.javax.xml.F_SAXParserFactoryTest_02;
...
/**
 */
public class F_SAXParserFactoryTest_02 extends ScenarioTest {
    static HashMap sax_map;
    static HashMap args_map;
    static int     count = 0;

    public static void main(String[] args) {
        System.exit(new F_SAXParserFactoryTest_02().test(args));
    }
