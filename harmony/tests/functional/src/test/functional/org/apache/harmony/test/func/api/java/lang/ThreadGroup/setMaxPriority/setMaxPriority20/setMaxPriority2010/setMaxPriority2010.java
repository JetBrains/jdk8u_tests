...
package org.apache.harmony.test.func.api.java.lang.ThreadGroup.setMaxPriority.setMaxPriority20.setMaxPriority2010;
...
public class setMaxPriority2010  extends Test {
...
/* This Security Manager blocks any access to the ThreadGroup wint given name
   and any access to the any threads */
    ...
    public static void main(String args[]) {
        System.exit(new setMaxPriority2010().test());
    }
...
// ----------------
        ...
        try{
            rootTG.setMaxPriority( Thread.MAX_PRIORITY );
            tStop = true;
