 ...
 *
 */
package org.apache.harmony.test.func.networking.java.net.URL.GetContent02;
...
public class getContent02 extends URLTestFramework {
    ...
    public int test () {
        ...
        if (content2 != null){
            return (pass("Content " + content1.toString()));
        }
        else {
    ...
    public static void main (String[] args) {
        System.exit(new getContent02().test(args));
    }
}
