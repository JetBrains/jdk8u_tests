...
package org.apache.harmony.test.func.reg.jit.btest1197;

import java.io.ByteArrayInputStream;
import java.io.InputStream;

public class Btest1197 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.err.println("Start Btest1197 main");
        ...
        class Thr extends Thread {
            public void run() {
                ...
                try {
                    synchronized(Btest1197.class) {
                         brr++;
                        if(brr == THREADS) {
                               Btest1197.class.notifyAll();
                         } else {
                             Btest1197.class.wait(); 
                         }
                    }
        ...
        for (int i = 0; i < THREADS; ++i) {
            if (read[i + 'a'] != THREADS * READS) {
                System.err.println("expected " + THREADS * READS + " for " 
                           + ('a' + i) + " but got " + read['a' + i]);
            }
        }
        System.err.println("Finish Btest1197 main!");
    } 
}
