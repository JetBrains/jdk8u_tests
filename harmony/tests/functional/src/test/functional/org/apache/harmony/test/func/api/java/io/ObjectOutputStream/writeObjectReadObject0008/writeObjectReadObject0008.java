...
/** 
 */  
package org.apache.harmony.test.func.api.java.io.ObjectOutputStream.writeObjectReadObject0008;
...
public class writeObjectReadObject0008 extends SerializationTestFramework {
    public static void main(String[] args) {
        System.exit(new writeObjectReadObject0008().test(args));
    }
    ...
    protected int testIn(ObjectInputStream ois) throws IOException,
        ...
        if (s.size() != 3) {
            return fail("too many objects in set");
        }
