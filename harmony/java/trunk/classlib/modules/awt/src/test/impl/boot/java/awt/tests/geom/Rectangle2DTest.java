...
//        filterImage = createFilter("^(rect).*([.]ico)$", "(.*)((affine)|(flat)|(bounds))(.*)");
    ...
    public void testSetRect() {
        ...
        Assert.assertEquals(new Rectangle2D.Double(5, 6, 7, 8), r);
    }
    ...
    public void testGetBounds2D() {
        Assert.assertEquals(new Rectangle2D.Double(1, 2, 3, 4), r.getBounds2D());
    }

    public void testOutcode() {
        // Just check it works
        Assert.assertEquals(Rectangle2D.OUT_LEFT | Rectangle2D.OUT_TOP,     r.outcode(0, 0));
        Assert.assertEquals(0, r.outcode(new Point2D.Double(2, 3)));
    }

    public void testEquals() {
        Assert.assertTrue(r.equals(new Rectangle(1, 2, 3, 4)));
        Assert.assertTrue(!r.equals(new Rectangle(0, 2, 3, 4)));
        Assert.assertTrue(!r.equals(new Rectangle(1, 0, 3, 4)));
        Assert.assertTrue(!r.equals(new Rectangle(1, 2, 0, 4)));
        Assert.assertTrue(!r.equals(new Rectangle(1, 2, 3, 0)));
    }

    public void testHashCode() {
        Assert.assertTrue(r.hashCode() == new Rectangle(1, 2, 3, 4).hashCode());
        Assert.assertTrue(r.hashCode() != new Rectangle(0, 2, 3, 4).hashCode());
        Assert.assertTrue(r.hashCode() != new Rectangle(1, 0, 3, 4).hashCode());
        Assert.assertTrue(r.hashCode() != new Rectangle(1, 2, 0, 4).hashCode());
        Assert.assertTrue(r.hashCode() != new Rectangle(1, 2, 3, 0).hashCode());
    }
    ...
    public void testIntersect() {
        ...
        Assert.assertEquals(new Rectangle(1, 2, 3, 4), dst); // The same
        Rectangle2D.intersect(r, new Rectangle(2, 3, 1, 2), dst);
        Assert.assertEquals(new Rectangle(2, 3, 1, 2), dst); // Inside
        Rectangle2D.intersect(r, new Rectangle(5, 7, 1, 2), dst);
        Assert.assertEquals(new Rectangle(5, 7, -1, -1), dst); // Outside
        Rectangle2D.intersect(r, new Rectangle(2, 3, 5, 6), dst);
        Assert.assertEquals(new Rectangle(2, 3, 2, 3), dst); // Intersect
        Rectangle2D.intersect(r, new Rectangle(0, 0, 5, 6), dst);
        Assert.assertEquals(new Rectangle(1, 2, 3, 4), dst); // Cover
    }
    ...
    public void testUnion() {
        ...
        Assert.assertEquals(new Rectangle(1, 2, 3, 4), dst); // Inside
        Rectangle2D.union(r, new Rectangle(5, 7, 1, 2), dst);
        Assert.assertEquals(new Rectangle(1, 2, 5, 7), dst); // Outside
        Rectangle2D.union(r, new Rectangle(2, 3, 5, 6), dst);
        Assert.assertEquals(new Rectangle(1, 2, 6, 7), dst); // Intersect
        Rectangle2D.union(r, new Rectangle(0, 0, 5, 6), dst);
        Assert.assertEquals(new Rectangle(0, 0, 5, 6), dst); // Cover
    }

    public void testAdd1() {
        r.add(1.0, 1.0);
        Assert.assertEquals(new Rectangle2D.Double(1, 1, 3, 5), r);
        r.add(7.0, 8.0);
        Assert.assertEquals(new Rectangle2D.Double(1, 1, 6, 7), r);
        r.add(5.0, 9.0);
        Assert.assertEquals(new Rectangle2D.Double(1, 1, 6, 8), r);
        r.add(9.0, 6.0);
        Assert.assertEquals(new Rectangle2D.Double(1, 1, 8, 8), r);
        r.add(0.0, 0.0);
        Assert.assertEquals(new Rectangle2D.Double(0, 0, 9, 9), r);
    }

    public void testAdd2() {
        r.add(new Point(0, 0));
        Assert.assertEquals(new Rectangle2D.Double(0, 0, 4, 6), r);
        r.add(new Point(1, 1));
        Assert.assertEquals(new Rectangle2D.Double(0, 0, 4, 6), r);
        r.add(new Point(7, 8));
        Assert.assertEquals(new Rectangle2D.Double(0, 0, 7, 8), r);
        r.add(new Point(5, 9));
        Assert.assertEquals(new Rectangle2D.Double(0, 0, 7, 9), r);
        r.add(new Point(9, 6));
        Assert.assertEquals(new Rectangle2D.Double(0, 0, 9, 9), r);
    }
