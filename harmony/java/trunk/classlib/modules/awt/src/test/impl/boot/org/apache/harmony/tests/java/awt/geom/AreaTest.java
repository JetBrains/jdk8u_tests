...
public class AreaTest extends PathIteratorTestCase {
    ...
    public void testContainsPoint() {
        try {
         ...
         Assert.assertTrue(area.contains(250, 350));
         Assert.assertFalse(area.contains(200, 300));
         Assert.assertFalse(area.contains(50, 50));
         
         Assert.assertTrue(area.contains(new Point2D.Double(500, 400)));
         Assert.assertFalse(area.contains(new Point2D.Double(700, 400)));
         ...
         Assert.assertFalse(areaPath.contains(100, 50));
     }
     ...
     public void testContainsRect() {
         ...
         Assert.assertTrue(area.contains(new Rectangle2D.Double(300, 400, 100, 50)));
         Assert.assertFalse(area.contains(new Rectangle2D.Double(50, 400, 700, 50)));
         ...
         Assert.assertTrue(area1.contains(350, 200, 50, 50));
         Assert.assertFalse(area1.contains(100, 50, 600, 500));
     ...
     public void testIntersectsRect() {
         ...
         Area area = new Area(path);
         Assert.assertTrue(area.intersects(new Rectangle2D.Double(300, 400, 100, 50)));
         Assert.assertFalse(area.intersects(new Rectangle2D.Double(50, 50, 50, 50)));
         ...
         Area area1 = new Area(path1);
         Assert.assertTrue(area1.intersects(350, 200, 50, 50));
         Assert.assertFalse(area1.intersects(500, 50, 100, 50));
     ...
     public void testIsRectangle() {
     	...
     	Assert.assertTrue(area.isRectangular());
         ...
         Assert.assertTrue(area1.isRectangular());
     ...
     public void testSubtract() {
		...
		Assert.assertFalse(area1.contains(375, 325));
		Assert.assertTrue(area1.contains(600, 300));
		Assert.assertTrue(area1.contains(325, 325));
    }
    ...
    public void testTransformPathIterator() {
        ...
        while (!path.isDone() && !transformedPath.isDone()) {
            ...
            Assert.assertTrue(rule1 == rule2);
            switch (rule1) {
                case PathIterator.SEG_MOVETO: {
                    transform.transform(coords, 0, coords, 0, 1);
                    Assert.assertTrue(coords[0] == transformedCoords[0] && coords[1] == transformedCoords[1]);
                    break;
                }
        ...
        Assert.assertTrue(path.isDone() && transformedPath.isDone());
    }   
